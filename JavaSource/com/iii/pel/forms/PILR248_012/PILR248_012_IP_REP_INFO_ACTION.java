package com.iii.pel.forms.PILR248_012;
...
public class PILR248_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR248_012_HELPER helper;
	PILR248_012_DELEGATE delegate;

	public PILR248_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR248_012_HELPER();
		delegate = new PILR248_012_DELEGATE();
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR248_012_HELPER helper = new PILR248_012_HELPER();
	...
	public PILR248_012_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR248_012_HELPER helper) {
		this.helper = helper;
	}

	public PILR248_012_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR248_012_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR248_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR248_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR248_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] {  IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR248_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_PROD_CODE(Object obj) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR248_012",
