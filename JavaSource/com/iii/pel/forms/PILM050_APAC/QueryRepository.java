...
String PM_IL_BANK_ACCOUNT_SETUP_DIVISION_LOV = "SELECT DIVN_CODE,DIVN_NAME FROM FM_DIVISION WHERE ROWNUM < 25 ORDER BY DIVN_CODE ASC";
...
//Bug fixed : sql query is not handled proper  : added by Shankar Bodduluri : 01-Apr-2009
String PM_IL_BANK_ACCOUNT_SETUP_BRANCH_LOV="SELECT DIVN_CODE,DIVN_NAME FROM FM_DIVISION WHERE ROWNUM < 25 ";
