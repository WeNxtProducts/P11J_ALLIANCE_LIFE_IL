package com.iii.pel.forms.PILR006_APAC;
...
public class PILR006_APAC_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR006_APAC_HELPER helper;
	PILR006_APAC_DELEGATE delegate;

	public PILR006_APAC_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR006_APAC_HELPER();
		delegate = new PILR006_APAC_DELEGATE();
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR006_APAC_HELPER helper = new PILR006_APAC_HELPER();
	...
	public PILR006_APAC_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR006_APAC_HELPER helper) {
		this.helper = helper;
	}

	public PILR006_APAC_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR006_APAC_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR006_APAC_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR006_APAC_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR006_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] {  IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR006_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR006_APAC_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR006_APAC_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
