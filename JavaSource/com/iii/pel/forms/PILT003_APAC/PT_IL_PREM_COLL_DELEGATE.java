...
public class PT_IL_PREM_COLL_DELEGATE {
	public void executeSelectStatement(
		...
		{
			selectStatement = "SELECT ROWID, PT_IL_PREM_COLL.* FROM " +
					"PT_IL_PREM_COLL WHERE PC_POL_SYS_ID = ?  AND PC_SCHD_PYMT_DT <= SYSDATE  ORDER BY PC_SCHD_PYMT_DT ASC ";
		...
		{
			selectStatement = "SELECT ROWID, PT_IL_PREM_COLL.* FROM " +
					"PT_IL_PREM_COLL WHERE PC_POL_SYS_ID = ? AND PC_PAID_FLAG != 'A' AND PC_sCHD_PYMT_DT <= SYSDATE ORDER BY PC_SCHD_PYMT_DT ASC ";
		}
