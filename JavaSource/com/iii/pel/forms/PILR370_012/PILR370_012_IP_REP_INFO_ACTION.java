package com.iii.pel.forms.PILR370_012;
...
public class PILR370_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR370_012_HELPER helper;
	PILR370_012_DELEGATE delegate;
	...
	public PILR370_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR370_012_HELPER();
		delegate=new PILR370_012_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listPaymentFm = ListItemUtil.getDropDownListValue(connection, "PILR370_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_FM", "PAYMODE");
			listPaymentTo = ListItemUtil.getDropDownListValue(connection, "PILR370_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_TO", "PAYMODE");
			listInstrFm= ListItemUtil.getDropDownListValue(connection, "PILR370_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_FM", "IL_CPAY_MODE");
			listInstrTo = ListItemUtil.getDropDownListValue(connection, "PILR370_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_TO", "IL_CPAY_MODE");
			listM_Lapse = ListItemUtil.getDropDownListValue(connection, "PILR370_012", 
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR370_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_FM_DIVN_CODE", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_TO_DIVN_CODE", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_FM_DEPT_CODE", IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
				map.put("P_TO_DEPT_CODE", IP_REP_INFO_BEAN.getUI_M_TO_DEPT_CODE());
				map.put("P_PROD_FM_CODE", IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_PROD_TO_CODE", IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR370_012_HELPER helper=new PILR370_012_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovAgentCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_AGENT_FM", 
	...
	public List<LovBean> lovSrcBus(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_SRC_BUS_FM", 
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR370_012_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
	...
	public List<LovBean> lovCustCode1(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_FM_CUST", 
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_PROD_CODE_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovMainAcnt(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_MACNT_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_FM_STATUS", 
	...
	public List<LovBean> lovCLM(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR370_012", "REP_PARAM", "M_CLM_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_DIVN_CODE(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_DEPT_CODE(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.DEPARTMENT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovPolNoCode(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.POL_NO;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR370_012_QUERY_CONSTANTS.POL_LIKE;
		}
