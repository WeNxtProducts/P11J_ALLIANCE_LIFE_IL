...
public class PILR370_012_HELPER {
	...
	public void whenCreaterecord(PILR370_012_IP_REP_INFO_ACTION action) throws Exception{
	...
	public String WHEN_VALIDATE_ITEM_UI_DIVN_CODE(String uiDivnFmCode,
		...
		String C1 ="SELECT DIVN_NAME FROM PM_DIVISION WHERE DIVN_CODE =  ? ";
	...
	public String WHEN_VALIDATE_ITEM_UI_PROD_CODE(String uiDivnFmCode,
			IP_REP_INFO pbr016ValueBean) throws Exception {
