...
public class PT_IL_POL_CONDITION extends BaseValueBean {
	...
	private String PLCOND_COND_TYP;

	public String getPLCOND_COND_TYP() {
		return PLCOND_COND_TYP;
	}
	public void setPLCOND_COND_TYP(String pLCOND_COND_TYP) {
		PLCOND_COND_TYP = pLCOND_COND_TYP;
	}
	/*End*/
	
	/*Added by Ameen on 08-06-2017 for ZBILQC-1720056*/
	@Column(name="PLCOND_COND_FLAG")
	private String PLCOND_COND_FLAG;

	public String getPLCOND_COND_FLAG() {
		return PLCOND_COND_FLAG;
	}
	public void setPLCOND_COND_FLAG(String pLCOND_COND_FLAG) {
		PLCOND_COND_FLAG = pLCOND_COND_FLAG;
	}
	/*End*/
}
