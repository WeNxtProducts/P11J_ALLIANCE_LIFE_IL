...
public class PM_IL_DOC_TODO_GROUP_HELPER {
    ...
    Start*/ 
    public void executeQuery1(PILT002_APAC_COMPOSITE_ACTION compositeAction)
			throws Exception {
		try {
    ...
    public void onPopulateDetails(PILT002_APAC_COMPOSITE_ACTION compositeAction) throws Exception {
    ...
    public void preDelete(PILT002_APAC_COMPOSITE_ACTION compositeAction) throws Exception {
	PM_IL_DOC_TODO_GROUP pm_il_doc_todo_group_bean = compositeAction
		.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN()
		.getPM_IL_DOC_TODO_GROUP_BEAN();
	Connection connection = null;
    ...
    public void preQuery( PM_IL_DOC_TODO_GROUP pm_il_doc_todo_group_bean ,PT_IL_POLICY pt_il_policy_bean) throws Exception {
	try{
