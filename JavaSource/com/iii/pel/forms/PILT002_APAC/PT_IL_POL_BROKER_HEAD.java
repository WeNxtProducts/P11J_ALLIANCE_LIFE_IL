...
public class PT_IL_POL_BROKER_HEAD extends BaseValueBean {
	...
	private Integer POBH_AGENT_LEVEL;
	...
	private Double UI_M_FC_COMMISSION;
	
    private Double UI_M_LC_COMMISSION;
	
	public Double getUI_M_FC_COMMISSION() {
		return UI_M_FC_COMMISSION;
	}
	public void setUI_M_FC_COMMISSION(Double ui_m_fc_commission) {
		UI_M_FC_COMMISSION = ui_m_fc_commission;
	}
	public Double getUI_M_LC_COMMISSION() {
		return UI_M_LC_COMMISSION;
	}
	public void setUI_M_LC_COMMISSION(Double ui_m_lc_commission) {
		UI_M_LC_COMMISSION = ui_m_lc_commission;
	}
	...
	public Integer getPOBH_AGENT_LEVEL() {
		return POBH_AGENT_LEVEL;
	}
	public void setPOBH_AGENT_LEVEL(Integer pobh_agent_level) {
		POBH_AGENT_LEVEL = pobh_agent_level;
	}
	...
	@Column(name="POBH_SHARE_PERC")
	private Double POBH_SHARE_PERC;

	public Double getPOBH_SHARE_PERC() {
		return POBH_SHARE_PERC;
	}
	public void setPOBH_SHARE_PERC(Double pOBH_SHARE_PERC) {
		POBH_SHARE_PERC = pOBH_SHARE_PERC;
	}

	/*end*/
	
	/*Added by saranya for  FSD_IL_ZB Life_007_Multiple agents on 26-12-2016 */
	@Column(name="POBH_PARENT_CODE")
	public String POBH_PARENT_BROKER;

	public String getPOBH_PARENT_BROKER() {
		return POBH_PARENT_BROKER;
	}
	public void setPOBH_PARENT_BROKER(String pOBH_PARENT_BROKER) {
		POBH_PARENT_BROKER = pOBH_PARENT_BROKER;
	}
	/*End*/
	/*Added by saranya for  FSD_IL_ZB Life_007_Multiple agents on 26-12-2016 */
	@Column(name="POBH_AGENT_HEIRCHY")
	public String POBH_AGENT_HEIRCHY;

	public String getPOBH_AGENT_HEIRCHY() {
		return POBH_AGENT_HEIRCHY;
	}
	public void setPOBH_AGENT_HEIRCHY(String pOBH_AGENT_HEIRCHY) {
		POBH_AGENT_HEIRCHY = pOBH_AGENT_HEIRCHY;
	}
	
	public String UI_M_COMM_TYPE;

	public String getUI_M_COMM_TYPE() {
		return UI_M_COMM_TYPE;
	}
	public void setUI_M_COMM_TYPE(String uI_M_COMM_TYPE) {
		UI_M_COMM_TYPE = uI_M_COMM_TYPE;
	}
	/*End*/
}
