...
public class PT_IL_POL_APPL_PROD_HELPER {
    ...
    public void preInsert(PT_IL_POL_APPL_PROD pt_il_pol_appl_prod_bean,PILT002_APAC_COMPOSITE_ACTION compositeAction)
                throws Exception {
	...
	try {
    	...
    	public void  keyDelRec(PT_IL_POL_APPL_PROD_ACTION pt_il_pol_appl_prod_action,
	    			PT_IL_POLICY pt_il_policy_bean,PILT002_APAC_COMPOSITE_ACTION compositeAction)
        	throws Exception {
        String M_APPL_PROD_YN = null;
        String M_PGD_MAIN_PROD_YN = null;
        String M_PGD_MANDATORY_YN = null;
        ...
        try {
        	...
        	if (!CommonUtils.nvl(pt_il_policy_bean.getPOL_END_TYPE(), "000")
        		...
        		/*new PKG_PILT002_APAC().P_SET_DEL_RECORD_PROPERTY(
        		...
        		new PKG_PILT002_APAC().P_DEL_APPL_PROD (pt_il_pol_appl_prod_bean.getPAPP_POL_SYS_ID(),
	...
	try {
		...
		//--REV1.0 TO HANDLE DUPLICATE CHECK
		  ArrayList<String> pvalList = pkg_pilt002_apac.P_VAL_PRODUCT(pt_il_pol_appl_prod_bean.getPAPP_PROD_CODE(),
			   	CommonUtils.getProcedureValue(pt_il_policy_bean.getPOL_ISSUE_DT()),
			   	"E");
		  if(pvalList.get(0) !=null){
		      pt_il_pol_appl_prod_bean.setUI_M_PAPP_PROD_DESC(pvalList.get(0));
