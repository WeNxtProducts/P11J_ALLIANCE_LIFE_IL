 ...
 * 
 */
public class PILT002_APAC_LOCAL_PROCEDURES {

	public void IL_ENDT_002_PROPS(PILT002_APAC_COMPOSITE_ACTION compositeAction) {
	...
	public void IL_ENDT_003_004_BLK_DISABLE(
		...
		try {
			if (!"PILT041_APAC".equals(CommonUtils
				...
				pt_il_surr_mat_values_action.disableAllComponent(true);
	...
	public void IL_BLOCK_POL_DISABLED(
	    ...
	    compositeAction.getPT_IL_POLICY_1_ACTION_BEAN().disableAllComponent(true);
	    ...
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().setDELETE_ALLOWED(false);
	    
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setDELETE_ALLOWED(false);
	    
	    compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setDELETE_ALLOWED(false);
	    
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setDELETE_ALLOWED(false);
	    
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    compositeAction.getPT_IL_POL_CONDITION_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_CONDITION_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_CONDITION_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    /*compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setDELETE_ALLOWED(false);*/
	    
	    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    compositeAction.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN().setINSERT_ALLOWED(false);
	    ...
	    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setDELETE_ALLOWED(false);
	   
	    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setDELETE_ALLOWED(false);	    
	    
	    compositeAction.getPT_IL_POL_STATUS_2_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_STATUS_2_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_STATUS_2_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_STATUS_2_ACTION_BEAN().setDELETE_ALLOWED(false);
	    
	    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().disableAllComponent(true);
	    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setUPDATE_ALLOWED(false);
	    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setINSERT_ALLOWED(false);
	    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setDELETE_ALLOWED(false);
	    ...
	    /* added by R. Raja for RM018T - FSD_IL_ZB Life_010-Maximum Funeral  Benefit Limit*/
	    	...
	    	if ("S".equals(CommonUtils.nvl(compositeAction
	    		...
	    		if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
	    			...
	    			compositeAction.getPT_IL_SURR_MAT_VALUES_ACTION_BEAN().disableAllComponent(true);
	    			compositeAction.getPT_IL_SURR_MAT_VALUES_ACTION_BEAN()
	...
	public void IL_ENDT_QUOT_CHANGES(
		...
		try {
			if ("Q".equals(pt_il_policy_bean.getPOL_PROP_QUOT_FLAG())) {
				dummy_action.getCOMP_UI_M_BUT_APPROVAL().setRendered(true);
				...
				dummy_action.getCOMP_UI_M_BUT_CALC_DISC_LOAD().setRendered(false);
	...
	public void IL_BLOCK_POL_ENABLED(
		...
		.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN();
		PT_IL_POL_ASSURED_DTLS_1_ACTION assuredAction1 = compositeAction
		.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN();
		PT_IL_POL_ADDL_COVER_ACTION additionalCoverAction = compositeAction
		.getPT_IL_POL_ADDL_COVER_ACTION_BEAN();
		PT_IL_POL_ADDL_COVER_1_ACTION additionalCoverAction1 = compositeAction
		.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN();
		PT_IL_POL_DISC_LOAD_ACTION discLoadAction = compositeAction
		.getPT_IL_POL_DISC_LOAD_ACTION_BEAN();
		PT_IL_POL_CHARGE_ACTION chargeAction = compositeAction
		.getPT_IL_POL_CHARGE_ACTION_BEAN();
		PT_IL_POL_BROKER_HEAD_ACTION brokerHdrAction = compositeAction
		.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN();
		PT_IL_POL_BROKER_DTL_ACTION brokerDtlsAction = compositeAction
		.getPT_IL_POL_BROKER_DTL_ACTION_BEAN();
		PT_IL_POL_MED_EXAM_DTL_ACTION medicalExamDtlsAction = compositeAction
		.getPT_IL_POL_MED_EXAM_DTL_ACTION_BEAN();
		PT_IL_POL_ASSR_ILLNESS_DTLS_ACTION illnessDtlsAction = compositeAction
		.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN();
		PT_IL_DOC_TODO_LIST_STATUS_ACTION todoListStatusAction = compositeAction
		.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN();
		PT_IL_POL_ASSR_MED_HIST_ACTION assuredMedicalHistoryAction = compositeAction
		.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN();
		PT_IL_POL_CONDITION_ACTION policyConditionAction = compositeAction
		.getPT_IL_POL_CONDITION_ACTION_BEAN();
		PT_IL_POL_BENEFICIARY_ACTION beneficiaryAction = compositeAction
		.getPT_IL_POL_BENEFICIARY_ACTION_BEAN();
		PT_IL_POL_FUND_DTL_ACTION fundDtlsAction = compositeAction
		.getPT_IL_POL_FUND_DTL_ACTION_BEAN();
		PT_IL_UNPAID_PREM_DTLS_ACTION unpaidPremiumDtlsAction = compositeAction
		.getPT_IL_UNPAID_PREM_DTLS_ACTION_BEAN();
		PT_IL_SURR_MAT_VALUES_ACTION surrendarMaturityAction = compositeAction
		.getPT_IL_SURR_MAT_VALUES_ACTION_BEAN();
		PM_IL_DOC_TODO_GROUP_ACTION todoGroupAction = compositeAction
		.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN();
		
		// added by R. Raja on 04-01-2017 for RM018T - FSD_IL_ZB Life_010-Maximum Funeral  Benefit Limit
		
	/*	PT_IL_POL_FUNERAL_MEMB_DTLS_ACTION funeralAction=compositeAction.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN();*/
		
		//end
		
		DUMMY_ACTION dummyAction = compositeAction.getDUMMY_ACTION_BEAN();
		DUMMY dummy_bean = dummyAction.getDUMMY_BEAN();
		...
		try {
		    ...
		    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().setDELETE_ALLOWED(true);
		    ...
		    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ADDL_COVER_1_ACTION_BEAN().setDELETE_ALLOWED(true);
		    ...
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_MED_HIST_1_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_CHARGE_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_CHARGE_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_CHARGE_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_BROKER_DTL_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_BROKER_DTL_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_BROKER_DTL_ACTION_BEAN().setDELETE_ALLOWED(true);
		    ...
		    compositeAction.getPT_IL_POL_STATUS_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_STATUS_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_STATUS_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_ASSR_ILLNESS_DTLS_ACTION_BEAN().setDELETE_ALLOWED(true);
		    ...
		    compositeAction.getPT_IL_POL_DISC_LOAD_ACTION_BEAN().disableAllComponent(true);
		    compositeAction.getPT_IL_POL_DISC_LOAD_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_DISC_LOAD_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_DISC_LOAD_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_FUND_DTL_1_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POLICY2_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POLICY2_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POLICY2_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPM_IL_DOC_TODO_GROUP_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().setDELETE_ALLOWED(true);
		   ...
		   compositeAction.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN().disableAllComponents(false);
		    ...
		    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().disableAllComponent(false);
		    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_STATUS_1_ACTION_BEAN().setDELETE_ALLOWED(true);
		    
		    compositeAction.getPT_IL_POL_STATUS_2_ACTION_BEAN().disableAllComponent(false);
		    ...
		    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().disableAllComponent(false);
		    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setUPDATE_ALLOWED(true);
		    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setINSERT_ALLOWED(true);
		    compositeAction.getPT_IL_POL_SA_INST_PYMT_HEAD_ACTION_BEAN().setDELETE_ALLOWED(true);
			connection = CommonUtils.getConnection();
			if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE").substring(0, 1) )) {
				if("001".equalsIgnoreCase(CommonUtils.nvl(policyBean.getPOL_END_TYPE(),"000"))){
			    policyAction.setINSERT_ALLOWED(true);
				assuredAction.disableAllComponent(true);
				assuredAction1.disableAllComponent(true);
				additionalCoverAction.disableAllComponent(true);
				additionalCoverAction1.disableAllComponent(true);
				beneficiaryAction.disableAllComponent(false);
				assuredMedicalHistoryAction.disableAllComponent(true);
				chargeAction.disableAllComponent(true);
				brokerHdrAction.disableAllComponent(true);
				
				}else{
					policyAction.setINSERT_ALLOWED(true);
					assuredAction.disableAllComponent(false);
					assuredAction1.disableAllComponent(false);
					additionalCoverAction.disableAllComponent(false);
					additionalCoverAction1.disableAllComponent(false);
					beneficiaryAction.disableAllComponent(false);
					assuredMedicalHistoryAction.disableAllComponent(false);
					chargeAction.disableAllComponent(false);
					brokerHdrAction.disableAllComponent(false);
			...
			if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE").substring(1, 2) )) {
				...
				if("001".equalsIgnoreCase(CommonUtils.nvl(policyBean.getPOL_END_TYPE(),"000"))){
			    policyAction.setUPDATE_ALLOWED(true);
				assuredAction.disableAllComponent(true);
				assuredAction1.disableAllComponent(true);
				additionalCoverAction.disableAllComponent(true);
				additionalCoverAction1.disableAllComponent(true);
			...
			if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE").substring(2, 3))) {
			    //pt_il_policy_action.disableAllComponent(false);
				if("001".equalsIgnoreCase(CommonUtils.nvl(policyBean.getPOL_END_TYPE(),"000"))){
			    policyAction.setDELETE_ALLOWED(true);
				assuredAction.disableAllComponent(true);
				assuredAction1.disableAllComponent(true);
				additionalCoverAction.disableAllComponent(true);
				additionalCoverAction1.disableAllComponent(true);
			...
			if ("Y".equalsIgnoreCase(M_ASD_CHAR_VALUE)) {
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
					...
					brokerDtlsAction.setINSERT_ALLOWED(true);
				}
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
						.substring(1, 2) )) {

					brokerDtlsAction.setUPDATE_ALLOWED(true);
				}
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
						.substring(2, 3) )) {

					brokerDtlsAction.setDELETE_ALLOWED(true);
					
				}
				brokerDtlsAction.getCOMP_UI_M_ADD().setDisabled(false);
				brokerDtlsAction.getCOMP_UI_M_DEL().setDisabled(false);
				brokerDtlsAction.getCOMP_UI_M_POST().setDisabled(false);
			} else {
				//brokerDtlsAction.setINSERT_ALLOWED(false);
				//brokerDtlsAction.setUPDATE_ALLOWED(false);
				//brokerDtlsAction.setDELETE_ALLOWED(false);
				brokerDtlsAction.getCOMP_UI_M_ADD().setDisabled(true);
				brokerDtlsAction.getCOMP_UI_M_DEL().setDisabled(true);
				brokerDtlsAction.getCOMP_UI_M_POST().setDisabled(true);
				
			    brokerDtlsAction.disableAllComponent( true);
			}
			if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE").substring(
					0, 1) )) {
				if("001".equalsIgnoreCase(CommonUtils.nvl(policyBean.getPOL_END_TYPE(),"000"))){
				policyConditionAction.disableAllComponent(true);
				discLoadAction.disableAllComponent(true);
				surrendarMaturityAction.disableAllComponent(true);
				unpaidPremiumDtlsAction.disableAllComponent(true);
				illnessDtlsAction.disableAllComponent(true);
				medicalExamDtlsAction.disableAllComponent(true);
				todoGroupAction.disableAllComponent(true);
				todoListStatusAction.disableAllComponent(true);
				}else{
					policyConditionAction.disableAllComponent(false);
					discLoadAction.disableAllComponent(false);
					surrendarMaturityAction.disableAllComponent(false);
					unpaidPremiumDtlsAction.disableAllComponent(false);
					illnessDtlsAction.disableAllComponent(false);
					medicalExamDtlsAction.disableAllComponent(false);
					todoGroupAction.disableAllComponent(false);
					todoListStatusAction.disableAllComponent(false);
				}
			...
			if ( "N".equalsIgnoreCase(dummy_bean.getUI_M_NOTIONAL())) {
			    ...
			    fundDtlsAction.disableAllComponent( true);

			} else if ("O".equals(dummy_bean.getUI_M_NOTIONAL())) {
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
						.substring(0, 1))) {
					fundDtlsAction.setINSERT_ALLOWED(true);
					fundDtlsAction.disableAllComponent( false);
				}
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
						.substring(1, 2))) {
					fundDtlsAction.setUPDATE_ALLOWED(true);
					fundDtlsAction.disableAllComponent( false);

				}
				if ("Y".equals(CommonUtils.getGlobalVariable("GLOBAL.M_PRIVILEGE")
						.substring(2, 3))) {
					fundDtlsAction.setDELETE_ALLOWED(true);
					fundDtlsAction.disableAllComponent( false);
				}
			}
	...
	public void IL_ENDT_002_CHANGES(
		...
		PT_IL_POL_BENEFICIARY_ACTION pt_il_pol_beneficiary_action = compositeAction
		.getPT_IL_POL_BENEFICIARY_ACTION_BEAN();
		PT_IL_POL_FUNERAL_MEMB_DTLS_ACTION PT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN=compositeAction
				.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN();
	...
	/*Commentted &Modified by saritha on 06-04-2018 for KIC Duplicate Policy Number Validation Handled.*/
	...
	public void IL_UNIQUE_POL_NO(String POL_DS_TYPE, String currValue) throws Exception {

		String dupAppNumerQuery = " SELECT  'X'  FROM  PT_IL_POLICY  WHERE  POL_NO = ?  AND  POL_DS_TYPE  = ? ";
		...
		try {
			object1 = new Object[] { currValue, POL_DS_TYPE };
			connection = CommonUtils.getConnection();
			resultSet = new CRUDHandler().executeSelectStatement(dupAppNumerQuery,
					connection, object1);
	...
	public void L_INST_MAT_DTLS( PILT002_APAC_COMPOSITE_ACTION compositeAction) {
	...
	public void IL_ENDT_001_CHANGES(
		...
		PT_IL_POL_BENEFICIARY_ACTION pt_il_pol_beneficiary_action = compositeAction
		.getPT_IL_POL_BENEFICIARY_ACTION_BEAN();
		PT_IL_POL_STATUS_2_ACTION pt_il_pol_status_2_action = compositeAction
		.getPT_IL_POL_STATUS_2_ACTION_BEAN();
		PT_IL_POL_STATUS_1_ACTION pt_il_pol_status_1_action = compositeAction
		...
		try {
			...
			//Added By Haneef,to fix,After passing general endorsement, these
			//3 fields are getting enabling.
			pt_il_policy_action.getCOMP_POL_CUST_CODE().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_CONT_CODE().setDisabled(true);
			...
			//newly added
			pt_il_policy_action.getCOMP_POL_FAC_YN().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_MASTER_POL_NO().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_PAYOR_SDCODE().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_GRANTEE_NAME().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_BANK_REF_NO().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_NL_FM_DT().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_REMARKS().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_PROD_CODE().setDisabled(true);
			...
			pt_il_policy_action.getCOMP_POL_FC_TOP_UP_AMT().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_LC_EXC_INT_AMT().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_FC_EXC_INT_AMT().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_EXC_INT_PERC().setDisabled(true);
			...
			//added ends for mortage 1 and mortage disable
			// -- pt_il_policy_action.getCOMP_POL_CASH_YN().setDisabled(true);
			...
			pt_il_pol_assured_dtls_action.getCOMP_POAD_WEIGHT_UNIT()
			.setDisabled(true);
			pt_il_pol_assured_dtls_action.disableAllComponent(true);//ram
			...
			pt_il_pol_assured_dtls_1_action.getCOMP_POAD_WEIGHT_UNIT()
			.setDisabled(true);
			pt_il_pol_assured_dtls_1_action.disableAllComponent(true);//ram
			// --end
			...
			pt_il_pol_disc_load_action.setUPDATE_ALLOWED(false);
			pt_il_pol_disc_load_action.setDELETE_ALLOWED(false);
			pt_il_pol_disc_load_action.disableAllComponent(true);//ram
			...
			if (!"001".equals(CommonUtils.nvl(pt_il_policy_bean
				...
				pt_il_pol_broker_head_action.setUPDATE_ALLOWED(false);
				pt_il_pol_broker_head_action.setDELETE_ALLOWED(false);
				pt_il_pol_broker_head_action.disableAllComponent(true);//ram

				pt_il_pol_charge_action.setINSERT_ALLOWED(false);
				pt_il_pol_charge_action.setUPDATE_ALLOWED(false);
				pt_il_pol_charge_action.setDELETE_ALLOWED(false);
				pt_il_pol_charge_action.disableAllComponent(true);//ram
			...
			pt_il_pol_assr_illness_dtls_action.disableAllComponent(true);//ram
			// --BY Rajavel on 10/2/2003
			pt_il_policy_action.getCOMP_POL_JOINT_LIFE_YN().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_JOINT_LIFE_AGE().setDisabled(true);
			pt_il_policy_action.getCOMP_POL_PREM_PAY_YRS().setDisabled(true);
			...
			pt_il_doc_todo_list_status_action.getCOMP_DTLS_SR_NO().setDisabled(
					true);
			pt_il_doc_todo_list_status_action.disableAllComponent(true);//ram
			if ("Y".equals(CommonUtils.nvl(pt_il_policy_bean
					.getPOL_INCORPORATED_YN(), "N"))) {
				pt_il_policy_action.getCOMP_POL_FC_BANK_ALLOC_AMT()
				.setDisabled(true);
			...
			pt_il_pol_beneficiary_action.setINSERT_ALLOWED(true);
			pt_il_pol_beneficiary_action.setUPDATE_ALLOWED(true);
			pt_il_pol_beneficiary_action.setDELETE_ALLOWED(true);//addded by mohan for claim 
			pt_il_pol_beneficiary_action.disableAllComponent(false);//ram
			...
			pt_il_pol_addl_cover_action.getCOMP_POAC_FC_SA().setDisabled(true);
			pt_il_pol_addl_cover_action.getCOMP_POAC_LC_SA().setDisabled(true);
			//disabing comments and remainders AND CONDITION
			pt_il_pol_condition_action.setUPDATE_ALLOWED(false);
			pt_il_pol_condition_action.setINSERT_ALLOWED(false);
			pt_il_pol_condition_action.setDELETE_ALLOWED(false);
			pt_il_pol_status_2_action.setUPDATE_ALLOWED(false);
			pt_il_pol_status_2_action.setINSERT_ALLOWED(false);
			pt_il_pol_status_2_action.setDELETE_ALLOWED(false);
			pt_il_pol_status_2_action.disableAllComponent(true);
			pt_il_pol_status_1_action.setUPDATE_ALLOWED(false);
			pt_il_pol_status_1_action.setINSERT_ALLOWED(false);
			pt_il_pol_status_1_action.setDELETE_ALLOWED(false);
			pt_il_pol_status_1_action.disableAllComponent(true);
	...
	public void L_UPDATE_TABLES(Long POL_SYS_ID) throws SQLException, Exception {
		...
		try {
			...
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_ASSURED_DTLS,
					connection, object1);

			Object[] object2 = { POL_SYS_ID };
			int upd2 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_ADDL_COVER,
					connection, object2);

			Object[] object3 = { POL_SYS_ID };
			int upd3 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_BENEFICIARY,
					connection, object3);

			Object[] object4 = { POL_SYS_ID };
			int upd4 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_ASSR_MED_HIST,
					connection, object4);

			Object[] object5 = { POL_SYS_ID };
			int upd5 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_ASSR_ILLNESS_DTLS,
					connection, object5);

			Object[] object6 = { POL_SYS_ID };
			int upd6 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_MED_EXAM_DTL,
					connection, object6);

			Object[] object7 = { POL_SYS_ID };
			int upd7 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_CHARGE,
					connection, object7);

			Object[] object8 = { POL_SYS_ID };
			int upd8 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_BROKER_HEAD,
					connection, object8);

			Object[] object9 = { POL_SYS_ID };
			int upd9 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_BROKER_DTL,
					connection, object9);

			Object[] object10 = { POL_SYS_ID };
			int upd10 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_DISC_LOAD,
					connection, object10);

			Object[] object11 = { POL_SYS_ID };
			int upd11 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_CONDITION,
					connection, object11);

			Object[] object12 = { POL_SYS_ID };
			int upd12 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_RED_SA,
					connection, object12);

			Object[] object13 = { POL_SYS_ID };
			int upd13 = handler.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_FUND_DTL,
					connection, object12);

			Object[] object14 = { POL_SYS_ID };
			int upd14 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_SA_INST_PYMT_HEAD,
					connection, object12);

			Object[] object15 = { POL_SYS_ID };
			int upd15 = handler
			.executeUpdateStatement(
					PILT002_APAC_QUERY_CONSTANTS.L_UPDATE_PT_IL_POL_SA_INST_PYMT,
					connection, object12);
	...
	public void IL_SPL_REV_CHANGE(PILT002_APAC_COMPOSITE_ACTION compositeAction)
					throws SQLException, Exception {
	...
	public void IL_ENDT_004_GR_MAT_VALUE(
			PILT002_APAC_COMPOSITE_ACTION compositeAction) throws SQLException,
			Exception {
		Connection connection = null;
		connection = CommonUtils.getConnection();
		PT_IL_POLICY_ACTION action = compositeAction
	...
	public void IL_ENDT_003_SV_VALUES(
			PILT002_APAC_COMPOSITE_ACTION pilt002_apac_composite_action) {
		Double M_LC_PROFIT = null;
		Double M_FC_PROFIT = null;
		Double M_FC_SP = null;
		Double M_LC_SP = null;
		...
		PT_IL_POLICY pt_il_policy = pilt002_apac_composite_action
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
		PT_IL_SURR_MAT_VALUES pt_il_surr_mat_values = pilt002_apac_composite_action
		.getPT_IL_SURR_MAT_VALUES_ACTION_BEAN()
		.getPT_IL_SURR_MAT_VALUES_BEAN();
		DUMMY dummy_bean = pilt002_apac_composite_action.getDUMMY_ACTION_BEAN()
		.getDUMMY_BEAN();
		...
		try {
			...
			if ("A".equals(dummy_bean.getUI_M_POL_PLAN_TYPE())
				...
				IL_CALC_ISLM_SURR_VALUE(pilt002_apac_composite_action);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
...
/*Added by Shankar on 07/04/2017*/
	public boolean L_RIDER_CHECK(Long  POL_SYS_ID) {

		String CURSOR_C1=" SELECT * FROM PT_IL_POL_ADDL_COVER WHERE POAC_POL_SYS_ID= ? " ;
