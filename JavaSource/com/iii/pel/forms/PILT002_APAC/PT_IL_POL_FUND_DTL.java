...
public class PT_IL_POL_FUND_DTL extends BaseValueBean {
 ...
 public  String getUI_TO_DATE(){
	 return CommonUtils.dateToStringFormat(getPOFD_EFF_TO_DT());
 }
 
 public  String getUI_FM_DATE(){
	 return CommonUtils.dateToStringFormat(getPOFD_EFF_FM_DT());
 }
