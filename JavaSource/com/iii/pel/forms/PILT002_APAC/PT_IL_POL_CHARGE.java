...
public class PT_IL_POL_CHARGE extends BaseValueBean {
	...
	private String POC_RATE_STR;
	private String POC_LC_VALUE_STR;
	
	public String getPOC_RATE_STR() {
		return POC_RATE_STR;
	}
	public void setPOC_RATE_STR(String pOC_RATE_STR) {
		POC_RATE_STR = pOC_RATE_STR;
	}
	public String getPOC_LC_VALUE_STR() {
		return POC_LC_VALUE_STR;
	}
	public void setPOC_LC_VALUE_STR(String pOC_LC_VALUE_STR) {
		POC_LC_VALUE_STR = pOC_LC_VALUE_STR;
	}
