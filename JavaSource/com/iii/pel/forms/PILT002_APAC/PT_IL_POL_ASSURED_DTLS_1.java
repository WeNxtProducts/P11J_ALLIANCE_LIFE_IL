...
public class PT_IL_POL_ASSURED_DTLS_1 extends BaseValueBean {
	...
	@Column(name="POAD_RELATION_CODE")
	private String POAD_RELATION_CODE;
	
	@Column(name="POAD_POL_OWNER_YN")
	private String POAD_POL_OWNER_YN;
	
	private String UI_M_POAD_RELATION_DESC;
	...
	public String getPOAD_RELATION_CODE() {
		return POAD_RELATION_CODE;
	}
	public void setPOAD_RELATION_CODE(String poad_relation_code) {
		POAD_RELATION_CODE = poad_relation_code;
	}
	public String getUI_M_POAD_RELATION_DESC() {
		return UI_M_POAD_RELATION_DESC;
	}
	public void setUI_M_POAD_RELATION_DESC(String ui_m_poad_relation_desc) {
		UI_M_POAD_RELATION_DESC = ui_m_poad_relation_desc;
	}
