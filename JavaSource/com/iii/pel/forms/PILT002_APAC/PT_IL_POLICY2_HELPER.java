...
public class PT_IL_POLICY2_HELPER {
	    ...
	    if( dummy_bean.getUI_M_CALC_METHOD() == 2 || 
		  (  dummy_bean.getUI_M_CALC_METHOD() == 1 &&
			!"M".equals(CommonUtils.nvl(dummy_bean.getUI_M_POL_PLAN_TYPE(),"X"))) || 
	      	     ((dummy_bean.getUI_M_CALC_METHOD() == 1 ||dummy_bean.getUI_M_CALC_METHOD() == 2)&&
	      "M".equals(CommonUtils.nvl(dummy_bean.getUI_M_POL_PLAN_TYPE(),"X")) &&
    ...
    public void IL_ENDT_QUOT_DIFF_PREM(PILT002_APAC_COMPOSITE_ACTION compositeAction) {
    ...
    public void UI_M_POL_BASIC_RATE_WHEN_VALIDATE_ITEM(PILT002_APAC_COMPOSITE_ACTION compositeAction,
	    Double currValue){
    ...
    public void POL_FC_BASIC_PREM_WHEN_VALIDATE_ITEM(PILT002_APAC_COMPOSITE_ACTION compositeAction,
    	    String currValue){
    ...
    public void POL_BASIC_RATE2_WHEN_VALIDATE_ITEM(PILT002_APAC_COMPOSITE_ACTION compositeAction,
	    String currValue){
	PT_IL_POL_ASSURED_DTLS pt_il_pol_assured_dtls_bean = compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN();
	PT_IL_POLICY pt_il_policy_bean = compositeAction
	.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
