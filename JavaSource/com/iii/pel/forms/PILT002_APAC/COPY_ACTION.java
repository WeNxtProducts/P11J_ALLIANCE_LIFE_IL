...
import com.iii.pel.forms.PILP001_APAC.PILP001_APAC_COMPOSITE_ACTION;
...
public class COPY_ACTION extends CommonAction {
    ...
    private HtmlOutputLabel COMP_UI_SELL_ALL_LABEL;

    private HtmlSelectOneMenu COMP_UI_SELL_ALL;
    ...
    private List<SelectItem> listSelAll = new ArrayList<SelectItem>();

    public COPY_ACTION() {
    listSelAll.add(new SelectItem("Y","Yes"));
    listSelAll.add(new SelectItem("N","No"));
	COPY_BEAN = new COPY();
	...
	try {
	   ...
	   // compositeAction.getCOPY_ACTION_BEAN().setCOPY_BEAN(new COPY());
		...
		CommonUtils.getConnection().commit();
	    	...
	    	CommonUtils.setGlobalObject("PILT002_APAC_COMPOSITE_ACTION", compositeAction);
	...
	try {
	    COPY_BEAN.setUI_M_COPY_POL_ISSUE_DT((Date) value); 
		helper.UI_M_COPY_POL_ISSUE_DT_WHEN_VALIDATE_ITEM(this, 
	...
	try {
		COPY_BEAN.setUI_M_COPY_PT_IL_POL_ASS_DTL(value.toString());
	...
	public void validate_COMP_SEL_ALL(FacesContext context ,UIComponent component ,Object value){
		try{
			String objValue = (String)value;
			if(!(objValue.equalsIgnoreCase(COPY_BEAN.getUI_SEL_ALL()))){
				
			if("Y".equals(objValue)){
				COPY_BEAN.setUI_SEL_ALL("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_ASS_DTL("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_BENEF_DTL("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_ADDL_COVER("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_DISC_LOAD("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_CHARGE("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_BROKER("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_CHECK_LIST("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_COND("Y");
				COPY_BEAN.setUI_M_COPY_PT_IL_MED_HIST("Y");
				
			}else{
				COPY_BEAN.setUI_SEL_ALL("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_ASS_DTL("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_BENEF_DTL("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_ADDL_COVER("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_DISC_LOAD("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_CHARGE("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_BROKER("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_CHECK_LIST("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_POL_COND("N");
				COPY_BEAN.setUI_M_COPY_PT_IL_MED_HIST("N");
			}
			}
			COMP_UI_M_COPY_PT_IL_POL_BENEF_DTL.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_ADDL_COVER.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_DISC_LOAD.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_CHARGE.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_BROKER.resetValue();
			COMP_UI_M_COPY_PT_IL_CHECK_LIST.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_COND.resetValue();
			COMP_UI_M_COPY_PT_IL_MED_HIST.resetValue();
			COMP_UI_M_COPY_PT_IL_POL_ASS_DTL.resetValue();
		}catch (Exception e) {
			e.printStackTrace();
	...
	public HtmlOutputLabel getCOMP_UI_SELL_ALL_LABEL() {
		return COMP_UI_SELL_ALL_LABEL;
	}

	public void setCOMP_UI_SELL_ALL_LABEL(HtmlOutputLabel comp_ui_sell_all_label) {
		COMP_UI_SELL_ALL_LABEL = comp_ui_sell_all_label;
	}

	public HtmlSelectOneMenu getCOMP_UI_SELL_ALL() {
		return COMP_UI_SELL_ALL;
	}

	public void setCOMP_UI_SELL_ALL(HtmlSelectOneMenu comp_ui_sell_all) {
		COMP_UI_SELL_ALL = comp_ui_sell_all;
	}

	public List<SelectItem> getListSelAll() {
		return listSelAll;
	}

	public void setListSelAll(List<SelectItem> listSelAll) {
		this.listSelAll = listSelAll;
	}
	
	public void validateUI_M_COPY_PT_IL_POL_BENEF_DTL(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_BENEF_DTL(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_BENEF_DTL.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_BENEF_DTL",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_POL_DISC_LOAD(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_DISC_LOAD(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_DISC_LOAD.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_DISC_LOAD",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_POL_BROKER(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_BROKER(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_BROKER.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_BROKER",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_POL_COND(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_COND(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_COND.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_COND",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_POL_ADDL_COVER(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_ADDL_COVER(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_ADDL_COVER.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_ADDL_COVER",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_POL_CHARGE(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_POL_CHARGE(value.toString());
		    COMP_UI_M_COPY_PT_IL_POL_CHARGE.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_POL_CHARGE",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_CHECK_LIST(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_CHECK_LIST(value.toString());
		    COMP_UI_M_COPY_PT_IL_CHECK_LIST.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_CHECK_LIST",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
	...
	public void validateUI_M_COPY_PT_IL_MED_HIST(FacesContext facesContext,
		    UIComponent component, Object value) throws ValidatorException {
		 
		try {
			COPY_BEAN.setUI_M_COPY_PT_IL_MED_HIST(value.toString());
		    COMP_UI_M_COPY_PT_IL_MED_HIST.resetValue();
		} catch (Exception exception) {
		    exception.printStackTrace();
		    throw new ValidatorException(new FacesMessage(exception
		    ...
		    try {
			ErrorHelpUtil.getWarningForProcedure(CommonUtils
				.getConnection(), "UI_M_COPY_PT_IL_MED_HIST",
				getWarningMap());
		    } catch (Exception e) {
			e.printStackTrace();
		    }
