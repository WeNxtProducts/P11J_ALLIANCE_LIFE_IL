...
public class PT_IL_POLICY2_ACTION extends CommonAction {
	...
	try {
	    if (getPT_IL_POLICY2_BEAN().getROWID() != null && isUPDATE_ALLOWED()) {
		new CRUDHandler().executeUpdate(getPT_IL_POLICY2_BEAN(),
	    ...
	    } else if(PT_IL_POLICY2_BEAN.getROWID() == null && isINSERT_ALLOWED()){
