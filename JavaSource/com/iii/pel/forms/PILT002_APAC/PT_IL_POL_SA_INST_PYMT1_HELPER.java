...
public class PT_IL_POL_SA_INST_PYMT1_HELPER {
    ...
    public void L_VAL_PYMT_NUM_UNIQUE1(PILT002_APAC_COMPOSITE_ACTION compositeAction) 
    			throws Exception {
    ...
    public void whenNewRecordInstance(PILT002_APAC_COMPOSITE_ACTION compositeAction) 
    			throws Exception {
	PT_IL_POLICY pt_il_policy_bean = compositeAction
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
	PT_IL_POL_SA_INST_PYMT1 pt_il_pol_sa_inst_pymt1_bean = compositeAction
