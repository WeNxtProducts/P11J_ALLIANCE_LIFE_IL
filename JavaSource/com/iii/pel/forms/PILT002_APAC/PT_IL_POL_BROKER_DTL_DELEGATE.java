	...
	public void executeSelectStatement(
		...
		try {
			...
			while (resultSet.next()) {
				...
				/* Newly added By Dhinesh on 26-06-2017 for ssp call id */
				PT_IL_POL_BROKER_DTL_BEAN.setPOBD_COMM_CODE(resultSet
						.getString("POBD_COMM_CODE"));
				/* End */
...
System.out.println("POBD_RATE         "+resultSet.getDouble("POBD_RATE")+"        "
