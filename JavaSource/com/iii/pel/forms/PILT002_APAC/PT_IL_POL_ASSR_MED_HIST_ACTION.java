...
public class PT_IL_POL_ASSR_MED_HIST_ACTION extends CommonAction {
	...
	private PT_IL_POL_ASSR_MED_HIST PT_IL_POL_ASSR_MED_HIST_BEAN;

	public PILT002_APAC_COMPOSITE_ACTION compositeAction;

	private PT_IL_POL_ASSR_MED_HIST_HELPER helper;

	public PT_IL_POL_ASSR_MED_HIST_ACTION() {

		PT_IL_POL_ASSR_MED_HIST_BEAN = new PT_IL_POL_ASSR_MED_HIST();
		helper = new PT_IL_POL_ASSR_MED_HIST_HELPER();
		instantiateAllComponent();
	}
	/**
	 * Instantiates all components in PT_IL_POL_ASSR_MED_HIST_ACTION
	 */
	...
	public PT_IL_POL_ASSR_MED_HIST getPT_IL_POL_ASSR_MED_HIST_BEAN() {
		return PT_IL_POL_ASSR_MED_HIST_BEAN;
	}

	public void setPT_IL_POL_ASSR_MED_HIST_BEAN(
			PT_IL_POL_ASSR_MED_HIST PT_IL_POL_ASSR_MED_HIST_BEAN) {
		this.PT_IL_POL_ASSR_MED_HIST_BEAN = PT_IL_POL_ASSR_MED_HIST_BEAN;
	}

	public void saveRecord() {
		String message = null;
		try {
			if (getPT_IL_POL_ASSR_MED_HIST_BEAN().getROWID() == null && isINSERT_ALLOWED()) {
				helper.preInsert(compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN()
				...
				new CRUDHandler().executeInsert(getPT_IL_POL_ASSR_MED_HIST_BEAN(), CommonUtils.getConnection());
				message = Messages.getString(PELConstants.pelMessagePropertiesPath,"errorPanel$message$save");
			} else if(getPT_IL_POL_ASSR_MED_HIST_BEAN().getROWID() != null && isUPDATE_ALLOWED()){
				helper.preUpdate(getPT_IL_POL_ASSR_MED_HIST_BEAN(),
						compositeAction.getCTRL_ACTION_BEAN().getCTRL_BEAN());
				new CRUDHandler().executeUpdate(
						getPT_IL_POL_ASSR_MED_HIST_BEAN(), CommonUtils
								.getConnection());
	...
	public void onLoad(PhaseEvent event) {
		try {
			if (isBlockFlag()) {
				...
				if(PT_IL_POL_ASSR_MED_HIST_BEAN != null){
	...
	public void setCOMP_UI_M_POAD_ASSR_CODE(
			HtmlInputText comp_ui_m_poad_assr_code) {
	...
	public void setCOMP_PAMH_FIELD_01_LABEL(
			HtmlOutputLabel comp_pamh_field_01_label) {
	...
	public void setCOMP_PAMH_FIELD_02_LABEL(
			HtmlOutputLabel comp_pamh_field_02_label) {
	...
	public void setCOMP_PAMH_FIELD_03_LABEL(
			HtmlOutputLabel comp_pamh_field_03_label) {
	...
	public void setCOMP_PAMH_FIELD_04_LABEL(
			HtmlOutputLabel comp_pamh_field_04_label) {
	...
	public void setCOMP_PAMH_FIELD_05_LABEL(
			HtmlOutputLabel comp_pamh_field_05_label) {
	...
	public void setCOMP_PAMH_FIELD_06_LABEL(
			HtmlOutputLabel comp_pamh_field_06_label) {
	...
	public void setCOMP_PAMH_FIELD_07_LABEL(
			HtmlOutputLabel comp_pamh_field_07_label) {
	...
	public void setCOMP_PAMH_FIELD_08_LABEL(
			HtmlOutputLabel comp_pamh_field_08_label) {
	...
	public void setCOMP_PAMH_FIELD_09_LABEL(
			HtmlOutputLabel comp_pamh_field_09_label) {
	...
	public void setCOMP_PAMH_FIELD_10_LABEL(
			HtmlOutputLabel comp_pamh_field_10_label) {
	...
	public void setCOMP_PAMH_FIELD_12_LABEL(
			HtmlOutputLabel comp_pamh_field_12_label) {
	...
	public void setCOMP_PAMH_FIELD_13_LABEL(
			HtmlOutputLabel comp_pamh_field_13_label) {
	...
	public void setCOMP_PAMH_FIELD_14_LABEL(
			HtmlOutputLabel comp_pamh_field_14_label) {
	...
	public void setCOMP_PAMH_FIELD_15_LABEL(
			HtmlOutputLabel comp_pamh_field_15_label) {
	...
	public void setCOMP_PAMH_FIELD_16_LABEL(
			HtmlOutputLabel comp_pamh_field_16_label) {
	...
	public void setCOMP_PAMH_FIELD_17_LABEL(
			HtmlOutputLabel comp_pamh_field_17_label) {
	...
	public void setCOMP_PAMH_FIELD_18_LABEL(
			HtmlOutputLabel comp_pamh_field_18_label) {
	...
	public void setCOMP_PAMH_FIELD_19_LABEL(
			HtmlOutputLabel comp_pamh_field_19_label) {
	...
	public void setCOMP_PAMH_FIELD_20_LABEL(
			HtmlOutputLabel comp_pamh_field_20_label) {
	...
	public PT_IL_POL_ASSR_MED_HIST_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PT_IL_POL_ASSR_MED_HIST_HELPER helper) {
		this.helper = helper;
	}
	...
	public void PAMH_FIELD_01_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_01(PAMH_FIELD_01);
	...
	public void PAMH_FIELD_02_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_02(PAMH_FIELD_02);
	...
	public void PAMH_FIELD_03_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_03(PAMH_FIELD_03);
	...
	public void PAMH_FIELD_04_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_04(PAMH_FIELD_04);
	...
	public void PAMH_FIELD_05_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_05(PAMH_FIELD_05);
	...
	public void PAMH_FIELD_06_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_06(PAMH_FIELD_06);
	...
	public void PAMH_FIELD_07_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_07(PAMH_FIELD_07);
	...
	public void PAMH_FIELD_08_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_08(PAMH_FIELD_08);
	...
	public void PAMH_FIELD_09_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_09(PAMH_FIELD_09);
	...
	public void PAMH_FIELD_10_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_10(PAMH_FIELD_10);
	...
	public void PAMH_FIELD_11_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_11(PAMH_FIELD_11);
	...
	public void PAMH_FIELD_12_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_12(PAMH_FIELD_12);
	...
	public void PAMH_FIELD_13_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_13(PAMH_FIELD_13);
	...
	public void PAMH_FIELD_14_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_14(PAMH_FIELD_14);
	...
	public void PAMH_FIELD_15_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_15(PAMH_FIELD_15);
	...
	public void PAMH_FIELD_16_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_16(PAMH_FIELD_16);
	...
	public void PAMH_FIELD_17_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_17(PAMH_FIELD_17);
	...
	public void PAMH_FIELD_18_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_18(PAMH_FIELD_18);
	...
	public void PAMH_FIELD_19_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_19(PAMH_FIELD_19);
	...
	public void PAMH_FIELD_20_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		String fieldName = component.getId();
		try {
			getPT_IL_POL_ASSR_MED_HIST_BEAN().setPAMH_FIELD_20(PAMH_FIELD_20);
	...
	/**
	 * Disables all components in PT_IL_POL_ASSR_MED_HIST_ACTION
	 */
