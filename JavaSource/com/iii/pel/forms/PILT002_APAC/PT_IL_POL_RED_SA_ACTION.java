...
public class PT_IL_POL_RED_SA_ACTION extends CommonAction {
    ...
    public String UI_M_BUT_RD_SA1_WHEN_BUTTON_PRESSED() {
    	...
    	try {
    		System.out.println("********  ENTER THE UI_M_BUT_RD_SA1_WHEN_BUTTON_PRESSED *********");
    		System.out.println("pt_il_policy_bean.getPOL_SYS_ID()    : "+pt_il_policy_bean.getPOL_SYS_ID());
    		CommonUtils.setGlobalObject("GLOBAL.M_RSA_POL_SYS_ID",pt_il_policy_bean.getPOL_SYS_ID());
    		System.out.println("pt_il_policy_bean.getPOL_STATUS()    : "+pt_il_policy_bean.getPOL_STATUS());
    		if ("S".equals(CommonUtils.nvl(pt_il_policy_bean.getPOL_STATUS(),"N"))) {
    			System.out.println("TRUE bLOCK");
    			CommonUtils.setGlobalObject("GLOBAL.M_RSA_END_NO_IDX",(pt_il_policy_bean.getPOL_END_NO_IDX() -1));
    		} else {
    			System.out.println("FALSE BLOCK");
    			CommonUtils.setGlobalObject("GLOBAL.M_RSA_END_NO_IDX",pt_il_policy_bean.getPOL_END_NO_IDX());
    		}
    	} catch (Exception e) {
    		e.printStackTrace();
    		
    	}
    	return "PILT036_APAC_PT_IL_POL_RED_SA";
    }
