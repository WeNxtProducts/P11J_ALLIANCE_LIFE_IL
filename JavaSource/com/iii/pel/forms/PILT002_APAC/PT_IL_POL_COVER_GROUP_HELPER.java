...
public class PT_IL_POL_COVER_GROUP_HELPER {

    public void executeQuery(PILT002_APAC_COMPOSITE_ACTION compositeAction)
	    throws Exception {
	new PT_IL_POL_COVER_GROUP_DELEGATE()
		.executeSelectStatement(compositeAction);

	List<PT_IL_POL_COVER_GROUP> dataList = compositeAction
		.getPT_IL_POL_COVER_GROUP_ACTION_BEAN()
		.getDataList_PT_IL_POL_COVER_GROUP();
	if (dataList != null && dataList.size() > 0) {
	    PT_IL_POL_COVER_GROUP PT_IL_POL_COVER_GROUP_BEAN = dataList.get(0);
	    PT_IL_POL_COVER_GROUP_BEAN.setRowSelected(true);
	    compositeAction.getPT_IL_POL_COVER_GROUP_ACTION_BEAN()
		    .setPT_IL_POL_COVER_GROUP_BEAN(PT_IL_POL_COVER_GROUP_BEAN);
	}
    }
    
    public void preInsert(
		PT_IL_POL_COVER_GROUP  pt_il_pol_cover_group_bean,PT_IL_POL_APPL_PROD productBean) throws Exception {
	...
	try {
		connection = CommonUtils.getConnection();
			...
			while (rs1.next()) {
				 pt_il_pol_cover_group_bean.setPCG_SYS_ID( rs1.getLong(1));
			}
				// Setting default values
				pt_il_pol_cover_group_bean.setPCG_POL_SYS_ID(productBean.getPAPP_POL_SYS_ID());
				pt_il_pol_cover_group_bean.setPCG_POAD_SYS_ID(productBean.getPAPP_POAD_SYS_ID());
				pt_il_pol_cover_group_bean.setPCG_PAPP_SYS_ID(productBean.getPAPP_SYS_ID());
				pt_il_pol_cover_group_bean.setPCG_CR_DT(new CommonUtils().getCurrentDate());
				pt_il_pol_cover_group_bean.setPCG_CR_UID(CommonUtils.getControlBean().getM_USER_ID());
				pt_il_pol_cover_group_bean.setPCG_DEL_FLAG("N");
	}   catch (Exception e) {
		e.printStackTrace();
    ...
    public void preUpdate(
		PT_IL_POL_COVER_GROUP pt_il_pol_cover_group_bean) throws Exception {

	try {
		pt_il_pol_cover_group_bean.setPCG_UPD_DT(new CommonUtils().getCurrentDate());
		pt_il_pol_cover_group_bean.setPCG_UPD_UID(CommonUtils.getControlBean().getM_USER_ID());
	} catch ( Exception e) {
		e.printStackTrace();
		throw new Exception(e.getMessage());
	}
	...
	try {
		connection = CommonUtils.getConnection();
		rs1 = handler.executeSelectStatement(CURSOR_C1, connection, 
				new Object[]{ pt_il_pol_cover_group_bean.getPCG_CODE() });
			while (rs1.next()) {
				 pt_il_pol_cover_group_bean.setUI_M_PCD_CODE_DESC(rs1.getString(1));
			}
	} catch (Exception e) {
		e.printStackTrace();
		throw new Exception(e.getMessage());
    ...
    public void onPopulateDetail(PILT002_APAC_COMPOSITE_ACTION compositeAction)
	    throws Exception {
	PT_IL_POL_COVER_GROUP PT_IL_POL_COVER_GROUP = compositeAction
		.getPT_IL_POL_COVER_GROUP_ACTION_BEAN()
		.getPT_IL_POL_COVER_GROUP_BEAN();
	try {
	    if ((PT_IL_POL_COVER_GROUP.getPCG_SYS_ID() != null)
		    || (PT_IL_POL_COVER_GROUP.getPCG_POL_SYS_ID() != null)
		    || (PT_IL_POL_COVER_GROUP.getPCG_POAD_SYS_ID() != null)
		    || (PT_IL_POL_COVER_GROUP.getPCG_PAPP_SYS_ID() != null)) {
	...
	try {
	    ...
	    rs1 = handler.executeSelectStatement(CURSOR_PT_IL_POL_ADDL_COVER , connection,
		    	new Object[]{ pt_il_pol_cover_group_bean.getPCG_POL_SYS_ID(),
		    pt_il_pol_cover_group_bean.getPCG_SYS_ID() ,
		    pt_il_pol_cover_group_bean.getPCG_POAD_SYS_ID(), 
		    pt_il_pol_cover_group_bean.getPCG_PAPP_SYS_ID()});
	    if (rs1.next()) {
    ...
    public void  post_insert(
		PT_IL_POL_COVER_GROUP pt_il_pol_cover_group_bean,
	...
	try {
	    ...
	    connection = CommonUtils.getConnection();
	    		new P9ILPK_POLICY().P_INS_ADDL_COVER(
	    			pt_il_pol_cover_group_bean.getPCG_POL_SYS_ID(),
	    			pt_il_pol_appl_prod_bean.getPAPP_PROD_CODE(),
	    			pt_il_pol_cover_group_bean.getPCG_POAD_SYS_ID(),
	    			pt_il_pol_cover_group_bean.getPCG_PAPP_SYS_ID(),
	    			pt_il_pol_cover_group_bean.getPCG_CODE(),
	    			 pt_il_pol_cover_group_bean.getPCG_SYS_ID());
    ...
    public void  whenNewRecordInstance(  PT_IL_POL_COVER_GROUP pt_il_pol_cover_group_bean ,
	    PT_IL_POL_APPL_PROD pt_il_pol_appl_prod_bean) throws Exception {
    	try {
    	    pt_il_pol_cover_group_bean.setUI_M_PROD_CODE(pt_il_pol_appl_prod_bean.getPAPP_PROD_CODE());
	...
	try {
	    if(compositeAction.getPT_IL_POL_COVER_GROUP_ACTION_BEAN().getPT_IL_POL_COVER_GROUP_BEAN().getROWID()!=null){
    ...
    public void  PCG_CODE_WHEN_VALIDATE_ITEM(PT_IL_POL_COVER_GROUP pt_il_pol_cover_group, String componentValue) throws Exception {
	...
	try {
		...
		if( pt_il_pol_cover_group.getPCG_CODE() !=null){
        		rs1 = handler.executeSelectStatement(CURSOR_C1, conn, 
        			new Object[]{ pt_il_pol_cover_group.getPCG_CODE()});
        		while (rs1.next()) {
        			M_CGH_GROUP_CODE = rs1.getString(1);
        			pt_il_pol_cover_group
        					.setUI_M_PCD_CODE_DESC(rs1.getString(2));
        		}
        
        		if (M_CGH_GROUP_CODE == null) {
        			pt_il_pol_cover_group.setUI_M_PCD_CODE_DESC(null);
        			throw new Exception(Messages.getString(
        					PELConstants.pelErrorMessagePath, "92000"));
        		}
         
        		rschk_dup = handler.executeSelectStatement(chk_DUPLICATE, conn,
  		   		new Object[]{"PT_IL_POL_COVER_GROUP",
                                            "PCG_CODE",
                                            pt_il_pol_cover_group.getPCG_CODE(),
                                            "PCG_POL_SYS_ID",
                                            pt_il_pol_cover_group.getPCG_POL_SYS_ID(),
                                            "PCG_POAD_SYS_ID",
                                            pt_il_pol_cover_group.getPCG_POAD_SYS_ID(),
                                            "PCG_PAPP_SYS_ID",      
                                            pt_il_pol_cover_group.getPCG_PAPP_SYS_ID()});
  	  
          	  while(rschk_dup.next()){
          	      M_DUP_CHK = rschk_dup.getString(1);
          	  }
          	  
          	if(componentValue !=null && pt_il_pol_cover_group.getPCG_CODE()!=null){
		  	  
		      if(!(componentValue.equalsIgnoreCase( pt_il_pol_cover_group.getPCG_CODE()))){  
    ...
    public void  PCG_RATE_WHEN_VALIDATE_ITEM(  Double curValue) throws Exception {
    	if ( curValue < 0) {
    		throw new Exception(Messages.getString(PELConstants.pelErrorMessagePath, "80001"));
    	}
    }
    ...
    public void keyDelRec(PT_IL_POL_COVER_GROUP_ACTION coverGroupAction,PT_IL_POLICY policyBean,PILT002_APAC_COMPOSITE_ACTION compositeAction) throws Exception{
    		...
    		if (!"000".equals(policyBean.getPOL_END_TYPE())) {
				...
				new PKG_PILT002_APAC().P_DEL_COVER_GROUP(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_POL_SYS_ID(),
						coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_PAPP_SYS_ID(), 
						coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_SYS_ID(), 
						coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_CODE(),"1",
    		...
    		if (!"000".equals(CommonUtils.nvl(policyBean.getPOL_END_TYPE(),"000"))) {
				if ("Y".equals(CommonUtils.nvl(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_DEL_FLAG(), "N"))) {
					coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().setPCG_FC_PREM(0.00);
					coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().setPCG_LC_PREM(0.00);
				}else if ("Y".equals(CommonUtils.nvl(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_DEL_FLAG(), "N")) 
				...
				if ("Y".equals(CommonUtils.nvl(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_DEL_FLAG(), "N"))) {
					new PKG_PILT002_APAC().P_DEL_COVER_GROUP(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_POL_SYS_ID(),
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_PAPP_SYS_ID(), 
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_SYS_ID(), 
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_CODE(),"3",
							compositeAction.getPT_IL_POL_BENEFIT_ACTION_BEAN().getPT_IL_POL_BENEFIT_BEAN().getPB_POAC_SYS_ID(),
							compositeAction.getPT_IL_POL_BENEFIT_ACTION_BEAN().getPT_IL_POL_BENEFIT_BEAN().getPB_SYS_ID());
				}else{
					new PKG_PILT002_APAC().P_DEL_COVER_GROUP(coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_POL_SYS_ID(),
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_PAPP_SYS_ID(), 
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_SYS_ID(), 
							coverGroupAction.getPT_IL_POL_COVER_GROUP_BEAN().getPCG_CODE(),"2",
							compositeAction.getPT_IL_POL_BENEFIT_ACTION_BEAN().getPT_IL_POL_BENEFIT_BEAN().getPB_POAC_SYS_ID(),
							compositeAction.getPT_IL_POL_BENEFIT_ACTION_BEAN().getPT_IL_POL_BENEFIT_BEAN().getPB_SYS_ID());
				}
			}
