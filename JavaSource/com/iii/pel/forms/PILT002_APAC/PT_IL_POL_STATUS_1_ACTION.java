...
public class PT_IL_POL_STATUS_1_ACTION extends CommonAction {
	...
	/*Modified by ganesh on 24-05-2017, for Factory testing point */
	private HtmlInputTextarea COMP_PS_STATUS_CODE;
	/*end*/
	...
	/*Modified by ganesh on 24-05-2017, for Factory testing point */
	public HtmlInputTextarea getCOMP_PS_STATUS_CODE() {
	...
	public void setCOMP_PS_STATUS_CODE(HtmlInputTextarea comp_PS_status_code) {
	...
	public void instantiateAllComponent(){
		...
		/*Modified by ganesh on 24-05-2017, for Factory testing point */
		COMP_PS_STATUS_CODE				 = new HtmlInputTextarea();
		/*end*/
	...
	/*Added by Ganesh on 25.05.2017 as part of factory testing feedback reminder*/
	public void validatorPS_REMARKS(FacesContext context,
			UIComponent component, Object value) {
		try {
			PT_IL_POL_STATUS_1_BEAN.setPS_REMARKS((String) value);
