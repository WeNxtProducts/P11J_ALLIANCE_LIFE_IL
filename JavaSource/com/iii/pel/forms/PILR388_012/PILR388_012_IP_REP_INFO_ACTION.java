package com.iii.pel.forms.PILR388_012;
...
public class PILR388_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR388_012_HELPER helper;
	PILR388_012_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR388_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR388_012_HELPER();
		delegate=new PILR388_012_DELEGATE();
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR388_012_HELPER helper=new PILR388_012_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovAgentCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR388_012_QUERY_CONSTANTS.AGENT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR388_012_QUERY_CONSTANTS.AGENT_CODE_QUERY_LIKE;
		}
	...
	public List<LovBean> lovGranteeCode1(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR388_012_QUERY_CONSTANTS.CUST_CLASS;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR388_012_QUERY_CONSTANTS.CUST_CLASS_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUnitCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR388_012_QUERY_CONSTANTS.UNIT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR388_012_QUERY_CONSTANTS.UNIT_CODE_QUERY_LIKE;
		}
