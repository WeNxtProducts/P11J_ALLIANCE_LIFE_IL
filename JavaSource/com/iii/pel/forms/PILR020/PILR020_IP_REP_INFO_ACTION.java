package com.iii.pel.forms.PILR020;
...
public class PILR020_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR020_HELPER helper;
	PILR020_DELEGATE delegate;

	private List<SelectItem> listM_POL_NO;

	public PILR020_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR020_HELPER();
		delegate = new PILR020_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_POL_NO = new ArrayList<SelectItem>();
			listM_POL_NO = ListItemUtil.getDropDownListValue(connection,
					"PILR035", "REP_PARAM", "REP_PARAM.M_POL_NO", "RSTM01");
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_FM_POL_CLASS_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_FM());
				map.put("P_TO_POL_CLASS_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_TO());
				map.put("P_FM_POL_PROD_CODE", IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM());
				map.put("P_TO_POL_PROD_CODE", IP_REP_INFO_BEAN.getUI_M_PROD_CODE_TO());
				map.put("P_PR_TXN_FM_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_DT()));
				map.put("P_PR_TXN_TO_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_DT()));
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR020_HELPER helper=new PILR020_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR020_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR020_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR020_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR020_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR020_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR020_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value) {
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR035", "REP_PARAM", "M_POL_NO",
	...
	public List<LovBean> lovUI_M_BANK(Object value) {
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR035", "REP_PARAM",
	...
	public void whenValidateUI_M_PROD_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_PROD_CODE_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_PROD_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_PROD_CODE_FM(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_PROD_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		...
		if (input.getSubmittedValue() == null
				|| input.getSubmittedValue().toString().isEmpty()) {
			if (IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM())) {
					this.IP_REP_INFO_BEAN
							.setUI_M_PROD_CODE_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_PROD_TO_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN
					.setUI_M_PROD_CODE_TO(IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM());
					getIP_REP_INFO_BEAN().setUI_M_PROD_TO_DESC(IP_REP_INFO_BEAN.getUI_M_PROD_FM_DESC());
				}
			}
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_PROD_CODE_TO(input.getValue()
						.toString());
			}
		}
	...
	public void validateUI_M_PROD_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
	...
	public void validateUI_M_CLASS_TO(FacesContext facesContext,
		...
		try {
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_CLASS_TO", getWarningMap());
	...
	public void validateUI_M_PROD_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
	...
	public List<LovBean> lovUI_M_PROD_CODE(Object obj) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR035", "REP_PARAM",
					"M_FM_PROD_CODE", null, null, null, null, null,
					(String) obj);
	...
	public List<SelectItem> getListM_POL_NO() {
		return listM_POL_NO;
	}

	public void setListM_POL_NO(List<SelectItem> listM_POL_NO) {
		this.listM_POL_NO = listM_POL_NO;
	}
