...
public class PILR246_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR246_012_HELPER helper;
	PILR246_012_DELEGATE delegate;

	public PILR246_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR246_012_HELPER();
		delegate = new PILR246_012_DELEGATE();
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR246_012_HELPER helper = new PILR246_012_HELPER();
	...
	public PILR246_012_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR246_012_HELPER helper) {
		this.helper = helper;
	}

	public PILR246_012_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR246_012_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR246_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR246_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR246_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR246_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_PROD_CODE(Object obj) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR246_012",
		...
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_FM() != null) {
				...
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
					...
					this.IP_REP_INFO_BEAN
							.setUI_M_TO_FUND_TYPE_DESC(IP_REP_INFO_BEAN
		...
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FM_PYMT_MODE() != null) {
				...
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
					...
					this.IP_REP_INFO_BEAN
							.setUI_M_TO_PYMT_MODE_DESC(IP_REP_INFO_BEAN
	...
	public List<LovBean> lovUI_M_AGENT_CODE(Object event) {
		...
		try {
			...
			suggestionList = (ArrayList<LovBean>) brokerCodeSuggestion(
					(String) event, CommonUtils.getControlBean()
							.getM_DIVN_CODE());
		} catch (Exception e) {
