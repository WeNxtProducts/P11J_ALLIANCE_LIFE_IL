...
public class CTRL extends BaseValueBean {
	...
	private String M_DELETE_MSG_FLAG;
	...
	public String getM_DELETE_MSG_FLAG() {
		return M_DELETE_MSG_FLAG;
	}

	public void setM_DELETE_MSG_FLAG(String m_delete_msg_flag) {
		M_DELETE_MSG_FLAG = m_delete_msg_flag;
	}
