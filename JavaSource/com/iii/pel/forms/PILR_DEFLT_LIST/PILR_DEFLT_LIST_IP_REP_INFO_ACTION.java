...
public class PILR_DEFLT_LIST_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR_DEFLT_LIST_HELPER helper;
	PILR_DEFLT_LIST_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR_DEFLT_LIST_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR_DEFLT_LIST_HELPER();
		delegate=new PILR_DEFLT_LIST_DELEGATE();
	...
	public String runAction() {
		...
		IP_REP_INFO_BEAN.setREP_ID("PILR_REPDEMO");
		...
		try
		{
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				if (IP_REP_INFO_BEAN.getROWID() == null) {
					...
					IP_REP_INFO_BEAN.setREP_VALUE_2(CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_DATE_TO()));
					IP_REP_INFO_BEAN.setREP_VALUE_3("001");
					IP_REP_INFO_BEAN.setREP_ID("PILR_REPDEMO");
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR_DEFLT_LIST_HELPER helper=new PILR_DEFLT_LIST_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR_DEFLT_LIST_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_DEFLT_LIST_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_DEFLT_LIST_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_DEFLT_LIST_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
