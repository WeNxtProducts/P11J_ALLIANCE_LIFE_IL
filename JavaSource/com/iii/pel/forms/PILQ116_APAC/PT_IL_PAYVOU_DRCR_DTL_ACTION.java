...
public class PT_IL_PAYVOU_DRCR_DTL_ACTION extends CommonAction {
	...
	private PT_IL_PAYVOU_DRCR_DTL_HELPER helper;

	private List<PT_IL_PAYVOU_DRCR_DTL> dataList_PT_IL_PAYVOU_DRCR_DTL = new ArrayList<PT_IL_PAYVOU_DRCR_DTL>();
	...
	public PT_IL_PAYVOU_DRCR_DTL_ACTION() {
		...
		helper = new PT_IL_PAYVOU_DRCR_DTL_HELPER();
	}
	...
	public List<PT_IL_PAYVOU_DRCR_DTL> getDataList_PT_IL_PAYVOU_DRCR_DTL() {
		return dataList_PT_IL_PAYVOU_DRCR_DTL;
	}

	public void setDataListPT_IL_PAYVOU_DRCR_DTL(
			List<PT_IL_PAYVOU_DRCR_DTL> dataList_PT_IL_PAYVOU_DRCR_DTL) {
		this.dataList_PT_IL_PAYVOU_DRCR_DTL = dataList_PT_IL_PAYVOU_DRCR_DTL;
	}
