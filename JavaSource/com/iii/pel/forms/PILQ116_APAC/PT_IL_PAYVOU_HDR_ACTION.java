...
public class PT_IL_PAYVOU_HDR_ACTION extends CommonAction {
	...
	private PT_IL_PAYVOU_HDR_HELPER helper;

	private List<PT_IL_PAYVOU_HDR> dataList_PT_IL_PAYVOU_HDR = new ArrayList<PT_IL_PAYVOU_HDR>();
	...
	public PT_IL_PAYVOU_HDR_ACTION() {
		...
		helper = new PT_IL_PAYVOU_HDR_HELPER();
	}
	...
	public List<PT_IL_PAYVOU_HDR> getDataList_PT_IL_PAYVOU_HDR() {
		return dataList_PT_IL_PAYVOU_HDR;
	}

	public void setDataListPT_IL_PAYVOU_HDR(
			List<PT_IL_PAYVOU_HDR> dataList_PT_IL_PAYVOU_HDR) {
		this.dataList_PT_IL_PAYVOU_HDR = dataList_PT_IL_PAYVOU_HDR;
	}
	...
	public void setDataList_PT_IL_PAYVOU_HDR(
			List<PT_IL_PAYVOU_HDR> dataList_PT_IL_PAYVOU_HDR) {
		this.dataList_PT_IL_PAYVOU_HDR = dataList_PT_IL_PAYVOU_HDR;
	}
}