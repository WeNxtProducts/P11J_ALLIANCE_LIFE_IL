...
public class PT_IL_PAYVOU_PAY_DTL_ACTION extends CommonAction {
	...
	private PT_IL_PAYVOU_PAY_DTL_HELPER helper;

	private List<PT_IL_PAYVOU_PAY_DTL> dataList_PT_IL_PAYVOU_PAY_DTL = new ArrayList<PT_IL_PAYVOU_PAY_DTL>();
	...
	public List<PT_IL_PAYVOU_PAY_DTL> getDataList_PT_IL_PAYVOU_PAY_DTL() {
		return dataList_PT_IL_PAYVOU_PAY_DTL;
	}

	public void setDataListPT_IL_PAYVOU_PAY_DTL(
			List<PT_IL_PAYVOU_PAY_DTL> dataList_PT_IL_PAYVOU_PAY_DTL) {
		this.dataList_PT_IL_PAYVOU_PAY_DTL = dataList_PT_IL_PAYVOU_PAY_DTL;
	}
