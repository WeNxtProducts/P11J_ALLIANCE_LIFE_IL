...
public class IP_REP_INFO_ACTION  extends CommonAction{
	...
	public IP_REP_INFO_ACTION(){
		...
		CommonUtils.setGlobalVariable("MENU_PARAMETER_01", "PILR_REP009");
	...
	public void submitToBranch(ActionEvent e) {
		...
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
		System.out.println("submitToBranch Set :" + inputString);
		if (inputString != null) {
	...
	public void submitFromClaim(ActionEvent e) {
		WHEN_VALIDATE_COMP_FROM_CLAIM_CODE();
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
	...
	public void submitToClaim(ActionEvent e) {
		WHEN_VALIDATE_COMP_TO_CLAIM_CODE();
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
	...
	public void submitFromClaimType(ActionEvent e) {
		WHEN_VALIDATE_COMP_FROM_CLAIM_TYPE_CODE();
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
	...
	public void submitToClaimType(ActionEvent e) {
		WHEN_VALIDATE_COMP_TO_CLAIM_TYPE_CODE();
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
...
//			
	...
	"PR_VALIDATE_FM_TO");
				...
				System.out.println("PILP024.to_Policy_code action \n--------------- OUTPUTPARAM -----------------	--\n"+((OracleParameter)resultList.get(0)).getValue()+"\n----------------");
	...
	public void WHEN_VALIDATE_COMP_FROM_CLAIM_CODE(){
		if("".equals(getCOMP_FROM_CLAIM_NO().getSubmittedValue().toString()) ){
			getCOMP_FROM_CLAIM_NO().setSubmittedValue(P_SET_FIRST_FIELD(getCOMP_FROM_CLAIM_NO().getSubmittedValue().toString(),getCOMP_TO_CLAIM_NO().getSubmittedValue().toString()));
		}else if(!"".equals(getCOMP_TO_CLAIM_NO().getSubmittedValue().toString()))
			L_VAL_FROM_TO(getCOMP_FROM_CLAIM_NO().getSubmittedValue().toString(),getCOMP_TO_CLAIM_NO().getSubmittedValue().toString());
	}
	
	
	public void WHEN_VALIDATE_COMP_TO_CLAIM_CODE(){
		if("".equals(getCOMP_TO_CLAIM_NO().getSubmittedValue().toString())){
			getCOMP_TO_CLAIM_NO().setSubmittedValue(P_SET_SECOND_FIELD(getCOMP_FROM_CLAIM_NO().getSubmittedValue().toString(),getCOMP_TO_CLAIM_NO().getSubmittedValue().toString()));
		}else{
			L_VAL_FROM_TO(getCOMP_FROM_CLAIM_NO().getSubmittedValue().toString(),getCOMP_TO_CLAIM_NO().getSubmittedValue().toString());
		}
	}
	
	public void WHEN_VALIDATE_COMP_FROM_CLAIM_TYPE_CODE(){
		if("".equals(getCOMP_FROM_CLAIM_TYPE().getSubmittedValue().toString()) ){
			getCOMP_FROM_CLAIM_TYPE().setSubmittedValue(P_SET_FIRST_FIELD(getCOMP_FROM_CLAIM_TYPE().getSubmittedValue().toString(),getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString()));
		}else if(!"".equals(getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString()))
			L_VAL_FROM_TO(getCOMP_FROM_CLAIM_TYPE().getSubmittedValue().toString(),getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString());
	}
	
	
	public void WHEN_VALIDATE_COMP_TO_CLAIM_TYPE_CODE(){
		if("".equals(getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString())){
			getCOMP_TO_CLAIM_TYPE().setSubmittedValue(P_SET_SECOND_FIELD(getCOMP_FROM_CLAIM_TYPE().getSubmittedValue().toString(),getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString()));
		}else{
			L_VAL_FROM_TO(getCOMP_FROM_CLAIM_TYPE().getSubmittedValue().toString(),getCOMP_TO_CLAIM_TYPE().getSubmittedValue().toString());
		}
	}
