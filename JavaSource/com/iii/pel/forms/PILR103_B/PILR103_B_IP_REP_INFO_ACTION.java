...
public class PILR103_B_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR103_B_HELPER helper;
	PILR103_B_DELEGATE delegate;

	private List<SelectItem> listM_POL_NO;

	public PILR103_B_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR103_B_HELPER();
		delegate = new PILR103_B_DELEGATE();
	...
	public String runAction() {
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR103_B_HELPER helper=new PILR103_B_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR103_B_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR103_B_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR103_B_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR103_B_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR103_B_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR103_B_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
