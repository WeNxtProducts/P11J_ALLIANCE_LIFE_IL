...
public void executeSelectStatement (PILP026_COMPOSITE_ACTION PILP026_COMPOSITE_ACTION_BEAN) throws Exception { 
...
PT_IL_POLICY_BEAN.setPOL_PERIOD(resultSet.getDouble("POL_PERIOD"));
...
PT_IL_POLICY_BEAN.setPOL_END_NO_IDX(resultSet.getDouble("POL_END_NO_IDX"));
...
PT_IL_POLICY_BEAN.setPOL_JOINT_LIFE_AGE(resultSet.getDouble("POL_JOINT_LIFE_AGE"));
PT_IL_POLICY_BEAN.setPOL_PREM_PAY_YRS(resultSet.getDouble("POL_PREM_PAY_YRS"));
...
PT_IL_POLICY_BEAN.setPOL_NO_OF_INST(resultSet.getDouble("POL_NO_OF_INST"));
PT_IL_POLICY_BEAN.setPOL_ORG_NO_OF_INST(resultSet.getDouble("POL_ORG_NO_OF_INST"));
...
PT_IL_POLICY_BEAN.setPOL_LINK_SYS_ID(resultSet.getLong("POL_LINK_SYS_ID"));
...
PT_IL_POLICY_BEAN.setPOL_PERIOD_MON(resultSet.getDouble("POL_PERIOD_MON"));
...
PT_IL_POLICY_BEAN.setPOL_NEW_FC_SA(resultSet.getDouble("POL_NEW_FC_SA"));
PT_IL_POLICY_BEAN.setPOL_NEW_LC_SA(resultSet.getDouble("POL_NEW_LC_SA"));
PT_IL_POLICY_BEAN.setPOL_ORG_NEW_FC_SA(resultSet.getDouble("POL_ORG_NEW_FC_SA"));
PT_IL_POLICY_BEAN.setPOL_ORG_NEW_LC_SA(resultSet.getDouble("POL_ORG_NEW_LC_SA"));
PT_IL_POLICY_BEAN.setPOL_PAYOR_SDCODE(resultSet.getString("POL_PAYOR_SDCODE"));
PT_IL_POLICY_BEAN.setPOL_ENROL_YN(resultSet.getString("POL_ENROL_YN"));
...
PT_IL_POLICY_BEAN.setPOL_AUTH_LIMIT(resultSet.getDouble("POL_AUTH_LIMIT"));
PT_IL_POLICY_BEAN.setPOL_DEF_IMM_FLAG(resultSet.getString("POL_DEF_IMM_FLAG"));
PT_IL_POLICY_BEAN.setPOL_FC_MON_ANNU_AMT(resultSet.getDouble("POL_FC_MON_ANNU_AMT"));
PT_IL_POLICY_BEAN.setPOL_LC_MON_ANNU_AMT(resultSet.getDouble("POL_LC_MON_ANNU_AMT"));
PT_IL_POLICY_BEAN.setPOL_DEF_PERIOD_FM(resultSet.getDouble("POL_DEF_PERIOD_FM"));
PT_IL_POLICY_BEAN.setPOL_DEF_PERIOD_TO(resultSet.getDouble("POL_DEF_PERIOD_TO"));
PT_IL_POLICY_BEAN.setPOL_WAQAF_PERIOD_FM(resultSet.getDouble("POL_WAQAF_PERIOD_FM"));
PT_IL_POLICY_BEAN.setPOL_WAQAF_PERIOD_TO(resultSet.getDouble("POL_WAQAF_PERIOD_TO"));
PT_IL_POLICY_BEAN.setPOL_ORG_FC_MON_ANNU_AMT(resultSet.getDouble("POL_ORG_FC_MON_ANNU_AMT"));
PT_IL_POLICY_BEAN.setPOL_ORG_LC_MON_ANNU_AMT(resultSet.getDouble("POL_ORG_LC_MON_ANNU_AMT"));
PT_IL_POLICY_BEAN.setPOL_PROD_GROUP_CODE(resultSet.getString("POL_PROD_GROUP_CODE"));
PT_IL_POLICY_BEAN.setPOL_UPLOAD_ID(resultSet.getString("POL_UPLOAD_ID"));
PT_IL_POLICY_BEAN.setPOL_PABAL_INSUF_YN(resultSet.getString("POL_PABAL_INSUF_YN"));
PT_IL_POLICY_BEAN.setPOL_FLEX_11(resultSet.getString("POL_FLEX_11"));
PT_IL_POLICY_BEAN.setPOL_FLEX_12(resultSet.getString("POL_FLEX_12"));
PT_IL_POLICY_BEAN.setPOL_FLEX_13(resultSet.getString("POL_FLEX_13"));
PT_IL_POLICY_BEAN.setPOL_FLEX_14(resultSet.getString("POL_FLEX_14"));
PT_IL_POLICY_BEAN.setPOL_FLEX_15(resultSet.getString("POL_FLEX_15"));
PT_IL_POLICY_BEAN.setPOL_FLEX_16(resultSet.getString("POL_FLEX_16"));
PT_IL_POLICY_BEAN.setPOL_FLEX_17(resultSet.getString("POL_FLEX_17"));
PT_IL_POLICY_BEAN.setPOL_FLEX_18(resultSet.getString("POL_FLEX_18"));
PT_IL_POLICY_BEAN.setPOL_FLEX_19(resultSet.getString("POL_FLEX_19"));
PT_IL_POLICY_BEAN.setPOL_FLEX_20(resultSet.getString("POL_FLEX_20"));
PT_IL_POLICY_BEAN.setPOL_ESC_PREM(resultSet.getDouble("POL_ESC_PREM"));
PT_IL_POLICY_BEAN.setPOL_ESC_SA(resultSet.getDouble("POL_ESC_SA"));
PT_IL_POLICY_BEAN.setPOL_FLEX_21(resultSet.getString("POL_FLEX_21"));
PT_IL_POLICY_BEAN.setPOL_STP_YN(resultSet.getString("POL_STP_YN"));
PT_IL_POLICY_BEAN.setPOL_PREM_WAIVE_INT_RATE(resultSet.getDouble("POL_PREM_WAIVE_INT_RATE"));
PT_IL_POLICY_BEAN.setPOL_PREM_WAIVE_TYPE(resultSet.getString("POL_PREM_WAIVE_TYPE"));
PT_IL_POLICY_BEAN.setPOL_PREM_WAIVE_FIX_AMOUNT(resultSet.getDouble("POL_PREM_WAIVE_FIX_AMOUNT"));
PT_IL_POLICY_BEAN.setPOL_FC_ANNUAL_CONTR(resultSet.getDouble("POL_FC_ANNUAL_CONTR"));
PT_IL_POLICY_BEAN.setPOL_LC_ANNUAL_CONTR(resultSet.getDouble("POL_LC_ANNUAL_CONTR"));
PT_IL_POLICY_BEAN.setPOL_PA_AUTH(resultSet.getString("POL_PA_AUTH"));
PT_IL_POLICY_BEAN.setPOL_MICR_CODE(resultSet.getDouble("POL_MICR_CODE"));
PT_IL_POLICY_BEAN.setPOL_CUST_BANK_CODE(resultSet.getDouble("POL_CUST_BANK_CODE"));
PT_IL_POLICY_BEAN.setPOL_PABAL_INSUF(resultSet.getString("POL_PABAL_INSUF"));

}
PILP026_COMPOSITE_ACTION_BEAN.getPT_IL_POLICY_ACTION_BEAN().setPT_IL_POLICY_BEAN(PT_IL_POLICY_BEAN);
 } 
 finally { 
