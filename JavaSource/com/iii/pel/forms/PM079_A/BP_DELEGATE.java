...
BP_BEAN.setPROFIDEMINITYAMT(resultSet.getDouble("PROFIDEMINITYAMT"));
BP_BEAN.setPARENTBPID(resultSet.getDouble("PARENTBPID"));
BP_BEAN.setCG_PAYMENTMODE(resultSet.getDouble("CG_PAYMENTMODE"));
BP_BEAN.setDDASTARTNUMBER(resultSet.getDouble("DDASTARTNUMBER"));
BP_BEAN.setDDAENDNUMBER(resultSet.getDouble("DDAENDNUMBER"));
BP_BEAN.setDDALASTNUMBER(resultSet.getDouble("DDALASTNUMBER"));
BP_BEAN.setCG_BPNATIONALITY(resultSet.getDouble("CG_BPNATIONALITY"));
...
BP_BEAN.setISAPPROVEDFORSUBSIDY(resultSet.getString("ISAPPROVEDFORSUBSIDY"));
...
BP_BEAN.setSECOND_DIRNAME(resultSet.getString("SECOND_DIRNAME"));
BP_BEAN.setTHIRD_DIRNAME(resultSet.getString("THIRD_DIRNAME"));
BP_BEAN.setCHIEF_ACCOUNTANT(resultSet.getString("CHIEF_ACCOUNTANT"));
BP_BEAN.setMIN_SAFETY_NET(resultSet.getDouble("MIN_SAFETY_NET"));
BP_BEAN.setCG_BILLINGCYCLE(resultSet.getDouble("CG_BILLINGCYCLE"));
BP_BEAN.setCG_CURRENCY(resultSet.getDouble("CG_CURRENCY"));
BP_BEAN.setCG_DISTRICTCODE(resultSet.getDouble("CG_DISTRICTCODE"));
...
PM079_A_COMPOSITE_ACTION_BEAN.getBP_ACTION_BEAN().setBP_BEAN(BP_BEAN);
 } 
 finally { 
