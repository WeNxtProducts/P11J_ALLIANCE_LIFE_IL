...
public class PILR017_01_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR017_01_HELPER helper;
	PILR017_01_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR017_01_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR017_01_HELPER();
		delegate=new PILR017_01_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_MODULE_CODE_FM = ListItemUtil.getDropDownListValue(connection, "PILR069_APAC", 
	...
	new PILR017_01_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
		...
		/*		map.put("P_DIVN_FM_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
				...
				*/
				map.put("P_FM_DATE",IP_REP_INFO_BEAN.getREP_VALUE_7());
				map.put("P_TO_DATE",IP_REP_INFO_BEAN.getREP_VALUE_8());
				map.put("P_MICR_CODE",IP_REP_INFO_BEAN.getREP_VALUE_10());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR017_01_HELPER helper=new PILR017_01_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR017_01_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR017_01_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovDivnCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR069_APAC", "REP_PARAM", "M_PR_DIVN_FM_CODE", 
	...
	public List<LovBean> lovDeptCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR069_APAC", "REP_PARAM", "M_DEPT_FM_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR069_APAC", "REP_PARAM", "M_FM_PROD_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovPlanType(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR069_APAC", "REP_PARAM", "M_FM_PLAN_TYPE", 
	...
	public List<LovBean> lovTrans_Fm(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
	...
	public List<LovBean> prepareLovListTrans(String query, Object[] obj) {
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR017_01_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR017_01_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public void validatorMICR_NO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		try {
			IP_REP_INFO_BEAN.setUI_M_MICR_NO((String)value);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_MICR_NO", getWarningMap());
	...
	public List<LovBean> micrLov(Object event) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = "SELECT PMD_MICR_CODE,PMD_MICR_CODE FROM PM_BANK_DTLS WHERE ROWNUM < ?";
		} else {
			object = new Object[] { code + "%",
					PELConstants.suggetionRecordSize };
			query = "SELECT PMD_MICR_CODE,PMD_MICR_CODE FROM PM_BANK_DTLS WHERE  PMD_MICR_CODE LIKE ? AND ROWNUM < ? " ;
		...
		try {
			...
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
					e.getMessage());
			getErrorMap().put("MICR_CODE", e.getMessage());
		}
		return suggestionList;
	}
