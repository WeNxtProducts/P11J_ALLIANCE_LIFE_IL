...
@Table(name="PS_IL_DRCR_TREATY")
public class PS_IL_DRCR_TREATY extends BaseValueBean {
	...
	public void setUI_M_DRCR_TOT_DR(Double UI_M_DRCR_TOT_DR) {
		this.UI_M_DRCR_TOT_DR = UI_M_DRCR_TOT_DR;
	}
	...
	public void setUI_M_DRCR_TOT_CR(Double UI_M_DRCR_TOT_CR) {
		this.UI_M_DRCR_TOT_CR = UI_M_DRCR_TOT_CR;
	}
	...
	public Double getUI_M_DRCR_DR() {
		return UI_M_DRCR_DR;
	}

	public void setUI_M_DRCR_DR(Double ui_m_drcr_dr) {
		UI_M_DRCR_DR = ui_m_drcr_dr;
	}
}
