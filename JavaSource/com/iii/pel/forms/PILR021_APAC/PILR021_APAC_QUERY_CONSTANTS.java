...
public interface PILR021_APAC_QUERY_CONSTANTS {
	...
	String AGENT_QUERY_LIKE=
		" SELECT CUST_CODE, CUST_NAME FROM PM_CUSTOMER,PM_CUST_CLASS WHERE CCLAS_TYPE IN (?,?,?,?,?,?,?,?,?,?) AND CUST_CLASS = CCLAS_CODE" +
