...
public class IP_REP_INFO extends BaseValueBean {
	...
	private Date UI_M_FM_APR_DT;
	private Date UI_M_TO_APR_DT;
	private Date UI_M_FM_CS_DT;
	private Date UI_M_TO_CS_DT;
	private String UI_M_TO_PYMT_MODE;
	private String UI_M_FM_PYMT_MODE;
	private String UI_M_PROD_FM;
	private String UI_M_PROD_TO;
	private String UI_M_USER_FM;
	private String UI_M_USER_TO;
	private String UI_M_FM_AGENT_CODE;
	private String UI_M_TO_AGENT_CODE;
	private String UI_M_FUND_TYPE_FM;
	private String UI_M_FUND_TYPE_TO;
	private Integer UI_M_FM_CHQ_NO;
	private Integer UI_M_TO_CHQ_NO;
	...
	private String UI_M_FM_FUND_TYPE_DESC;
	private String UI_M_TO_FUND_TYPE_DESC;
	private String UI_M_FM_PYMT_MODE_DESC;
	private String UI_M_TO_PYMT_MODE_DESC;
	private String UI_M_USER_FM_DESC;
	private String UI_M_USER_TO_DESC;
	private Integer UI_M_FM_CHQ_NO_DESC;
	private Integer UI_M_TO_CHQ_NO_DESC;
	...
	public Date getUI_M_FM_APR_DT() {
		return UI_M_FM_APR_DT;
	}

	public void setUI_M_FM_APR_DT(Date ui_m_fm_apr_dt) {
		UI_M_FM_APR_DT = ui_m_fm_apr_dt;
	}

	public Date getUI_M_TO_APR_DT() {
		return UI_M_TO_APR_DT;
	}

	public void setUI_M_TO_APR_DT(Date ui_m_to_apr_dt) {
		UI_M_TO_APR_DT = ui_m_to_apr_dt;
	}

	public Date getUI_M_FM_CS_DT() {
		return UI_M_FM_CS_DT;
	}

	public void setUI_M_FM_CS_DT(Date ui_m_fm_cs_dt) {
		UI_M_FM_CS_DT = ui_m_fm_cs_dt;
	}

	public Date getUI_M_TO_CS_DT() {
		return UI_M_TO_CS_DT;
	}

	public void setUI_M_TO_CS_DT(Date ui_m_to_cs_dt) {
		UI_M_TO_CS_DT = ui_m_to_cs_dt;
	}

	public String getUI_M_TO_PYMT_MODE() {
		return UI_M_TO_PYMT_MODE;
	}

	public void setUI_M_TO_PYMT_MODE(String ui_m_to_pymt_mode) {
		UI_M_TO_PYMT_MODE = ui_m_to_pymt_mode;
	}

	public String getUI_M_FM_PYMT_MODE() {
		return UI_M_FM_PYMT_MODE;
	}

	public void setUI_M_FM_PYMT_MODE(String ui_m_fm_pymt_mode) {
		UI_M_FM_PYMT_MODE = ui_m_fm_pymt_mode;
	}
	...
	public String getUI_M_USER_FM() {
		return UI_M_USER_FM;
	}

	public void setUI_M_USER_FM(String ui_m_user_fm) {
		UI_M_USER_FM = ui_m_user_fm;
	}

	public String getUI_M_USER_TO() {
		return UI_M_USER_TO;
	}

	public void setUI_M_USER_TO(String ui_m_user_to) {
		UI_M_USER_TO = ui_m_user_to;
	}
	...
	public String getUI_M_FUND_TYPE_FM() {
		return UI_M_FUND_TYPE_FM;
	}

	public void setUI_M_FUND_TYPE_FM(String ui_m_fund_type_fm) {
		UI_M_FUND_TYPE_FM = ui_m_fund_type_fm;
	}

	public String getUI_M_FUND_TYPE_TO() {
		return UI_M_FUND_TYPE_TO;
	}

	public void setUI_M_FUND_TYPE_TO(String ui_m_fund_type_to) {
		UI_M_FUND_TYPE_TO = ui_m_fund_type_to;
	}
	...
	public void setUI_M_FM_AGENT_DESC(String ui_m_fm_agent_desc) {
		UI_M_FM_AGENT_DESC = ui_m_fm_agent_desc;
	}
	...
	public void setUI_M_TO_AGENT_DESC(String ui_m_to_agent_desc) {
		UI_M_TO_AGENT_DESC = ui_m_to_agent_desc;
	}

	public String getUI_M_FM_FUND_TYPE_DESC() {
		return UI_M_FM_FUND_TYPE_DESC;
	}

	public void setUI_M_FM_FUND_TYPE_DESC(String ui_m_fm_fund_type_desc) {
		UI_M_FM_FUND_TYPE_DESC = ui_m_fm_fund_type_desc;
	}

	public String getUI_M_TO_FUND_TYPE_DESC() {
		return UI_M_TO_FUND_TYPE_DESC;
	}

	public void setUI_M_TO_FUND_TYPE_DESC(String ui_m_to_fund_type_desc) {
		UI_M_TO_FUND_TYPE_DESC = ui_m_to_fund_type_desc;
	}

	public String getUI_M_FM_PYMT_MODE_DESC() {
		return UI_M_FM_PYMT_MODE_DESC;
	}

	public void setUI_M_FM_PYMT_MODE_DESC(String ui_m_fm_pymt_mode_desc) {
		UI_M_FM_PYMT_MODE_DESC = ui_m_fm_pymt_mode_desc;
	}

	public String getUI_M_TO_PYMT_MODE_DESC() {
		return UI_M_TO_PYMT_MODE_DESC;
	}

	public void setUI_M_TO_PYMT_MODE_DESC(String ui_m_to_pymt_mode_desc) {
		UI_M_TO_PYMT_MODE_DESC = ui_m_to_pymt_mode_desc;
	}
	...
	public Integer getUI_M_FM_CHQ_NO() {
		return UI_M_FM_CHQ_NO;
	}

	public void setUI_M_FM_CHQ_NO(Integer ui_m_fm_chq_no) {
		UI_M_FM_CHQ_NO = ui_m_fm_chq_no;
	}

	public Integer getUI_M_TO_CHQ_NO() {
		return UI_M_TO_CHQ_NO;
	}

	public void setUI_M_TO_CHQ_NO(Integer ui_m_to_chq_no) {
		UI_M_TO_CHQ_NO = ui_m_to_chq_no;
	}

	public Integer getUI_M_FM_CHQ_NO_DESC() {
		return UI_M_FM_CHQ_NO_DESC;
	}

	public void setUI_M_FM_CHQ_NO_DESC(Integer ui_m_fm_chq_no_desc) {
		UI_M_FM_CHQ_NO_DESC = ui_m_fm_chq_no_desc;
	}
	...
	public Integer getUI_M_TO_CHQ_NO_DESC() {
		return UI_M_TO_CHQ_NO_DESC;
	}

	public void setUI_M_TO_CHQ_NO_DESC(Integer ui_m_to_chq_no_desc) {
		UI_M_TO_CHQ_NO_DESC = ui_m_to_chq_no_desc;
	}
