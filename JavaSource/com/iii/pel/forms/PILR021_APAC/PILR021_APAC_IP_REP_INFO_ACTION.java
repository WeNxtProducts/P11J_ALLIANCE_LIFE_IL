package com.iii.pel.forms.PILR021_APAC;
...
import com.iii.pel.forms.PILR011.PILR011_QUERY_CONSTANTS;
import com.iii.pel.forms.PILR247_012.PILR247_012_HELPER;
import com.iii.pel.forms.PILR247_012.PILR247_012_QUERY_CONSTANTS;
...
public class PILR021_APAC_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR021_APAC_HELPER helper;
	PILR021_APAC_DELEGATE delegate;

	public PILR021_APAC_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR021_APAC_HELPER();
		delegate = new PILR021_APAC_DELEGATE();
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR021_APAC_HELPER helper = new PILR021_APAC_HELPER();
	...
	public PILR021_APAC_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR021_APAC_HELPER helper) {
		this.helper = helper;
	}

	public PILR021_APAC_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR021_APAC_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR021_APAC_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR021_APAC_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR021_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] {  IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR021_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR021_APAC_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR021_APAC_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_FM_USER_CODE(Object obj) {
		...
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR021_APAC",
	...
	public List<LovBean> lovPlanType(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR021_APAC", "REP_PARAM", "M_FM_POL_FUND_TYPE", 
	...
	public List<LovBean> lovUI_M_NO_OF_CHQ(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR021_APAC",
