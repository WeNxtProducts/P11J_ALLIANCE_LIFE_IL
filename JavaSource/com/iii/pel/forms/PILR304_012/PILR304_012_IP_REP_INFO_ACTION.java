...
public class PILR304_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR304_012_HELPER helper;
	PILR304_012_DELEGATE delegate;

	private List<SelectItem> listM_INSTR_FM;
	private List<SelectItem> listM_INSTR_TO;

	public PILR304_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR304_012_HELPER();
		delegate = new PILR304_012_DELEGATE();
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_CUST_FM", IP_REP_INFO_BEAN.getUI_M_CLASS_FM());
				map.put("P_CUST_TO", IP_REP_INFO_BEAN.getUI_M_CLASS_TO());
				map.put("P_POL_NO_FM", IP_REP_INFO_BEAN.getUI_M_USER_ID_FM());
				map.put("P_POL_NO_TO", IP_REP_INFO_BEAN.getUI_M_USER_ID_TO());
				map.put("P_FM_PROD_CODE", IP_REP_INFO_BEAN.getUI_M_BANK_FM());
				map.put("P_TO_PROD_CODE", IP_REP_INFO_BEAN.getUI_M_BANK_TO());
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR304_012_HELPER helper = new PILR304_012_HELPER();
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR304_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR304_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR304_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR304_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR304_012_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR304_012_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value) {
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR304_012", "REP_PARAM", "M_POL_NO",
	...
	public List<LovBean> lovUI_M_BANK(Object value) {
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR304_012", "REP_PARAM",
	...
	public List<LovBean> lovUI_M_USER_ID(Object obj) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR304_012_QUERY_CONSTANTS.USER_ID_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR304_012_QUERY_CONSTANTS.USER_ID_QUERY_LIKE;
		}
	...
	public void prepareDropDownListM_INSTR_FM() {
		...
		try {
			...
			listM_INSTR_FM = ListItemUtil.getDropDownListValue(connection,
					"PILR304_012", "REP_PARAM", "REP_PARAM.M_INSTR_FM",
					"IL_PAY_MODE");
	...
	public void prepareDropDownListM_INSTR_TO() {
		...
		try {
			...
			listM_INSTR_TO = ListItemUtil.getDropDownListValue(connection,
					"PILR304_012", "REP_PARAM", "REP_PARAM.M_INSTR_TO",
					"IL_PAY_MODE");
	...
	public List<LovBean> lovUI_M_POL_NO(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR304_012_QUERY_CONSTANTS.POL_NO ;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR304_012_QUERY_CONSTANTS.POL_NO_LIKE;
		}
