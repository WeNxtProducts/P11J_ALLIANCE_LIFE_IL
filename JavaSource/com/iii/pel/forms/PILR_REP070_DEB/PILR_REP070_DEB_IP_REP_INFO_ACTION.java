...
public class PILR_REP070_DEB_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	private HtmlSelectOneMenu COMP_4_INPUT_TEXT;
	...
	PILR_REP070_DEB_HELPER helper;
	PILR_REP070_DEB_DELEGATE delegate;
	
	private List<SelectItem> listM_FM_STATUS;
	
	public PILR_REP070_DEB_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR_REP070_DEB_HELPER();
		delegate=new PILR_REP070_DEB_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_FM_STATUS = ListItemUtil.getDropDownListValue(connection, "PILP014B", 
					"DUMMY", "DUMMY.REM_TYPE", "REM_TYPE");
	...
	public HtmlSelectOneMenu getCOMP_4_INPUT_TEXT() {
		return COMP_4_INPUT_TEXT;
	}

	public void setCOMP_4_INPUT_TEXT(HtmlSelectOneMenu comp_4_input_text) {
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR_REP070_DEB_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						.getCurrentInstance().getExternalContext()
						.getResponse();
				map.put("P_EMP_CODE", IP_REP_INFO_BEAN.getUI_M_MACNT_FM());
				
				//map.put("P_PROCESS_DATE_FM", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_DT()));
				map.put("P_PROC_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_DT()));
				//map.put("P_REM_TYPE", IP_REP_INFO_BEAN.getSelectedCustType());
				/*map.put("P_PROD_FROM", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR_REP070_DEB_HELPER helper=new PILR_REP070_DEB_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovAgentCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_AGENT_FM", 
	...
	public List<LovBean> lovSrcBus(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_SRC_BUS_FM", 
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR_REP070_DEB_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
	...
	public List<LovBean> lovCustCode1(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_FM_CUST", 
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_PROD_CODE_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovMainAcnt(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_MACNT_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovPolicy(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.POLICY_QUERY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.POLICY_QUERY_LIKE;
		}
	...
	public List<LovBean> lovStsCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_FM_STATUS", 
	...
	public List<LovBean> lovCLM(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_REP070_DEB", "REP_PARAM", "M_CLM_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP070_DEB_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public void validateEmp(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setUI_M_MACNT_FM((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void validateDT(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setUI_M_TO_DT((Date)value);
		}catch(Exception e){
			e.printStackTrace();
