...
public class PT_IL_PYMT_DTLS2_ACTION extends CommonAction {
	...
	private PT_IL_PYMT_DTLS2 PT_IL_PYMT_DTLS2_BEAN;

	public PILQ020_COMPOSITE_ACTION compositeAction;

	private PT_IL_PYMT_DTLS2_HELPER helper;

	private List<PT_IL_PYMT_DTLS2> dataList_PT_IL_PYMT_DTLS2 = new ArrayList<PT_IL_PYMT_DTLS2>();
...
public PT_IL_PYMT_DTLS2_ACTION(){


PT_IL_PYMT_DTLS2_BEAN = new PT_IL_PYMT_DTLS2();
helper = new PT_IL_PYMT_DTLS2_HELPER();
}
	...
	public PT_IL_PYMT_DTLS2 getPT_IL_PYMT_DTLS2_BEAN() {
		return PT_IL_PYMT_DTLS2_BEAN;
	}

	public void setPT_IL_PYMT_DTLS2_BEAN(PT_IL_PYMT_DTLS2 PT_IL_PYMT_DTLS2_BEAN) {
		this.PT_IL_PYMT_DTLS2_BEAN = PT_IL_PYMT_DTLS2_BEAN;
	}

	public List<PT_IL_PYMT_DTLS2> getDataList_PT_IL_PYMT_DTLS2() {
		return dataList_PT_IL_PYMT_DTLS2;
	}

	public void setDataListPT_IL_PYMT_DTLS2(List<PT_IL_PYMT_DTLS2> dataList_PT_IL_PYMT_DTLS2) {
		this.dataList_PT_IL_PYMT_DTLS2 = dataList_PT_IL_PYMT_DTLS2;
	}
...
getErrorMap().put("addRow",exc.getMessage());
	...
	public void setDataList_PT_IL_PYMT_DTLS2(
			List<PT_IL_PYMT_DTLS2> dataList_PT_IL_PYMT_DTLS2) {
		this.dataList_PT_IL_PYMT_DTLS2 = dataList_PT_IL_PYMT_DTLS2;
	}
	...
	public void displayRecords() {
		...
		try {
			resetSelectedRow();
			PT_IL_PYMT_DTLS2_BEAN = (PT_IL_PYMT_DTLS2) dataTable
					.getRowData();
	...
	private void resetSelectedRow() {
		Iterator<PT_IL_PYMT_DTLS2> PT_IL_PYMT_DTLS2_BEAN_ITR = dataList_PT_IL_PYMT_DTLS2.iterator();
		while (PT_IL_PYMT_DTLS2_BEAN_ITR.hasNext()) {
			PT_IL_PYMT_DTLS2_BEAN_ITR.next().setRowSelected(false);
		}
	}
}