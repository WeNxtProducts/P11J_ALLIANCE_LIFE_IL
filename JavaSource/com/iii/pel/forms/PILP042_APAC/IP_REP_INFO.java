...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String selectedFileTyp = "PDF";
	...
	private String UI_M_FM_CLASS_CODE;
	private String UI_M_TO_CLASS_CODE;
	private String UI_M_FM_SC_CODE;
	private String UI_M_TO_SC_CODE;
	private String UI_M_FM_CUST_CLASS;
	private String UI_M_TO_CUST_CLASS;
	
	private String UI_M_FM_CUST_CODE;
	private String UI_M_TO_CUST_CODE;
	private String UI_M_FM_FPPC_CUST_CODE;
	private String UI_M_TO_FPPC_CUST_CODE;
	
	private Date UI_M_DOC_APRVL_TO_DT;
	private Date UI_M_DOC_APRVL_FM_DT;
	...
	private String UI_M_FM_CLASS_DESC;
	private String UI_M_TO_CLASS_DESC;
	private String UI_M_FM_SC_DESC;
	private String UI_M_TO_SC_DESC;
	private String UI_M_FM_CUST_CLASS_DESC;
	private String UI_M_TO_CUST_CLASS_DESC;
	private String UI_M_FM_CUST_CODE_DESC;
	private String UI_M_TO_CUST_CODE_DESC;
	
	private String UI_M_FM_FPPC_CUST_CODE_DESC;
	private String UI_M_TO_FPPC_CUST_CODE_DESC;
	private String UI_M_FM_CUST_CODE_SEARCH;
	private String TEMP_UI_M_FM_CUST_CODE;
	
	private String UI_M_GROUP_CODE;
	private String UI_M_CLIENT_CODE;
	private String customerType;
	private String UI_M_FROM_CUST_CODE_DESC;
	
	
	private String[] selectedUserList = new String[]{};

	public String getUI_M_FM_CUST_CODE_SEARCH() {
		return UI_M_FM_CUST_CODE_SEARCH;
	}

	public void setUI_M_FM_CUST_CODE_SEARCH(String ui_m_fm_cust_code_search) {
		UI_M_FM_CUST_CODE_SEARCH = ui_m_fm_cust_code_search;
	}

	public String getTEMP_UI_M_FM_CUST_CODE() {
		return TEMP_UI_M_FM_CUST_CODE;
	}

	public void setTEMP_UI_M_FM_CUST_CODE(String temp_ui_m_fm_cust_code) {
		TEMP_UI_M_FM_CUST_CODE = temp_ui_m_fm_cust_code;
	}

	public String getUI_M_GROUP_CODE() {
		return UI_M_GROUP_CODE;
	}

	public void setUI_M_GROUP_CODE(String ui_m_group_code) {
		UI_M_GROUP_CODE = ui_m_group_code;
		setREP_VALUE_12(ui_m_group_code);
	}

	public String getUI_M_CLIENT_CODE() {
		return UI_M_CLIENT_CODE;
	}

	public void setUI_M_CLIENT_CODE(String ui_m_client_code) {
		UI_M_CLIENT_CODE = ui_m_client_code;
		setREP_VALUE_11(ui_m_client_code);
	}
	...
	public String getSelectedFileTyp() {
		return selectedFileTyp;
	}

	public void setSelectedFileTyp(String selectedFileTyp) {
		this.selectedFileTyp = selectedFileTyp;
	}

	public Date getUI_M_DOC_APRVL_FM_DT() {
		return UI_M_DOC_APRVL_FM_DT;
	}

	public void setUI_M_DOC_APRVL_FM_DT(Date ui_m_fm_dt) {
		setREP_VALUE_9(new ReportUtils().changeDatetoString(ui_m_fm_dt,PELConstants.pelDateFormat));
		UI_M_DOC_APRVL_FM_DT = ui_m_fm_dt;
	}

	public Date getUI_M_DOC_APRVL_TO_DT() {
		return UI_M_DOC_APRVL_TO_DT;
	}

	public void setUI_M_DOC_APRVL_TO_DT(Date ui_m_to_dt) {
		setREP_VALUE_10(new ReportUtils().changeDatetoString(ui_m_to_dt,PELConstants.pelDateFormat));
		UI_M_DOC_APRVL_TO_DT = ui_m_to_dt;
	}
	...
	public String getUI_M_FM_CLASS_CODE() {
		return UI_M_FM_CLASS_CODE;
	}

	public void setUI_M_FM_CLASS_CODE(String ui_m_fm_class_code) {
		setREP_VALUE_5(ui_m_fm_class_code);
		UI_M_FM_CLASS_CODE = ui_m_fm_class_code;
	}

	public String getUI_M_TO_CLASS_CODE() {
		return UI_M_TO_CLASS_CODE;
	}

	public void setUI_M_TO_CLASS_CODE(String ui_m_to_class_code) {
		setREP_VALUE_6(ui_m_to_class_code);
		UI_M_TO_CLASS_CODE = ui_m_to_class_code;
	}

	public String getUI_M_FM_CLASS_DESC() {
		return UI_M_FM_CLASS_DESC;
	}

	public void setUI_M_FM_CLASS_DESC(String ui_m_fm_class_desc) {
		UI_M_FM_CLASS_DESC = ui_m_fm_class_desc;
	}
	...
	public String getUI_M_FM_SC_CODE() {
		return UI_M_FM_SC_CODE;
	}

	public void setUI_M_FM_SC_CODE(String ui_m_fm_sc_code) {
		UI_M_FM_SC_CODE = ui_m_fm_sc_code;
	}

	public String getUI_M_TO_SC_CODE() {
		return UI_M_TO_SC_CODE;
	}

	public void setUI_M_TO_SC_CODE(String ui_m_to_sc_code) {
		UI_M_TO_SC_CODE = ui_m_to_sc_code;
	}

	public String getUI_M_FM_SC_DESC() {
		return UI_M_FM_SC_DESC;
	}

	public void setUI_M_FM_SC_DESC(String ui_m_fm_sc_desc) {
		UI_M_FM_SC_DESC = ui_m_fm_sc_desc;
	}

	public String getUI_M_TO_SC_DESC() {
		return UI_M_TO_SC_DESC;
	}

	public void setUI_M_TO_SC_DESC(String ui_m_to_sc_desc) {
		UI_M_TO_SC_DESC = ui_m_to_sc_desc;
	}

	public String getUI_M_FM_CUST_CLASS() {
		return UI_M_FM_CUST_CLASS;
	}

	public void setUI_M_FM_CUST_CLASS(String ui_m_fm_cust_class) {
		setREP_VALUE_7(ui_m_fm_cust_class);
		UI_M_FM_CUST_CLASS = ui_m_fm_cust_class;
	}

	public String getUI_M_TO_CUST_CLASS() {
		return UI_M_TO_CUST_CLASS;
	}

	public void setUI_M_TO_CUST_CLASS(String ui_m_to_cust_class) {
		setREP_VALUE_8(ui_m_to_cust_class);
		UI_M_TO_CUST_CLASS = ui_m_to_cust_class;
	}

	public String getUI_M_FM_CUST_CLASS_DESC() {
		return UI_M_FM_CUST_CLASS_DESC;
	}

	public void setUI_M_FM_CUST_CLASS_DESC(String ui_m_fm_cust_class_desc) {
		UI_M_FM_CUST_CLASS_DESC = ui_m_fm_cust_class_desc;
	}

	public String getUI_M_TO_CUST_CLASS_DESC() {
		return UI_M_TO_CUST_CLASS_DESC;
	}

	public void setUI_M_TO_CUST_CLASS_DESC(String ui_m_to_cust_class_desc) {
		UI_M_TO_CUST_CLASS_DESC = ui_m_to_cust_class_desc;
	}

	
	public String getUI_M_FM_CUST_CODE() {
		return UI_M_FM_CUST_CODE;
	}

	public void setUI_M_FM_CUST_CODE(String ui_m_fm_cust_code) {
		setREP_VALUE_30(ui_m_fm_cust_code);
		UI_M_FM_CUST_CODE = ui_m_fm_cust_code;
	}

	public String getUI_M_TO_CUST_CODE() {
		return UI_M_TO_CUST_CODE;
	}

	public void setUI_M_TO_CUST_CODE(String ui_m_to_cust_code) {
		setREP_VALUE_31(ui_m_to_cust_code);
		UI_M_TO_CUST_CODE = ui_m_to_cust_code;
	}

	public String getUI_M_FM_CUST_CODE_DESC() {
		return UI_M_FM_CUST_CODE_DESC;
	}

	public void setUI_M_FM_CUST_CODE_DESC(String ui_m_fm_cust_code_desc) {
		UI_M_FM_CUST_CODE_DESC = ui_m_fm_cust_code_desc;
	}

	public String getUI_M_TO_CUST_CODE_DESC() {
		return UI_M_TO_CUST_CODE_DESC;
	}

	public void setUI_M_TO_CUST_CODE_DESC(String ui_m_to_cust_code_desc) {
		UI_M_TO_CUST_CODE_DESC = ui_m_to_cust_code_desc;
	}
    
	
	public String getUI_M_FM_FPPC_CUST_CODE() {
		return UI_M_FM_FPPC_CUST_CODE;
	}

	public void setUI_M_FM_FPPC_CUST_CODE(String ui_m_fm_fppc_cust_code) {
		setREP_VALUE_15(ui_m_fm_fppc_cust_code);
		UI_M_FM_FPPC_CUST_CODE = ui_m_fm_fppc_cust_code;
	}

	public String getUI_M_TO_FPPC_CUST_CODE() {
		return UI_M_TO_FPPC_CUST_CODE;
	}

	public void setUI_M_TO_FPPC_CUST_CODE(String ui_m_to_fppc_cust_code) {
		setREP_VALUE_16(ui_m_to_fppc_cust_code);
		UI_M_TO_FPPC_CUST_CODE = ui_m_to_fppc_cust_code;
	}

	
	
	public String getUI_M_FM_FPPC_CUST_CODE_DESC() {
		return UI_M_FM_FPPC_CUST_CODE_DESC;
	}

	public void setUI_M_FM_FPPC_CUST_CODE_DESC(String ui_m_fm_fppc_cust_code_desc) {
		UI_M_FM_FPPC_CUST_CODE_DESC = ui_m_fm_fppc_cust_code_desc;
	}

	public String getUI_M_TO_FPPC_CUST_CODE_DESC() {
		return UI_M_TO_FPPC_CUST_CODE_DESC;
	}

	public void setUI_M_TO_FPPC_CUST_CODE_DESC(String ui_m_to_fppc_cust_code_desc) {
		UI_M_TO_FPPC_CUST_CODE_DESC = ui_m_to_fppc_cust_code_desc;
	}
	...
	public String getUI_M_FROM_CUST_CODE_DESC() {
		return UI_M_FROM_CUST_CODE_DESC;
	}

	public void setUI_M_FROM_CUST_CODE_DESC(String ui_m_from_cust_code_desc) {
		UI_M_FROM_CUST_CODE_DESC = ui_m_from_cust_code_desc;
	}
