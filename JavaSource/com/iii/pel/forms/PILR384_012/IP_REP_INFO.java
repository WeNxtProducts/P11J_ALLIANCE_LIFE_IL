...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String selectedCustType;
	private String selectedCustStatus;
	private String selectedPolicyStatus;
	private String selectedFiled11;
	private String selectedFiled12;
	private String selectedFiled13;
	private String selectedFiled14;
	private String selectedFiled15;
	...
	private Date UI_M_REG_DT_FM;
	private Date UI_M_REG_DT_TO;
	private String UI_M_FM_STATUS;
	private String UI_M_TO_STATUS;
	private String UI_M_COVER_FM;
	private String UI_M_COVER_TO;
	private String UI_M_POL_FM;
	private String UI_M_POL_TO;
	private String UI_M_CLM_FM;
	private String UI_M_CLM_TO;
	private String UI_M_AGENT_FM;
	private String UI_M_AGENT_TO;
	
	private Date UI_M_AS_ON_DATE;
	private Date UI_M_AS_OF_DT;
	private Date UI_M_DOC_TO_DT;
	...
	private String UI_M_COVER_NAME_FM;
	private String UI_M_COVER_NAME_TO;
	private String UI_M_CUST_FM_DESC;
	private String UI_M_CUST_TO_DESC;
	private String UI_M_AGENT_DESC_FM;
	private String UI_M_AGENT_DESC_TO;
	private String UI_M_SRC_BUS_FM_DESC;
	private String UI_M_SRC_BUS_TO_DESC;
	private String UI_M_SRC_BUS_FM;
	private String UI_M_SRC_BUS_TO;
	private String UI_M_MACNT_FM;
	private String UI_M_MACNT_TO;
	private String UI_M_SUB_ACNT_FM;
	private String UI_M_SUB_ACNT_TO;
	private String UI_M_FM_CUST;
	private String UI_M_TO_CUST;
	private String UI_M_CUST_DESC_FM;
	private String UI_M_CUST_DESC_TO;
	
	private String UI_M_FM_STATUS_DESC;
	private String UI_M_TO_STATUS_DESC;
	
	private Date UI_FM_DT;
	private Date UI_TO_DT;
	
	private Integer UI_YEAR_FM;
	private Integer UI_YEAR_TO;
	
	private String UI_M_FM_DEPT_CODE;
	private String UI_M_FM_DEPT_CODE_DESC;
	private String UI_M_TO_DEPT_CODE;
	private String UI_M_TO_DEPT_CODE_DESC;
	...
	public String getSelectedCustType() {
		return selectedCustType;
	}

	public void setSelectedCustType(String selectedCustType) {
		setREP_VALUE_11(selectedCustType);
		this.selectedCustType = selectedCustType;
	}

	public String getSelectedCustStatus() {
		return selectedCustStatus;
	}

	public void setSelectedCustStatus(String selectedCustStatus) {
		setREP_VALUE_12(selectedCustStatus);
		this.selectedCustStatus = selectedCustStatus;
	}
	...
	public void setUI_M_FM_PROD_CODE(String ui_m_fm_prod_code) {
		setREP_VALUE_3(ui_m_fm_prod_code);
		UI_M_FM_PROD_CODE = ui_m_fm_prod_code;
	}
	...
	public void setUI_M_TO_PROD_CODE(String ui_m_to_prod_code) {
		setREP_VALUE_4(ui_m_to_prod_code);
		UI_M_TO_PROD_CODE = ui_m_to_prod_code;
	}
	...
	public void setUI_M_FM_PROD_DESC(String ui_m_fm_prod_desc) {
		UI_M_FM_PROD_DESC = ui_m_fm_prod_desc;
	}
	...
	public void setUI_M_TO_PROD_DESC(String ui_m_to_prod_desc) {
		UI_M_TO_PROD_DESC = ui_m_to_prod_desc;
	}

	public String getUI_M_FM_STATUS() {
		return UI_M_FM_STATUS;
	}

	public void setUI_M_FM_STATUS(String ui_m_fm_status) {
		setREP_VALUE_5(ui_m_fm_status);
		UI_M_FM_STATUS = ui_m_fm_status;
	}

	public String getUI_M_TO_STATUS() {
		return UI_M_TO_STATUS;
	}

	public void setUI_M_TO_STATUS(String ui_m_to_status) {
		setREP_VALUE_6(ui_m_to_status);
		UI_M_TO_STATUS = ui_m_to_status;
	}

	public String getUI_M_CUST_FM_DESC() {
		return UI_M_CUST_FM_DESC;
	}

	public void setUI_M_CUST_FM_DESC(String ui_m_cust_fm_desc) {
		UI_M_CUST_FM_DESC = ui_m_cust_fm_desc;
	}

	public String getUI_M_CUST_TO_DESC() {
		return UI_M_CUST_TO_DESC;
	}

	public void setUI_M_CUST_TO_DESC(String ui_m_cust_to_desc) {
		UI_M_CUST_TO_DESC = ui_m_cust_to_desc;
	}

	public String getUI_M_AGENT_DESC_FM() {
		return UI_M_AGENT_DESC_FM;
	}

	public void setUI_M_AGENT_DESC_FM(String ui_m_agent_desc_fm) {
		UI_M_AGENT_DESC_FM = ui_m_agent_desc_fm;
	}

	public String getUI_M_AGENT_DESC_TO() {
		return UI_M_AGENT_DESC_TO;
	}

	public void setUI_M_AGENT_DESC_TO(String ui_m_agent_desc_to) {
		UI_M_AGENT_DESC_TO = ui_m_agent_desc_to;
	}

	public String getUI_M_FM_STATUS_DESC() {
		return UI_M_FM_STATUS_DESC;
	}

	public void setUI_M_FM_STATUS_DESC(String ui_m_fm_status_desc) {
		UI_M_FM_STATUS_DESC = ui_m_fm_status_desc;
	}

	public String getUI_M_TO_STATUS_DESC() {
		return UI_M_TO_STATUS_DESC;
	}

	public void setUI_M_TO_STATUS_DESC(String ui_m_to_status_desc) {
		UI_M_TO_STATUS_DESC = ui_m_to_status_desc;
	}

	public String getUI_M_COVER_NAME_FM() {
		return UI_M_COVER_NAME_FM;
	}

	public void setUI_M_COVER_NAME_FM(String ui_m_cover_name_fm) {
		UI_M_COVER_NAME_FM = ui_m_cover_name_fm;
	}

	public String getUI_M_COVER_NAME_TO() {
		return UI_M_COVER_NAME_TO;
	}

	public void setUI_M_COVER_NAME_TO(String ui_m_cover_name_to) {
		UI_M_COVER_NAME_TO = ui_m_cover_name_to;
	}

	public String getUI_M_COVER_FM() {
		return UI_M_COVER_FM;
	}

	public void setUI_M_COVER_FM(String ui_m_cover_fm) {
		UI_M_COVER_FM = ui_m_cover_fm;
	}

	public String getUI_M_COVER_TO() {
		return UI_M_COVER_TO;
	}

	public void setUI_M_COVER_TO(String ui_m_cover_to) {
		UI_M_COVER_TO = ui_m_cover_to;
	}

	public String getUI_M_POL_FM() {
		return UI_M_POL_FM;
	}

	public void setUI_M_POL_FM(String ui_m_pol_fm) {
		UI_M_POL_FM = ui_m_pol_fm;
	}

	public String getUI_M_POL_TO() {
		return UI_M_POL_TO;
	}

	public void setUI_M_POL_TO(String ui_m_pol_to) {
		UI_M_POL_TO = ui_m_pol_to;
	}

	public String getUI_M_CLM_FM() {
		return UI_M_CLM_FM;
	}

	public void setUI_M_CLM_FM(String ui_m_clm_fm) {
		UI_M_CLM_FM = ui_m_clm_fm;
	}

	public String getUI_M_CLM_TO() {
		return UI_M_CLM_TO;
	}

	public void setUI_M_CLM_TO(String ui_m_clm_to) {
		UI_M_CLM_TO = ui_m_clm_to;
	}

	public Date getUI_M_REG_DT_FM() {
		return UI_M_REG_DT_FM;
	}

	public void setUI_M_REG_DT_FM(Date ui_m_reg_dt_fm) {
		setREP_VALUE_9(new ReportUtils().changeDatetoString(ui_m_reg_dt_fm,PELConstants.pelDateFormat));
		UI_M_REG_DT_FM = ui_m_reg_dt_fm;
	}

	public Date getUI_M_REG_DT_TO() {
		return UI_M_REG_DT_TO;
	}

	public void setUI_M_REG_DT_TO(Date ui_m_reg_dt_to) {
		setREP_VALUE_10(new ReportUtils().changeDatetoString(ui_m_reg_dt_to,PELConstants.pelDateFormat));
		UI_M_REG_DT_TO = ui_m_reg_dt_to;
	}
	...
	public String getUI_M_SRC_BUS_FM_DESC() {
		return UI_M_SRC_BUS_FM_DESC;
	}

	public void setUI_M_SRC_BUS_FM_DESC(String ui_m_src_bus_fm_desc) {
		UI_M_SRC_BUS_FM_DESC = ui_m_src_bus_fm_desc;
	}

	public String getUI_M_SRC_BUS_TO_DESC() {
		return UI_M_SRC_BUS_TO_DESC;
	}

	public void setUI_M_SRC_BUS_TO_DESC(String ui_m_src_bus_to_desc) {
		UI_M_SRC_BUS_TO_DESC = ui_m_src_bus_to_desc;
	}

	public String getUI_M_SRC_BUS_FM() {
		return UI_M_SRC_BUS_FM;
	}

	public void setUI_M_SRC_BUS_FM(String ui_m_src_bus_fm) {
		UI_M_SRC_BUS_FM = ui_m_src_bus_fm;
	}

	public String getUI_M_SRC_BUS_TO() {
		return UI_M_SRC_BUS_TO;
	}

	public void setUI_M_SRC_BUS_TO(String ui_m_src_bus_to) {
		UI_M_SRC_BUS_TO = ui_m_src_bus_to;
	}

	public String getUI_M_MACNT_FM() {
		return UI_M_MACNT_FM;
	}

	public void setUI_M_MACNT_FM(String ui_m_macnt_fm) {
		UI_M_MACNT_FM = ui_m_macnt_fm;
	}

	public String getUI_M_MACNT_TO() {
		return UI_M_MACNT_TO;
	}

	public void setUI_M_MACNT_TO(String ui_m_macnt_to) {
		UI_M_MACNT_TO = ui_m_macnt_to;
	}

	public String getUI_M_SUB_ACNT_FM() {
		return UI_M_SUB_ACNT_FM;
	}

	public void setUI_M_SUB_ACNT_FM(String ui_m_sub_acnt_fm) {
		UI_M_SUB_ACNT_FM = ui_m_sub_acnt_fm;
	}

	public String getUI_M_SUB_ACNT_TO() {
		return UI_M_SUB_ACNT_TO;
	}

	public void setUI_M_SUB_ACNT_TO(String ui_m_sub_acnt_to) {
		UI_M_SUB_ACNT_TO = ui_m_sub_acnt_to;
	}

	public Date getUI_M_AS_OF_DT() {
		return UI_M_AS_OF_DT;
	}

	public void setUI_M_AS_OF_DT(Date ui_m_as_of_dt) {
		setREP_VALUE_9(new ReportUtils().changeDatetoString(ui_m_as_of_dt,PELConstants.pelDateFormat));
		UI_M_AS_OF_DT = ui_m_as_of_dt;
	}

	public Date getUI_M_DOC_TO_DT() {
		return UI_M_DOC_TO_DT;
	}

	public void setUI_M_DOC_TO_DT(Date ui_m_doc_to_dt) {
		setREP_VALUE_10(new ReportUtils().changeDatetoString(ui_m_doc_to_dt,PELConstants.pelDateFormat));
		UI_M_DOC_TO_DT = ui_m_doc_to_dt;
	}

	public String getUI_M_FM_CUST() {
		return UI_M_FM_CUST;
	}

	public void setUI_M_FM_CUST(String ui_m_fm_cust) {
		UI_M_FM_CUST = ui_m_fm_cust;
	}

	public String getUI_M_TO_CUST() {
		return UI_M_TO_CUST;
	}

	public void setUI_M_TO_CUST(String ui_m_to_cust) {
		UI_M_TO_CUST = ui_m_to_cust;
	}

	public String getUI_M_CUST_DESC_FM() {
		return UI_M_CUST_DESC_FM;
	}

	public void setUI_M_CUST_DESC_FM(String ui_m_cust_desc_fm) {
		UI_M_CUST_DESC_FM = ui_m_cust_desc_fm;
	}

	public String getUI_M_CUST_DESC_TO() {
		return UI_M_CUST_DESC_TO;
	}

	public void setUI_M_CUST_DESC_TO(String ui_m_cust_desc_to) {
		UI_M_CUST_DESC_TO = ui_m_cust_desc_to;
	}

	public Date getUI_FM_DT() {
		return UI_FM_DT;
	}

	public void setUI_FM_DT(Date ui_fm_dt) {
		UI_FM_DT = ui_fm_dt;
	}

	public Date getUI_TO_DT() {
		return UI_TO_DT;
	}

	public void setUI_TO_DT(Date ui_to_dt) {
		UI_TO_DT = ui_to_dt;
	}

	public Integer getUI_YEAR_FM() {
		return UI_YEAR_FM;
	}

	public void setUI_YEAR_FM(Integer ui_year_fm) {
		UI_YEAR_FM = ui_year_fm;
	}

	public Integer getUI_YEAR_TO() {
		return UI_YEAR_TO;
	}

	public void setUI_YEAR_TO(Integer ui_year_to) {
		UI_YEAR_TO = ui_year_to;
	}
	...
	public String getUI_M_FM_DEPT_CODE_DESC() {
		return UI_M_FM_DEPT_CODE_DESC;
	}

	public void setUI_M_FM_DEPT_CODE_DESC(String ui_m_fm_dept_code_desc) {
		UI_M_FM_DEPT_CODE_DESC = ui_m_fm_dept_code_desc;
	}

	public String getUI_M_TO_DEPT_CODE_DESC() {
		return UI_M_TO_DEPT_CODE_DESC;
	}

	public void setUI_M_TO_DEPT_CODE_DESC(String ui_m_to_dept_code_desc) {
		UI_M_TO_DEPT_CODE_DESC = ui_m_to_dept_code_desc;
	}

	public String getSelectedFiled11() {
		return selectedFiled11;
	}

	public void setSelectedFiled11(String selectedFiled11) {
		this.selectedFiled11 = selectedFiled11;
	}

	public String getSelectedFiled12() {
		return selectedFiled12;
	}

	public void setSelectedFiled12(String selectedFiled12) {
		this.selectedFiled12 = selectedFiled12;
	}

	public String getSelectedFiled13() {
		return selectedFiled13;
	}

	public void setSelectedFiled13(String selectedFiled13) {
		this.selectedFiled13 = selectedFiled13;
	}

	public String getSelectedFiled14() {
		return selectedFiled14;
	}

	public void setSelectedFiled14(String selectedFiled14) {
		this.selectedFiled14 = selectedFiled14;
	}

	public String getSelectedFiled15() {
		return selectedFiled15;
	}

	public void setSelectedFiled15(String selectedFiled15) {
		this.selectedFiled15 = selectedFiled15;
	}
