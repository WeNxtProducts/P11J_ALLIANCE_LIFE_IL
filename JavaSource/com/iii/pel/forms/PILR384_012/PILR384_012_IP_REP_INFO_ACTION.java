package com.iii.pel.forms.PILR384_012;
...
public class PILR384_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	private HtmlSelectOneMenu COMP_5_INPUT_TEXT;
	...
	PILR384_012_HELPER helper;
	PILR384_012_DELEGATE delegate;
	
	private List<SelectItem> listPaymentFm = new ArrayList<SelectItem>();
	private List<SelectItem> listPaymentTo = new ArrayList<SelectItem>();
	private List<SelectItem> listInstrFm = new ArrayList<SelectItem>();
	private List<SelectItem> listInstrTo = new ArrayList<SelectItem>();
	private List<SelectItem> listM_Lapse = new ArrayList<SelectItem>();
	
	
	public List<SelectItem> getListPaymentFm() {
		return listPaymentFm;
	}

	public void setListPaymentFm(List<SelectItem> listPaymentFm) {
		this.listPaymentFm = listPaymentFm;
	}

	public List<SelectItem> getListPaymentTo() {
		return listPaymentTo;
	}

	public void setListPaymentTo(List<SelectItem> listPaymentTo) {
		this.listPaymentTo = listPaymentTo;
	}

	public List<SelectItem> getListInstrFm() {
		return listInstrFm;
	}

	public void setListInstrFm(List<SelectItem> listInstrFm) {
		this.listInstrFm = listInstrFm;
	}

	public List<SelectItem> getListInstrTo() {
		return listInstrTo;
	}

	public void setListInstrTo(List<SelectItem> listInstrTo) {
		this.listInstrTo = listInstrTo;
	}

	public List<SelectItem> getListM_Lapse() {
		return listM_Lapse;
	}

	public void setListM_Lapse(List<SelectItem> listM_Lapse) {
		this.listM_Lapse = listM_Lapse;
	}

	public PILR384_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR384_012_HELPER();
		delegate=new PILR384_012_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listPaymentFm = ListItemUtil.getDropDownListValue(connection, "PILR384_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_FM", "PAYMODE");
			listPaymentTo = ListItemUtil.getDropDownListValue(connection, "PILR384_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_TO", "PAYMODE");
			listInstrFm= ListItemUtil.getDropDownListValue(connection, "PILR384_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_FM", "IL_CPAY_MODE");
			listInstrTo = ListItemUtil.getDropDownListValue(connection, "PILR384_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_TO", "IL_CPAY_MODE");
			listM_Lapse = ListItemUtil.getDropDownListValue(connection, "PILR384_012", 
					"REP_PARAM", "REP_PARAM.M_LAPSE", "LAP_OPT");
	...
	public HtmlSelectOneMenu getCOMP_5_INPUT_TEXT() {
		return COMP_5_INPUT_TEXT;
	}

	public void setCOMP_5_INPUT_TEXT(HtmlSelectOneMenu comp_5_input_text) {
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR384_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						.getCurrentInstance().getExternalContext()
						.getResponse();
				map.put("P_FM_AGENT_CODE", IP_REP_INFO_BEAN.getUI_M_AGENT_FM());
				map.put("P_TO_AGENT_CODE", IP_REP_INFO_BEAN.getUI_M_AGENT_TO());
				map.put("P_FM_AGENCY_CODE", IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
				map.put("P_TO_AGENCY_CODE", IP_REP_INFO_BEAN.getUI_M_TO_DEPT_CODE());
				map.put("P_REGION_FM_CODE", IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_REGION_TO_CODE", IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
				map.put("P_FM_BRANCH_CODE", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_TO_BRANCH_CODE", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_FM_STATUS_CODE", IP_REP_INFO_BEAN.getUI_M_SRC_BUS_FM());
				map.put("P_TO_STATUS_CODE", IP_REP_INFO_BEAN.getUI_M_SRC_BUS_TO());
				map.put("P_FM_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_DT()));
				map.put("P_TO_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_DT()));
				
				//map.put("P_ACNT_YEAR_FM", String.valueOf(IP_REP_INFO_BEAN.getUI_YEAR_FM()));
				//map.put("P_ACNT_YEAR_TO", String.valueOf(IP_REP_INFO_BEAN.getUI_YEAR_TO()));
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR384_012_HELPER helper=new PILR384_012_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovAgentCode(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_AGENT_FM", 
					"BROKER", null, "BROKER", null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
	...
	public List<LovBean> lovAgency(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_AGENCY_FM_CODE", 
	...
	public List<LovBean> lovRegion(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_REGION_FM_CODE", 
					"AGNREGN", null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
		}
	...
	public List<LovBean> lovStatusCode(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_FM_STATUS_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSrcBus(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_SRC_BUS_FM", 
					"SRC_BUS_TY", null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
		}
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR384_012_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	public List<LovBean> lovCustCode1(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_FM_CUST", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public void whenValidateUI_FM_DIVN_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_DIVN_DESC(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_FM_DEPT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_DEPT_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_DEPT_CODE_DESC(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_DEPT_CODE(input.getValue().toString());
			}
		}
	...
	public void validateUI_FM_DEPT_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		String uiDivnFmCode = (String) value;
		try {
			if(!"*".equals(uiDivnFmCode)){
				String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_DEPT_CODE(uiDivnFmCode,IP_REP_INFO_BEAN);
				IP_REP_INFO_BEAN.setUI_M_FM_DEPT_CODE_DESC(divnCodeName);
			}
			COMP_9_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_FM_PROD_CODE(FacesContext facesContext,
		...
		try {
			if(!"*".equals(uiDivnFmCode)){
				String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_PROD_CODE(uiDivnFmCode,IP_REP_INFO_BEAN);
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(divnCodeName);
			}
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_M_MAST_POL_NO(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
	...
	public void whenValidateUI_TO_DEPT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		...
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_DEPT_CODE_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE_DESC(IP_REP_INFO_BEAN.getUI_M_FM_DIVN_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_TO_DIVN_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE())){
					this.IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_DIVN_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DIVN_DESC(IP_REP_INFO_BEAN.getUI_M_FM_DIVN_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_FM_CUST(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_CUST(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_CUST_DESC_FM(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_CUST(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_CUST(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			...
			if(IP_REP_INFO_BEAN.getUI_M_FM_CUST()!=null){
				
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_CUST())){
					
					this.IP_REP_INFO_BEAN.setUI_M_TO_CUST(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_CUST_DESC_TO(null);
				
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_CUST(IP_REP_INFO_BEAN.getUI_M_FM_CUST());
					this.IP_REP_INFO_BEAN.setUI_M_CUST_DESC_TO(IP_REP_INFO_BEAN.getUI_M_CUST_DESC_FM());
				}
			}
		...
		//	if (input.isValid()) {
				...
				this.IP_REP_INFO_BEAN.setUI_M_TO_CUST(submittedValue);
	...
	public void whenValidateUI_M_AGENT_FM(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_AGENT_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_AGENT_DESC_FM(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_AGENT_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_AGENT_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue=(String)input.getSubmittedValue();
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			...
			if(IP_REP_INFO_BEAN.getUI_M_AGENT_FM()!=null){
				
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_AGENT_FM())){
					
					this.IP_REP_INFO_BEAN.setUI_M_AGENT_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_AGENT_DESC_TO(null);
				
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_AGENT_TO(IP_REP_INFO_BEAN.getUI_M_AGENT_FM());
					this.IP_REP_INFO_BEAN.setUI_M_AGENT_DESC_TO(IP_REP_INFO_BEAN.getUI_M_AGENT_DESC_FM());
				}
			}
		...
		//	if (input.isValid()) {
				...
				this.IP_REP_INFO_BEAN.setUI_M_AGENT_TO(submittedValue);
	...
	public void whenValidateUI_YEAR_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue=(String)input.getSubmittedValue();
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_YEAR_FM()!=null){
				if(IP_REP_INFO_BEAN.getUI_YEAR_FM() == 0){
					this.IP_REP_INFO_BEAN.setUI_YEAR_TO(Integer.valueOf(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_9999));
				
				}else{
					this.IP_REP_INFO_BEAN.setUI_YEAR_TO(IP_REP_INFO_BEAN.getUI_YEAR_FM());
				}
			}
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			this.IP_REP_INFO_BEAN.setUI_YEAR_TO(Integer.valueOf(submittedValue));
		}
		COMP_4_INPUT_TEXT.resetValue();
	}
	
	
	public void whenValidateUI_YEAR_FM(ActionEvent actionEvent) {

		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_YEAR_FM(Integer.valueOf(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0));
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_YEAR_FM((Integer)input.getValue());
			}
		}
		COMP_3_INPUT_TEXT.resetValue();
	}
	
	public void validateUI_M_TO_CUST(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiSrc_Bus = (String) value;
		try {

			String sourceOfBus = helper.WHEN_VALIDATE_ITEM_UI_M_CUST_CODE_FM(uiSrc_Bus,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CUST_DESC_TO(sourceOfBus);
			COMP_10_INPUT_TEXT_DESC.resetValue();
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_SRC_BUS_FM", getWarningMap());
	...
	public void validateUI_M_FM_CUST(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			String sourceOfBus = helper.WHEN_VALIDATE_ITEM_UI_M_CUST_CODE_FM(uiSrc_Bus,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CUST_DESC_FM(sourceOfBus);
			COMP_9_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_SRC_BUS_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiSrc_Bus = (String) value;
		try {

			String sourceOfBus = helper.WHEN_VALIDATE_ITEM_UI_M_SRC_BUS(uiSrc_Bus,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_SRC_BUS_FM_DESC(sourceOfBus);
			COMP_7_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_SRC_BUS_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			String sourceOfBus = helper.WHEN_VALIDATE_ITEM_UI_M_SRC_BUS(uiSrc_Bus,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_SRC_BUS_TO_DESC(sourceOfBus);
			COMP_8_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_CUST_CODE_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiCust_Code = (String) value;
		try {

			String custName = helper.WHEN_VALIDATE_ITEM_UI_M_CUST_CODE_FM(uiCust_Code,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CUST_FM_DESC(custName );
			COMP_9_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_CUST_CODE_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String custCode = (String) value;
		try {

			String custName = helper.WHEN_VALIDATE_ITEM_UI_M_CUST_CODE_FM(custCode,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CUST_FM_DESC(custName);
			COMP_10_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_TO_DIVN_CODE(FacesContext facesContext,
		...
		try {
			...
			IP_REP_INFO_BEAN.setUI_M_TO_DIVN_DESC(divnCodeName);
			COMP_8_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_TO_DEPT_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiDivnToCode = (String) value;
		try {
			String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_DEPT_CODE(uiDivnToCode,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE_DESC(divnCodeName);
			COMP_10_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_AGENT_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiAgent_Code = (String) value;
		try {

			String agentName = helper.WHEN_VALIDATE_ITEM_UI_M_AGENT_FM(uiAgent_Code,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_AGENT_DESC_FM(agentName );
			COMP_3_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_AGENT_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String agentCode = (String) value;
		try {

			String custName = helper.WHEN_VALIDATE_ITEM_UI_M_AGENT_FM(agentCode,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_AGENT_DESC_TO(custName);
			COMP_4_INPUT_TEXT_DESC.resetValue();
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_AGENT_TO", getWarningMap());
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_PROD_CODE_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovMainAcnt(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_MACNT_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_FM_STATUS", 
	...
	public List<LovBean> lovCLM(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR384_012", "REP_PARAM", "M_CLM_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public void whenValidateUI_M_MACNT_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_MACNT_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_MACNT_FM(input.getValue().toString());
			}
		}
		COMP_11_INPUT_TEXT.resetValue();
	}	

	public void whenValidateUI_M_MACNT_TO(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_MACNT_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_MACNT_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_MACNT_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_MACNT_TO(IP_REP_INFO_BEAN.getUI_M_MACNT_FM());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_MACNT_TO(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_SUB_ACNT_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_FM(input.getValue().toString());
			}
		}
		COMP_5_INPUT_TEXT.resetValue();
	}	

	public void whenValidateUI_M_SUB_ACNT_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_SUB_ACNT_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_SUB_ACNT_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_TO(IP_REP_INFO_BEAN.getUI_M_SUB_ACNT_FM());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_TO(input.getValue().toString());
			}
		}
	...
	public void validateUI_M_FM_PROD_CODE(FacesContext facesContext,
		...
		try {
			...
			IP_REP_INFO_BEAN.setUI_M_FM_PROD_CODE(uiDeptFmCode);
			if(!REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE())){
	...
	public void whenValidateUI_M_CLM_FM(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_CLM_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_CLM_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_CLM_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue=(String)input.getSubmittedValue();
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			...
			if(IP_REP_INFO_BEAN.getUI_M_CLM_FM()!=null){
				
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_CLM_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_CLM_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_CLM_TO(IP_REP_INFO_BEAN.getUI_M_CLM_TO());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
		//	if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_CLM_TO(submittedValue);
		//	}
		}
		COMP_12_INPUT_TEXT.resetValue();
	}
	
	public void whenValidateUI_M_POL_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_POL_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_POL_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_POL_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue=(String)input.getSubmittedValue();
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_POL_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_POL_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_POL_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_POL_TO(IP_REP_INFO_BEAN.getUI_M_POL_TO());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
		//	if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_POL_TO(submittedValue);
		//	}
		}
		COMP_12_INPUT_TEXT.resetValue();
	}
	...
	public void whenValidateUI_M_SRC_BUS_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_SRC_BUS_FM_DESC(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_SRC_BUS_TO(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_SRC_BUS_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_SRC_BUS_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_SRC_BUS_TO_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_TO(IP_REP_INFO_BEAN.getUI_M_SRC_BUS_FM());
					this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_TO_DESC(IP_REP_INFO_BEAN.getUI_M_SRC_BUS_FM_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_SRC_BUS_TO(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_FM_STATUS(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_STATUS(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_STATUS_DESC(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_STATUS(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_STATUS(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_STATUS()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_STATUS())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_STATUS(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_STATUS_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_STATUS(IP_REP_INFO_BEAN.getUI_M_FM_STATUS());
					this.IP_REP_INFO_BEAN.setUI_M_TO_STATUS_DESC(IP_REP_INFO_BEAN.getUI_M_TO_STATUS_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_STATUS(input.getValue().toString());
			}
		}
		COMP_6_INPUT_TEXT.resetValue();
	...
	public void validateUI_M_TO_PROD_CODE(FacesContext facesContext,
		...
		String uiDivnToCode = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_TO_PROD_CODE(uiDivnToCode);
	...
	public void validateUI_M_MACNT_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String mainAcCode = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_MACNT_FM(mainAcCode);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_COVER_FM", getWarningMap());
	...
	public void validateUI_M_MACNT_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String mainAcCode = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_MACNT_TO(mainAcCode);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_COVER_TO", getWarningMap());
	...
	public void validateM_SUB_ACNT_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String subAct = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_FM(subAct);
	...
	public void validateM_SUB_ACNT_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String subAct = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_TO(subAct);
	...
	public void validateUI_M_SUB_ACNT_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String subActCode = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_FM(subActCode);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_POL_FM", getWarningMap());
	...
	public void validateUI_M_SUB_ACNT_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String subActCode = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_SUB_ACNT_TO(subActCode);
		} catch (Exception exception) {
			exception.printStackTrace();
			throw new ValidatorException(new FacesMessage(exception
					.getMessage()));
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_POL_TO", getWarningMap());
	...
	public void validateUI_M_CLM_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiclm = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_CLM_FM(uiclm);
		} catch (Exception exception) {
			exception.printStackTrace();
			throw new ValidatorException(new FacesMessage(exception
					.getMessage()));
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_CLM_FM", getWarningMap());
	...
	public void validateUI_M_CLM_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiclm = (String) value;
		try {
			IP_REP_INFO_BEAN.setUI_M_CLM_TO(uiclm);
		} catch (Exception exception) {
			exception.printStackTrace();
			throw new ValidatorException(new FacesMessage(exception
					.getMessage()));
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_CLM_TO", getWarningMap());
	...
	public void validateUI_M_FM_DT(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		
		IP_REP_INFO_BEAN.setUI_M_FM_DT((Date)value);
		try {
			helper.WHEN_VALIDATE_ITEM_UI_M_FM_DT(IP_REP_INFO_BEAN);
		} catch (Exception exception) {
			exception.printStackTrace();
			throw new ValidatorException(new FacesMessage(exception
					.getMessage()));
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_FM_DT", getWarningMap());
	...
	public void validateUI_M_TO_DT(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		
		IP_REP_INFO_BEAN.setUI_M_TO_DT((Date)value);
		try {
			helper.WHEN_VALIDATE_ITEM_UI_M_TO_DT(IP_REP_INFO_BEAN);
		} catch (Exception exception) {
			exception.printStackTrace();
			throw new ValidatorException(new FacesMessage(exception
					.getMessage()));
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_TO_DT", getWarningMap());
	...
	public void validateUI_M_FM_STATUS(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String stsCode = (String) value;
		try {

			String stsCodeDesc = helper.WHEN_VALIDATE_ITEM_UI_M_FM_STATUS(stsCode,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_FM_STATUS_DESC(stsCodeDesc);
			COMP_8_INPUT_TEXT_DESC.resetValue();
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_FM_STATUS", getWarningMap());
	...
	public void validateUI_M_TO_STATUS(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			String stsCodeDesc = helper.WHEN_VALIDATE_ITEM_UI_M_FM_STATUS(stsCode,IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_TO_STATUS_DESC(stsCodeDesc);
			COMP_9_INPUT_TEXT_DESC.resetValue();
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_TO_STATUS", getWarningMap());
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_DIVN_CODE(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_DEPT_CODE(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.DEPARTMENT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public void whenValidateUI_M_FM_DT(FacesContext context,UIComponent component ,Object value){
		try{
			Date value_1 = (Date)value;
			IP_REP_INFO_BEAN.setUI_M_FM_DT(value_1);
			helper.WHEN_VALIDATE_ITEM_UI_M_FM_DT(IP_REP_INFO_BEAN);
		}catch (Exception e) {
			e.printStackTrace();
	...
	public void whenValidateUI_M_TO_DT(FacesContext context,UIComponent component ,Object value){
		try{
			Date value_1 = (Date)value;
			IP_REP_INFO_BEAN.setUI_M_TO_DT(value_1);
			helper.WHEN_VALIDATE_ITEM_UI_M_TO_DT(IP_REP_INFO_BEAN);
		}catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void whenValidateSEL_1(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setSelectedFiled11((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void whenValidateSEL_2(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setSelectedFiled12((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void whenValidateSEL_3(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setSelectedFiled13((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void whenValidateSEL_4(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setSelectedFiled14((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void whenValidateSEL_5(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setSelectedFiled15((String)value);
		}catch(Exception e){
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public List<LovBean> prepareLovListSingleColoumn(String query, Object[] obj) {
	...
	public List<LovBean> lovPolNoCode(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.POL_NO;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR384_012_QUERY_CONSTANTS.POL_LIKE;
		}
		suggestionList = prepareLovListSingleColoumn(query, object);
		return suggestionList;
	}
	
	
	public List<LovBean> policyPBRK_BRK_CODESuggestion(Object event) {
