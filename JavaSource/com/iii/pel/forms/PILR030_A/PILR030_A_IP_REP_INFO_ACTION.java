...
public class PILR030_A_IP_REP_INFO_ACTION  extends CommonReportAction{
...
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_FM_AGENT_CODE",IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_TO_AGENT_CODE",IP_REP_INFO_BEAN.getUI_M_GRANTEE_CODE());
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR030_A_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
...
*/	public List<LovBean> lovProjectCode(Object value){
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean>lovAgentCode(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.AGENT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.AGENT_CODE_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
...
*/
	...
	public PILR030_A_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR030_A_DELEGATE delegate) {
