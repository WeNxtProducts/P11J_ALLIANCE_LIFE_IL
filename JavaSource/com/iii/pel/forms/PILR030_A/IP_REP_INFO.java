package com.iii.pel.forms.PILR030_A;
...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_DEPT_FM_CODE;
	private String UI_M_DEPT_FM_NAME;
	private String UI_M_DEPT_TO_CODE;
	private String UI_M_DEPT_TO_DESC;
	private String UI_M_FM_POL_CLASS_CODE;
	private String UI_M_FM_POL_CLASS_NAME;
	private String UI_M_TO_POL_CLASS_CODE;
	private String UI_M_TO_POL_CLASS_NAME;
	...
	public String getUI_M_DEPT_FM_CODE() {
		return UI_M_DEPT_FM_CODE;
	}

	public void setUI_M_DEPT_FM_CODE(String ui_m_dept_fm_code) {
		UI_M_DEPT_FM_CODE = ui_m_dept_fm_code;
	}

	public String getUI_M_DEPT_FM_NAME() {
		return UI_M_DEPT_FM_NAME;
	}

	public void setUI_M_DEPT_FM_NAME(String ui_m_dept_fm_name) {
		UI_M_DEPT_FM_NAME = ui_m_dept_fm_name;
	}

	public String getUI_M_DEPT_TO_CODE() {
		return UI_M_DEPT_TO_CODE;
	}

	public void setUI_M_DEPT_TO_CODE(String ui_m_dept_to_code) {
		UI_M_DEPT_TO_CODE = ui_m_dept_to_code;
	}
	...
	public void setUI_M_DEPT_TO_DESC(String ui_m_dept_to_desc) {
		UI_M_DEPT_TO_DESC = ui_m_dept_to_desc;
	}
	...
	public String getUI_M_FM_POL_CLASS_CODE() {
		return UI_M_FM_POL_CLASS_CODE;
	}

	public void setUI_M_FM_POL_CLASS_CODE(String ui_m_fm_pol_class_code) {
		UI_M_FM_POL_CLASS_CODE = ui_m_fm_pol_class_code;
	}

	public String getUI_M_FM_POL_CLASS_NAME() {
		return UI_M_FM_POL_CLASS_NAME;
	}

	public void setUI_M_FM_POL_CLASS_NAME(String ui_m_fm_pol_class_name) {
		UI_M_FM_POL_CLASS_NAME = ui_m_fm_pol_class_name;
	}

	public String getUI_M_TO_POL_CLASS_CODE() {
		return UI_M_TO_POL_CLASS_CODE;
	}

	public void setUI_M_TO_POL_CLASS_CODE(String ui_m_to_pol_class_code) {
		UI_M_TO_POL_CLASS_CODE = ui_m_to_pol_class_code;
	}

	public String getUI_M_TO_POL_CLASS_NAME() {
		return UI_M_TO_POL_CLASS_NAME;
	}

	public void setUI_M_TO_POL_CLASS_NAME(String ui_m_to_pol_class_name) {
		UI_M_TO_POL_CLASS_NAME = ui_m_to_pol_class_name;
	}
	...
	public void setUI_M_FM_AGENT_CODE(String ui_m_fm_agent_code) {
		UI_M_FM_AGENT_CODE = ui_m_fm_agent_code;
	}
	...
	public void setUI_M_TO_AGENT_CODE(String ui_m_to_agent_code) {
		UI_M_TO_AGENT_CODE = ui_m_to_agent_code;
	}
	...
	public void setUI_M_TO_AGENT_NAME(String ui_m_to_agent_name) {
		UI_M_TO_AGENT_NAME = ui_m_to_agent_name;
	}
	...
	public void setUI_M_FM_AGENT_NAME(String ui_m_fm_agent_name) {
		UI_M_FM_AGENT_NAME = ui_m_fm_agent_name;
	}
