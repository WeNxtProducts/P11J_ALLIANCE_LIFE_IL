package com.iii.pel.forms.PILR296_APAC;
...
public class PILR296_APAC_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR296_APAC_HELPER helper;
	PILR296_APAC_DELEGATE delegate;
	
	private List<SelectItem> listM_FM_STATUS;
	
	public PILR296_APAC_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR296_APAC_HELPER();
		delegate=new PILR296_APAC_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_FM_STATUS = ListItemUtil.getDropDownListValue(connection, "PILR296_APAC", 
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR296_APAC_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR296_APAC_HELPER helper=new PILR296_APAC_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovAgentCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_AGENT_FM", 
	...
	public List<LovBean> lovSrcBus(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_SRC_BUS_FM", 
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR296_APAC_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
	...
	public List<LovBean> lovCustCode1(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_FM_CUST", 
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_PROD_CODE_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovMainAcnt(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_MACNT_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_FM_STATUS", 
	...
	public List<LovBean> lovCLM(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR296_APAC", "REP_PARAM", "M_CLM_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR296_APAC_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
