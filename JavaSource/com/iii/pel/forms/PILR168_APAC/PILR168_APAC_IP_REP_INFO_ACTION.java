...
public class PILR168_APAC_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR168_APAC_HELPER helper;
	PILR168_APAC_DELEGATE delegate;

	private List<SelectItem> listM_INSTR_FM;
	private List<SelectItem> listM_INSTR_TO;

	public PILR168_APAC_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR168_APAC_HELPER();
		delegate = new PILR168_APAC_DELEGATE();
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR168_APAC_HELPER helper = new PILR168_APAC_HELPER();
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR168_APAC_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR168_APAC_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR168_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR168_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR168_APAC_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR168_APAC_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_M_USER_ID(Object obj) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR168_APAC_QUERY_CONSTANTS.USER_ID_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR168_APAC_QUERY_CONSTANTS.USER_ID_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_POL_NO(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR168_APAC_QUERY_CONSTANTS.POL_NO ;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR168_APAC_QUERY_CONSTANTS.POL_NO_LIKE;
		}
