...
public class CTRL extends BaseValueBean {
	...
	private String UI_M_MODULE_NAME;
	private String UI_M_GOFLD_NAME;
	private String UI_M_FAILURE;
	private String UI_M_COMM_DEL;

	/**
	 * @return the uI_M_SCR_NAME
	 */
	...
	/**
	 * @param ui_m_lang_code
	 *            the uI_M_LANG_CODE to set
	 */
	...
	/**
	 * @param ui_m_comp_code
	 *            the uI_M_COMP_CODE to set
	 */
	...
	/**
	 * @param ui_m_divn_code
	 *            the uI_M_DIVN_CODE to set
	 */
	...
	/**
	 * @param ui_m_dept_code
	 *            the uI_M_DEPT_CODE to set
	 */
	...
	/**
	 * @return the uI_M_MODULE_NAME
	 */
	public String getUI_M_MODULE_NAME() {
		return UI_M_MODULE_NAME;
	}

	/**
	 * @param ui_m_module_name
	 *            the uI_M_MODULE_NAME to set
	 */
	public void setUI_M_MODULE_NAME(String ui_m_module_name) {
		UI_M_MODULE_NAME = ui_m_module_name;
	}

	/**
	 * @return the uI_M_GOFLD_NAME
	 */
	...
	/**
	 * @param ui_m_gofld_name
	 *            the uI_M_GOFLD_NAME to set
	 */
	...
	/**
	 * @return the uI_M_FAILURE
	 */
	public String getUI_M_FAILURE() {
		return UI_M_FAILURE;
	}

	/**
	 * @param ui_m_failure
	 *            the uI_M_FAILURE to set
	 */
	public void setUI_M_FAILURE(String ui_m_failure) {
		UI_M_FAILURE = ui_m_failure;
	}

	/**
	 * @return the uI_M_COMM_DEL
	 */
