...
helper = new CTRL_HELPER();
	...
	public void setCOMP_UI_M_CURSOR_HINT_REC(HtmlOutputLabel COMP_UI_M_CURSOR_HINT_REC) {
	...
	public void saveRecord() {
		try {
			if (getCTRL_BEAN().getROWID() != null) {
				new CRUDHandler().executeInsert(getCTRL_BEAN(), CommonUtils.getConnection());
			} else {
				new CRUDHandler().executeInsert(getCTRL_BEAN(), CommonUtils.getConnection());
			}
