...
public class DUMMY_HELPER {
	 ...
	 * @return
	 */
	public static List<LovBean> getPolicyNumber(String value){
		List<LovBean> list = new ArrayList<LovBean>();
		Connection connection =null;
		CRUDHandler handler = null;
		LovBean lovBean =null;
		String C1="SELECT POL_NO FROM PT_IL_POLICY WHERE (POL_DS_TYPE = '1' OR (POL_DS_TYPE = '2' AND   POL_STATUS ='A') ) AND ROWNUM < 20";
		String C1_APPEND=" SELECT POL_NO FROM PT_IL_POLICY WHERE (POL_DS_TYPE = '1' OR (POL_DS_TYPE = '2' AND   POL_STATUS ='A') ) AND POL_NO = ? AND ROWNUM < 20"; 
	...
	public ArrayList<OracleParameter> PROC_ANIVR_PROCESS(Object P_POL_NO_FROM,
			Object P_POL_NO_TO, Object P_PROCESS_DATE ) throws ProcedureException {
		Connection connection = null;
