package com.iii.pel.forms.PILRA001;
...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_FM_PLAN_TYPE;
	private String UI_M_FM_PLAN_NAME;
	private String UI_M_TO_PLAN_TYPE;
	private String UI_M_TO_PLAN_NAME;
	...
	public String getUI_M_FM_PLAN_TYPE() {
		return UI_M_FM_PLAN_TYPE;
	}

	public void setUI_M_FM_PLAN_TYPE(String ui_m_fm_plan_type) {
		UI_M_FM_PLAN_TYPE = ui_m_fm_plan_type;
	}

	public String getUI_M_FM_PLAN_NAME() {
		return UI_M_FM_PLAN_NAME;
	}

	public void setUI_M_FM_PLAN_NAME(String ui_m_fm_plan_name) {
		UI_M_FM_PLAN_NAME = ui_m_fm_plan_name;
	}

	public String getUI_M_TO_PLAN_TYPE() {
		return UI_M_TO_PLAN_TYPE;
	}

	public void setUI_M_TO_PLAN_TYPE(String ui_m_to_plan_type) {
		UI_M_TO_PLAN_TYPE = ui_m_to_plan_type;
	}

	public String getUI_M_TO_PLAN_NAME() {
		return UI_M_TO_PLAN_NAME;
	}

	public void setUI_M_TO_PLAN_NAME(String ui_m_to_plan_name) {
		UI_M_TO_PLAN_NAME = ui_m_to_plan_name;
	}
