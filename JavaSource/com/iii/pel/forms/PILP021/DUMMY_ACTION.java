...
public class DUMMY_ACTION extends CommonAction {
	...
	PILP021_DUMMY_HELPER helper;
	public DUMMY_ACTION() {
		try {
			DUMMY_BEAN = new DUMMY();
			helper = new PILP021_DUMMY_HELPER();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String processButtonAction() {
		String message = null;
		PILP021_DUMMY_HELPER helper = new PILP021_DUMMY_HELPER();
		try {
			helper.BATCH_APPROVAL(DUMMY_BEAN.getUI_M_FM_PROD_CODE(), DUMMY_BEAN.getUI_M_TO_PROD_CODE(),
