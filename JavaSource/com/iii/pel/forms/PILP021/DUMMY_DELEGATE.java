...
public class DUMMY_DELEGATE {
	...
	public List<DUMMY> getListForFM_TO_PROD_CODE(String filterString) {
		...
		Object[] values={PILP021_SQLQUERY_CONSTANTS.FETCH_ROW_COUNT};
		queryString.append(PILP021_SQLQUERY_CONSTANTS.LOV_FM_TO_PROD_CODE);
	...
	public List<DUMMY> getListForFM_TO_PROP_NO(String filterString) {
		...
		queryString.append(PILP021_SQLQUERY_CONSTANTS.LOV_FM_TO_PROP_NO);
		...
		try {
			...
			Object[] values={format.format(fromDate).toString(),format.format(toDate).toString(),PILP021_SQLQUERY_CONSTANTS.FETCH_ROW_COUNT};
