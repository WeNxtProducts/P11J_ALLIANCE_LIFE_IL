package com.iii.pel.forms.PILR290_APAC;
...
public class PILR290_APAC_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR290_APAC_HELPER helper;
	PILR290_APAC_DELEGATE delegate;
	
	private List<SelectItem> listM_FM_STATUS;
	
	public PILR290_APAC_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR290_APAC_HELPER();
		delegate=new PILR290_APAC_DELEGATE();
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR290_APAC_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_DATE_FM", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_DT()));
				map.put("P_DATE_TO", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_DT()));
				map.put("P_PROD_FM", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_PROD_TO", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR290_APAC_HELPER helper=new PILR290_APAC_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR290_APAC_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
	...
	public List<LovBean> lovPolNoCode(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.POL_NO ;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.POL_NO_LIKE;
		}
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR290_APAC_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
