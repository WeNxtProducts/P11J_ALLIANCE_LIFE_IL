...
public class PT_IL_PYMT_DTLS_ACTION extends CommonAction {
	...
	private HtmlCommandButton COMP_UI_M_BUT_MAIN_RECEIPT;

	private HtmlCommandButton COMP_UI_M_BUT_PD_ADDR_02;

	private PT_IL_PYMT_DTLS PT_IL_PYMT_DTLS_BEAN;
	
	public PILT016A_APAC_COMPOSITE_ACTION compositeAction; 
	...
	public HtmlCommandButton getCOMP_UI_M_BUT_MAIN_RECEIPT() {
		return COMP_UI_M_BUT_MAIN_RECEIPT;
	}

	public void setCOMP_UI_M_BUT_MAIN_RECEIPT(HtmlCommandButton COMP_UI_M_BUT_MAIN_RECEIPT) {
		this.COMP_UI_M_BUT_MAIN_RECEIPT = COMP_UI_M_BUT_MAIN_RECEIPT;
	}
	 ...
	 */
	public PILT016A_APAC_COMPOSITE_ACTION getCompositeAction() {
	 ...
	 */
	public void setCompositeAction(PILT016A_APAC_COMPOSITE_ACTION compositeAction) {
	...
	public void disableAllComponent(boolean disabled){
		...
		COMP_UI_M_BUT_BANK_LOV.setDisabled(disabled);
		COMP_UI_M_BUT_LOV_DPD_REF_ID.setDisabled(disabled);
		COMP_UI_M_BUT_PD_CUST_NAME.setDisabled(disabled);
		COMP_UI_M_BUT_PD_ADDR_01.setDisabled(disabled);
		COMP_UI_M_BUT_PD_ADDR_03.setDisabled(disabled);
		COMP_UI_M_BUT_PD_REMARKS.setDisabled(disabled);
		COMP_UI_M_BUT_PD_BANK_NAME.setDisabled(disabled);
		COMP_UI_M_BUT_PD_BRANCH_NAME.setDisabled(disabled);
		COMP_UI_M_BUT_MORE.setDisabled(disabled);
		COMP_UI_M_BUT_MAIN_RECEIPT.setDisabled(disabled);
		COMP_UI_M_BUT_PD_ADDR_02.setDisabled(disabled);
	...
	public void instantiateAllComponent(){
		...
		COMP_UI_M_EXP_DT				 = new HtmlInputText();
		...
		COMP_UI_M_BUT_BANK_LOV				 = new HtmlCommandButton();
		COMP_UI_M_BUT_LOV_DPD_REF_ID			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_CUST_NAME			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_ADDR_01			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_ADDR_03			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_REMARKS			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_BANK_NAME			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_BRANCH_NAME			 = new HtmlCommandButton();
		COMP_UI_M_BUT_MORE				 = new HtmlCommandButton();
		COMP_UI_M_BUT_MAIN_RECEIPT			 = new HtmlCommandButton();
		COMP_UI_M_BUT_PD_ADDR_02			 = new HtmlCommandButton();
