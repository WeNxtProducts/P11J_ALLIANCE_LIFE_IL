...
public class CTRL extends BaseValueBean {
	...
	/**
		...
		/**
		 * @param ui_m_user_id the uI_M_USER_ID to set
		 */
		...
		/**
		 * @param ui_m_para_1 the uI_M_PARA_1 to set
		 */
		...
		/**
		 * @param ui_m_prog_name the uI_M_PROG_NAME to set
		 */
		...
		/**
		 * @param ui_m_scr_name the uI_M_SCR_NAME to set
		 */
		...
		/**
		 * @param ui_m_gofld_name the uI_M_GOFLD_NAME to set
		 */
		...
		/**
		 * @param ui_m_lang_code the uI_M_LANG_CODE to set
		 */
		...
		/**
		 * @param ui_m_comp_code the uI_M_COMP_CODE to set
		 */
		...
		/**
		 * @param ui_m_divn_code the uI_M_DIVN_CODE to set
		 */
		...
		/**
		 * @param ui_m_dept_code the uI_M_DEPT_CODE to set
		 */
		...
		/**
		 * @param ui_m_comm_del the uI_M_COMM_DEL to set
		 */
