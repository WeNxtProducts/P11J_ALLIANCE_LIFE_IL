...
public class PILR110_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR110_HELPER helper;
	PILR110_DELEGATE delegate;

	private List<SelectItem> listM_FM_STATUS;

	public PILR110_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR110_HELPER();
		delegate = new PILR110_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_FM_STATUS = new ArrayList<SelectItem>();
			listM_FM_STATUS = ListItemUtil.getDropDownListValue(connection,
					"PGLR035_012", "REP_PARAM", "REP_PARAM.M_FM_STATUS",
					"RSTM01");
	 ...
	 *  } catch (IOException e) { e.printStackTrace(); } return redirectUrl; }
	 */
	...
	public String runAction() {
		...
		try {
			...
			//	new PILR110_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						.getCurrentInstance().getExternalContext()
						.getResponse();
				
				map.put("P_DIVN_FM_CODE",IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_DIVN_TO_CODE",IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_DEPT_FM_CODE",IP_REP_INFO_BEAN.getUI_FM_DEPT_CODE());
				map.put("P_DEPT_TO_CODE",IP_REP_INFO_BEAN.getUI_TO_DEPT_CODE());
				map.put("P_SC_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_SC_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
				map.put("P_FM_PLAN_TYPE",IP_REP_INFO_BEAN.getUI_M_FM_PLAN_CODE());
				map.put("P_TO_PLAN_TYPE",IP_REP_INFO_BEAN.getUI_M_TO_PLAN_CODE());
	...
	public void onLoad(PhaseEvent phaseEvent) throws Exception {

		PILR110_HELPER helper = new PILR110_HELPER();
	...
	public List<SelectItem> getListM_FM_STATUS() {
		return listM_FM_STATUS;
	}

	public void setListM_FM_STATUS(List<SelectItem> listM_FM_STATUS) {
		this.listM_FM_STATUS = listM_FM_STATUS;
	}

	public void whenValidateUI_M_FM_DIVN_CODE(ActionEvent actionEvent) {
		...
		try {
			...
			if (inputValue.isEmpty()) {
				getCOMP_1_INPUT_TEXT().setSubmittedValue("0");
				IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE("0");
			} else {
				getCOMP_1_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE(inputValue);
			}
			ErrorHelpUtil.validate(Input, getErrorMap());
		} catch (Exception e) {
			e.printStackTrace();
	...
	/*public void whenValidateUI_M_TO_DIVN_CODE(ActionEvent actionEvent) {
		try {
			UIInput input = (UIInput) actionEvent.getComponent().getParent();
			String inputValue = (String) input.getSubmittedValue();
			String DivnFmCode = IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE();
			if (inputValue.isEmpty()) {
				if (DivnFmCode.equals("0")) {
					getCOMP_2_INPUT_TEXT().setSubmittedValue(z_Constant);
					IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(z_Constant);
				} else {
					getCOMP_2_INPUT_TEXT().setSubmittedValue(DivnFmCode);
					IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(DivnFmCode);
					IP_REP_INFO_BEAN.setUI_M_TO_DIVN_DESC(IP_REP_INFO_BEAN.getUI_M_FM_DIVN_DESC());
				}
			} else if (inputValue.compareTo(DivnFmCode) >= 0) {
				getCOMP_2_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(inputValue);
			} else {
				getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
	...
	public void whenValidateUI_M_FM_DEPT_CODE(ActionEvent actionEvent) {
		...
		try {
			...
			System.out.println("Input Value: " + inputValue);
			if (inputValue.isEmpty()) {
				getCOMP_3_INPUT_TEXT().setSubmittedValue("0");
				IP_REP_INFO_BEAN.setUI_FM_DEPT_CODE("0");
			} else {
				getCOMP_3_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_FM_DEPT_CODE(inputValue);
			}
			ErrorHelpUtil.validate(Input, getErrorMap());
		} catch (Exception e) {
			e.printStackTrace();
	...
	/*public void whenValidateUI_M_TO_DEPT_CODE(ActionEvent actionEvent) {
		try {
			UIInput input = (UIInput) actionEvent.getComponent().getParent();
			String inputValue = (String) input.getSubmittedValue();
			String DeptFmCode = IP_REP_INFO_BEAN.getUI_FM_DEPT_CODE();
			if (inputValue.isEmpty()) {
				if (DeptFmCode.equals("0")) {
					getCOMP_4_INPUT_TEXT().setSubmittedValue(z_Constant);
					IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(z_Constant);
				} else {
					getCOMP_4_INPUT_TEXT().setSubmittedValue(DeptFmCode);
					IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(DeptFmCode);
				}
			} else if (inputValue.compareTo(DeptFmCode) >= 0) {
				getCOMP_4_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(inputValue);
			} else {
				getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
						"Enter Greater value than From ");
			}
	...
	public void whenValidateUI_M_TO_DEPT_CODE(ActionEvent actionEvent) {
		...
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_FM_DEPT_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_FM_DEPT_CODE())){
					this.IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_DEPT_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(IP_REP_INFO_BEAN.getUI_FM_DEPT_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_DESC(IP_REP_INFO_BEAN.getUI_M_FM_DEPT_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_TO_DEPT_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_PLAN_CODE(ActionEvent actionEvent) {
			UIInput input = (UIInput) actionEvent.getComponent().getParent();
			String inputValue = (String) input.getSubmittedValue();
			String DivnFmCode = IP_REP_INFO_BEAN.getUI_M_FM_PLAN_CODE();
			if (inputValue.isEmpty()) {
				if(DivnFmCode != null){
					if (DivnFmCode.equals("0")) {
						getCOMP_6_INPUT_TEXT().setSubmittedValue(z_Constant);
						IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE(z_Constant);
						IP_REP_INFO_BEAN.setUI_M_TO_PLAN_DESC(null);
					} else {
						getCOMP_6_INPUT_TEXT().setSubmittedValue(DivnFmCode);
						IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE(DivnFmCode);
						IP_REP_INFO_BEAN.setUI_M_TO_PLAN_DESC(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_DESC());
					}
					...
					//ErrorHelpUtil.validate(input, getErrorMap());
					if (input.isValid()) {
						this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE(input.getValue().toString());
					}
				}
	...
	public void whenValidateUI_M_TO_PROD_CODE(ActionEvent actionEvent) {
			UIInput input = (UIInput) actionEvent.getComponent().getParent();
			String inputValue = (String) input.getSubmittedValue();
			String DeptFmCode = IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE();
			if (inputValue.isEmpty()) {
				if (DeptFmCode.equals("0")) {
					getCOMP_8_INPUT_TEXT().setSubmittedValue(z_Constant);
					IP_REP_INFO_BEAN.setUI_M_TO_PROD_CODE(z_Constant);
					IP_REP_INFO_BEAN.setUI_M_TO_PROD_DESC(null);
				} else {
					getCOMP_8_INPUT_TEXT().setSubmittedValue(DeptFmCode);
					IP_REP_INFO_BEAN.setUI_M_TO_PROD_CODE(DeptFmCode);
					IP_REP_INFO_BEAN.setUI_M_TO_PROD_DESC(IP_REP_INFO_BEAN.getUI_M_FM_PROD_DESC());
				}
			}else{
				//ErrorHelpUtil.validate(input, getErrorMap());
				if (input.isValid()) {
					this.IP_REP_INFO_BEAN.setUI_M_TO_PROD_CODE(input.getValue().toString());
				}
			}
	...
	public void whenValidateUI_M_FM_PLAN_CODE(ActionEvent actionEvent) {
		...
		try {
			...
			System.out.println("Input Value: " + inputValue);
			if (inputValue.isEmpty()) {
				getCOMP_5_INPUT_TEXT().setSubmittedValue("0");
				IP_REP_INFO_BEAN.setUI_M_FM_PLAN_CODE("0");
			} else {
				getCOMP_5_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_M_FM_PLAN_CODE(inputValue);
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void whenValidateUI_M_FM_PROD_CODE(ActionEvent actionEvent) {
		...
		try {
			...
			System.out.println("Input Value: " + inputValue);
			if (inputValue.isEmpty()) {
				getCOMP_7_INPUT_TEXT().setSubmittedValue("0");
				IP_REP_INFO_BEAN.setUI_M_FM_PROD_CODE("0");
			} else {
				getCOMP_7_INPUT_TEXT().setSubmittedValue(inputValue);
				IP_REP_INFO_BEAN.setUI_M_FM_PROD_CODE(inputValue);
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_FM_DIVN_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		ArrayList<OracleParameter> list = new ArrayList<OracleParameter>();
		IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE((String) value);
		try {
			list = new DBProcedures().P_VAL_DIVN(IP_REP_INFO_BEAN
					.getUI_FM_DIVN_CODE(), IP_REP_INFO_BEAN
					.getUI_M_FM_DIVN_DESC(), "N", CommonUtils.getControlBean()
					.getM_LANG_CODE());
			if (list != null && !(list.isEmpty())) {
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(list.get(0).getValue());
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_TO_DIVN_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		ArrayList<OracleParameter> list = new ArrayList<OracleParameter>();
		IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE((String) value);
		try {
			list = new DBProcedures().P_VAL_DIVN(IP_REP_INFO_BEAN
					.getUI_TO_DIVN_CODE(), IP_REP_INFO_BEAN
					.getUI_M_TO_DIVN_DESC(), "N", CommonUtils.getControlBean()
					.getM_LANG_CODE());
			if (list != null && !(list.isEmpty())) {
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(list.get(0).getValue());
			}
	...
	public void validateUI_M_FM_DEPT_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE((String) value);
		try {
			list = new DBProcedures().P_VAL_DEPT(IP_REP_INFO_BEAN
					.getUI_FM_DEPT_CODE(), IP_REP_INFO_BEAN
					.getUI_M_FM_DEPT_DESC(), "N", CommonUtils.getControlBean()
					.getM_LANG_CODE());
			if (list != null && !(list.isEmpty())) {
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(list);
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_TO_DEPT_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_FM_DEPT_CODE((String) value);
		try {
			list = new DBProcedures().P_VAL_DEPT(IP_REP_INFO_BEAN
					.getUI_TO_DEPT_CODE(), IP_REP_INFO_BEAN
					.getUI_M_TO_DEPT_DESC(), "N", CommonUtils.getControlBean()
					.getM_LANG_CODE());
			if (list != null && !(list.isEmpty())) {
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(list);
			}
	...
	public void validateUI_M_FM_PLAN_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_M_FM_PLAN_CODE((String) value);
		try {
			helper.whenValidateUI_M_FM_PLAN_CODE(this);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_TO_PLAN_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE((String) value);
		try {
			helper.whenValidateUI_M_TO_PLAN_CODE(this);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_FM_PROD_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_M_FM_PROD_CODE((String) value);
		try {
			helper.whenValidateUI_M_FM_PROD_CODE(this);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void validateUI_M_TO_PROD_CODE(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		String list = null;
		IP_REP_INFO_BEAN.setUI_M_TO_PROD_CODE((String) value);
		try {
			helper.whenValidateUI_M_TO_PROD_CODE(this);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public ArrayList<LovBean> SuggestionActionDivnFm(Object object) {

			ArrayList<LovBean> lovList = new ArrayList<LovBean>();
			Object[] values = null;
			String currentValue = (String) object;
			String query=PILR110_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
			try {
	...
	public ArrayList<LovBean> SuggestionActionDivnTo(Object object) {

		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR110_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		try {
	...
	public ArrayList<LovBean> SuggestionActionDeptFm(Object object) {

		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR110_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
		try {
	...
	public ArrayList<LovBean> SuggestionActionDeptTo(Object object) {
	...
	public List<LovBean> SuggestionActionPlanCodeFm(Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList  = listitemutil.P_CALL_LOV("PILR110", "REP_PARAM", "M_FM_PLAN_TYPE", 
					"ILPLANTYPE", null, null, null, null, (String)currValue);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return suggestionList;
	}
	public List<LovBean> SuggestionActionPlanTo(Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList  = listitemutil.P_CALL_LOV("PILR110", "REP_PARAM", "M_TO_PLAN_TYPE", 
					"ILPLANTYPE", null, null, null, null, (String)currValue);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<LovBean> SuggestionActionProdCodeFm(Object object) {
		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR110_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		try {
	...
	public List<LovBean> SuggestionActionProdCodeTo(Object object) {
		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR110_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		try {
