...
public class PT_IL_POL_MED_EXAM_DTL_ACTION extends CommonAction {
	...
	public PT_IL_POL_MED_EXAM_DTL_ACTION() {
	 ...
	 public void preparDropDownList(){
    	 ...
    	 listPMED_STATUS = ListItemUtil.getDropDownListValue(
    			    connection, "PILT002_APAC", "PT_IL_POL_MED_EXAM_DTL",
	...
	public void deleteRow(ActionEvent event) {
		try {
			if (isDELETE_ALLOWED()) {
				helper.keyDelRec(this,compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN());
	...
	public void postRecord(ActionEvent event) {
		...
		try {
			if (PT_IL_POL_MED_EXAM_DTL_BEAN.getROWID() == null
				...
				new CRUDHandler().executeInsert(PT_IL_POL_MED_EXAM_DTL_BEAN,CommonUtils.getConnection());
				...
				dataList_PT_IL_POL_MED_EXAM_DTL
					...
					&& isUPDATE_ALLOWED()) {
				helper.preUpdate(getPT_IL_POL_MED_EXAM_DTL_BEAN(),compositeAction.getCTRL_ACTION_BEAN().getCTRL_BEAN());
	...
	public void displayRecords() {
		...
		try {
			...
			PT_IL_POL_MED_EXAM_DTL_BEAN = (PT_IL_POL_MED_EXAM_DTL) dataTable
					.getRowData();
			helper.postQuery(this,compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN());
	...
	public void PMED_EXAM_CODE_WHEN_VALIDATE_ITEM(FacesContext context, UIComponent component,
			Object value) throws ValidatorException {

		try{
			getPT_IL_POL_MED_EXAM_DTL_BEAN().setPMED_EXAM_CODE((String)value);
			helper.PMED_EXAM_CODE_WHEN_VALIDATE_ITEM(getPT_IL_POL_MED_EXAM_DTL_BEAN());
	...
	public void PMED_CLINIC_CODE_WHEN_VALIDATE_ITEM(FacesContext context, UIComponent component,
			Object value) throws ValidatorException {
		String str = null;
	try{
			getPT_IL_POL_MED_EXAM_DTL_BEAN().setPMED_CLINIC_CODE((String)value);
			 str= helper.PMED_CLINIC_CODE_WHEN_VALIDATE_ITEM(getPT_IL_POL_MED_EXAM_DTL_BEAN(),
					compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN());
	...
	public void PMED_STATUS_WHEN_VALIDATE_ITEM(FacesContext context, UIComponent component,
			Object value) throws ValidatorException {

		try{
			getPT_IL_POL_MED_EXAM_DTL_BEAN().setPMED_STATUS((String)value);
			helper.PMED_STATUS_WHEN_VALIDATE_ITEM(compositeAction.getPT_IL_POL_MED_EXAM_DTL_ACTION_BEAN());
	...
	public ArrayList<LovBean> prepareSuggestionList_EXAM_CODE(Object object){
		...
		try {
			...
			lovList =	itemUtil.P_CALL_LOV(moduleName, blockName, fieldName, param1, null, null, null, null, currentValue);
		} catch (Exception e) {
			e.printStackTrace();
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY, e.getMessage());
