...
public class PILQ003_HELPER {
    ...
    public void IL_ADD_ENDORSE_COMMENT_CHANGES(PILQ003_COMPOSITE_ACTION compositeAction) {
	...
	//    object = new Object[] { pt_il_policy_bean.getPOL_PLAN_CODE() };
	     ...
	     */
	    if (CommonUtils.getGlobalVariable("CALLING_FORM").equals("PILT010")
	    ...
	    } else if (CommonUtils.getGlobalVariable("CALLING_FORM").equals(
		    "PILT041_APAC")) // ADDED BY SARVINDER/
	    {
		pt_il_policy_helper.executeQuery(compositeAction);
		// EXECUTE_QUERY;
	    } else if ("IL_END_QUOT"
		    .equals(CommonUtils.getGlobalVariable("GLOBAL.M_PARAM_1"))) {
	    ...
	    if (CommonUtils.getGlobalVariable("CALLING_FORM").equals(
		    "PILT041_APAC")
	    ...
	    if ("Q".equalsIgnoreCase(CommonUtils
			...
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_BENEFICIARY);
			...
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_ASSR_ILLNESS_DTLS);
			compositeAction.getWizard().disableWizardItem("PILT002_APAC_PT_IL_POL_ASSR_ILLNESS_DTLS");
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_MED_EXAM_DTL);
			...
			/*compositeAction.getTabbedBar().setTabDisabled(
				compositeAction.TAB_PT_IL_DOC_TODO_LIST_STATUS);*/
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_SURR_MAT_VALUES);
			compositeAction.getWizard().disableWizardItem("PILT002_APAC_PT_IL_SURR_MAT_VALUES");
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_STATUS);
			compositeAction.getWizard().disableWizardItem("PILT002_APAC_PT_IL_POL_STATUS");
			// compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_COMMENTS);
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_DISC_LOAD);
			compositeAction.getWizard().disableWizardItem("PILT002_APAC_PT_IL_POL_DISC_LOAD");
			//compositeAction.getTabbedBar().setTabDisabled(compositeAction.TAB_PT_IL_POL_CONDITION);
...
*/		compositeAction.getPT_IL_POLICY_ACTION_BEAN()
    ...
    public void PRE_FORM(PILQ003_COMPOSITE_ACTION compositeAction)
	    throws Exception {
	...
	try {
	    ...
	    rs_PP_SYS = new CRUDHandler().executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_PP_SYS,
		    connection );
	    ...
	    rs_1 = new CRUDHandler().executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_1, connection,
		    object1);
	    ...
	    rs_5 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_5, connection,
		    object5);
	    ...
	    rs_6 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_6, connection,
		    object6);
	    if (rs_6.next()) {
	    ...
	    rs_7 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_7, connection,
		    object7);
	  ...
	  /*  if ("1".equalsIgnoreCase(CommonUtils.getGlobalVariable(
	    ...
	    rs_BUY_SELL = new CRUDHandler().executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_BUY_SELL,
	    ...
	    rs_PLAN = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_PLAN, connection,
		    objectPlan);
		...
		compositeAction.getPT_IL_POLICY_ACTION_BEAN()
			.getCOMP_POL_FC_SUM_ASSURED().setRequired(true);
		compositeAction.getPT_IL_POLICY_ACTION_BEAN()
			.getCOMP_POL_LC_SUM_ASSURED().setRequired(true);
		compositeAction.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN()
	    ...
	    rs_8 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_8, connection,
		    object8);
	    while (rs_8.next()) {
		...
		action.getCOMP_POL_FAC_YN().setDisabled(true);
	    } 
	    else {
		    ...
		    action
			    ...
			    .setValue(
				    Messages
					    .getString(
						    "messageProperties_PILT002_APAC",
						    "PILT002_APAC$PT_IL_POLICY$POL_NO$caption")); // Policy
												    // No.';
		...
		action
			...
			.setValue(
				Messages
					.getString(
						"messageProperties_PILT002_APAC",
						"PILT002_APAC$PT_IL_POLICY$POL_PROP_NO$caption")); // Proposal
												    // No.';
		...
		CommonUtils.setGlobalVariable("GLOBAL.M_PARAM_11", "S");
	    }
	    /*
		...
		if ("1".equals(valueBean.getPOL_DS_TYPE())) {
		    ...
		    rs_3 = handler.executeSelectStatement(
			    PILQ003_QUERY_CONSTANTS.preFormQUERY_3,
			    connection, object3);
		    if (rs_3.next()) {
		...
		action.getCOMP_POL_NO_OF_INST_LABEL().setRendered(true);
		action.getCOMP_POL_CREDIT_INT_RATE().setRequired(false);
	    ...
	    rs_2 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_2, connection,
		    object2);
	    if (rs_2.next()) {
	    ...
	    rs_4 = handler.executeSelectStatement(
		    PILQ003_QUERY_CONSTANTS.preFormQUERY_4, connection,
		    object4);
	    ...
	    ErrorHelpUtil.getErrorsAndWarningforProcedure(connection,
		    ...
		    PILQ003_CONSTANTS.FORM_ID, action.getWarningMap());
	 ...
	 */
	public void STD_PRE_FORM(PILQ003_COMPOSITE_ACTION compositeAction){
	 ...
	 public void setLabel(   PT_IL_POLICY_ACTION pt_il_policy_action,
		 PT_IL_POL_ADDL_COVER_ACTION pt_il_pol_addl_cover_action,
		 PT_IL_POLICY_1_ACTION pt_il_policy_1_action ,
		 PT_IL_POLICY2_ACTION pt_il_policy_2_action ,
		 PT_IL_POL_STATUS_ACTION pt_il_pol_status_action,
