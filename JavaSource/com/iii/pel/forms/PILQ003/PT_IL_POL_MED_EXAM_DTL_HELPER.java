...
public class PT_IL_POL_MED_EXAM_DTL_HELPER {
	...
	public void preInsert(PT_IL_POL_MED_EXAM_DTL medicalDetail,
		...
		/*PILQ003_COMPOSITE_ACTION compositeAction = (PILQ003_COMPOSITE_ACTION) utils
	...
	public void whenNewRecordInstance(PT_IL_POL_MED_EXAM_DTL_ACTION examAction)
			throws Exception {
	...
	public void PMED_EXAM_CODE_WHEN_VALIDATE_ITEM(
			PT_IL_POL_MED_EXAM_DTL examDetail) throws Exception {
	...
	public void PMED_STATUS_WHEN_VALIDATE_ITEM(
			PT_IL_POL_MED_EXAM_DTL_ACTION examAction) throws Exception {
