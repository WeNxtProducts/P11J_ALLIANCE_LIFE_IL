...
public class PT_IL_POL_ASSURED_DTLS_ACTION extends CommonAction {
		...
		try {
			if (getPT_IL_POL_ASSURED_DTLS_BEAN().getROWID() == null) {
				...
				helper.preInsert(compositeAction.getPT_IL_POLICY_ACTION_BEAN()
						.getPT_IL_POLICY_BEAN(), compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN(),PT_IL_POL_ASSURED_DTLS_BEAN);
				new CRUDHandler().executeInsert(PT_IL_POL_ASSURED_DTLS_BEAN, CommonUtils.getConnection());
				...
				helper.preUpdate(getPT_IL_POL_ASSURED_DTLS_BEAN(),compositeAction);
				new CRUDHandler().executeInsert(PT_IL_POL_ASSURED_DTLS_BEAN, CommonUtils.getConnection());
	...
	public void onLoad(PhaseEvent event) {
		try {
			if (isBlockFlag()) {
				helper.WHEN_NEW_BLOCK_INSTANCE(PT_IL_POL_ASSURED_DTLS_BEAN,compositeAction);
  ...
  public String medicalHistory(){
	...
	public void POAD_ASSR_CODE_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			helper.POAD_ASSR_CODE_WHEN_VALIDATE_ITEM(compositeAction,getPT_IL_POL_ASSURED_DTLS_BEAN());
			COMP_POAD_ASSURED_NAME.resetValue();
	...
	public void POAD_REF_ID1_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			helper.POAD_REF_ID1_WHEN_VALIDATE_ITEM(POAD_REF_ID1,compositeAction,getPT_IL_POL_ASSURED_DTLS_BEAN());
			COMP_POAD_DOB.resetValue();
			COMP_POAD_AGE.resetValue();
			COMP_POAD_DISC_AGE.resetValue();
			COMP_POAD_CATG_CODE.resetValue();
	...
	public void POAD_REF_ID2_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			helper.POAD_REF_ID2_WHEN_VALIDATE_ITEM(compositeAction , getPT_IL_POL_ASSURED_DTLS_BEAN());
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	}
	...
	public void POAD_TYPE_WHEN_LIST_CHANGED(FacesContext context,
		...
		try {
			...
			helper.POAD_TYPE_WHEN_LIST_CHANGED(compositeAction,getPT_IL_POL_ASSURED_DTLS_BEAN());
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	}
	...
	public void POAD_DOB_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			helper.POAD_DOB_WHEN_VALIDATE_ITEM(POAD_DOB, this, compositeAction
					.getPT_IL_POL_ASSURED_DTLS_1_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_1_BEAN(), 
	...
	public void POAD_AGE_PROOF_FLAG_WHEN_LIST_CHANGED(FacesContext context,
		...
		try {
			helper.POAD_AGE_PROOF_FLAG_WHEN_LIST_CHANGED(POAD_AGE_PROOF_FLAG,
					compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN());
			getPT_IL_POL_ASSURED_DTLS_BEAN().setPOAD_AGE_PROOF_FLAG(
					POAD_AGE_PROOF_FLAG);
			COMP_POAD_AGE_PROOF_OTHERS.resetValue();
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
	...
	public void POAD_OCC_CODE_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			helper.POAD_OCC_CODE_WHEN_VALIDATE_ITEM(POAD_OCC_CODE,PT_IL_POL_ASSURED_DTLS_BEAN);
			COMP_UI_M_POAD_OCC_DESC.resetValue();
			COMP_POAD_OCC_CLASS.resetValue();
			COMP_UI_M_POAD_OCC_CLASS_DESC.resetValue();
		} catch (Exception e) {
	...
	public void POAD_RELIGION_CODE_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			getPT_IL_POL_ASSURED_DTLS_BEAN().setPOAD_RELIGION_CODE(POAD_RELIGION_CODE);
			helper.POAD_RELIGION_CODE_VALIDATE_ITEM(POAD_RELIGION_CODE,getPT_IL_POL_ASSURED_DTLS_BEAN());
			COMP_UI_M_POAD_REL_CODE_DESC.resetValue();
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	...
	public void POAD_HEALTH_CODE_WHEN_VALIDATE_ITEM(FacesContext context,
		...
		try {
			...
			getPT_IL_POL_ASSURED_DTLS_BEAN().setPOAD_HEALTH_CODE(POAD_HEALTH_CODE);
			helper.POAD_HEALTH_CODE_VALIDATE_ITEM(POAD_HEALTH_CODE,getPT_IL_POL_ASSURED_DTLS_BEAN());
			COMP_UI_M_POAD_HEALTH_DESC.resetValue();
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
		...
		try {
			...
			POAD_LC_AMAN_PREM = helper.POAD_LC_AMAN_PREM_VALIDATE_ITEM(
					...
					compositeAction.getPT_IL_POLICY_ACTION_BEAN()
							.getPT_IL_POLICY_BEAN(), compositeAction
							.getDUMMY_ACTION_BEAN().getDUMMY_BEAN());
			getPT_IL_POL_ASSURED_DTLS_BEAN().setPOAD_LC_AMAN_PREM(POAD_LC_AMAN_PREM);
		} catch (Exception e) {
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	}
 ...
 public void setlistValues(){
	 ...
	 try {
		setListPOAD_AGE_PROOF_FLAG(ListItemUtil.getDropDownListValue(
				    ...
				    "PT_IL_POL_ASSURED_DTLS.POAD_AGE_PROOF_FLAG", "IL_AGE_PROOF"));
