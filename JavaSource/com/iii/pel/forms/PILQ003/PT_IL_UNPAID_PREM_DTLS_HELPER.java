...
public class PT_IL_UNPAID_PREM_DTLS_HELPER {
	...
	public  void WHEN_NEW_RECORD_INSTANCE(PILQ003_COMPOSITE_ACTION compositeAction) throws Exception {
	...
	public void UPD_INT_CODE_WHEN_VALIDATE_ITEM(PILQ003_COMPOSITE_ACTION compositeAction,String currValue) throws Exception {
		PT_IL_POLICY pt_il_policy_bean = compositeAction
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
		DUMMY dummy_bean = compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN();
		ArrayList<OracleParameter> pValList = new ArrayList<OracleParameter>();
	...
	public void UPD_INT_PERC_WHEN_VALIDATE_ITEM(PILQ003_COMPOSITE_ACTION compositeAction,
	...
	public void UPD_FC_INTEREST_WHEN_VALIDATE_ITEM(PILQ003_COMPOSITE_ACTION compositeAction,
			Double currValue) throws Exception {
		PT_IL_POLICY pt_il_policy_bean = compositeAction
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
		DUMMY dummy_bean = compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN();
	...
	public void UPD_LC_INTEREST_WHEN_VALIDATE_ITEM(PILQ003_COMPOSITE_ACTION compositeAction,
			Double currValue) throws Exception {
		PT_IL_POLICY pt_il_policy_bean = compositeAction
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN();
		DUMMY dummy_bean = compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN();
