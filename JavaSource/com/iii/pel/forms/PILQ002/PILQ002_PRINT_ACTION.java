...
public class PILQ002_PRINT_ACTION extends CommonReportAction{
	
	public PILQ002_COMPOSITE_ACTION compositeAction;
			...
			private void prepareDropDowns(){
				try{
					...
					listUI_M_QUOT_REPORT_TYPE=(CommonReportAction.getDropDownListValue(connection, 
							"N", 
							"SUR_QUOT",compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getUI_M_QUOT_TYPE()));
				}catch (Exception e) {
					e.printStackTrace();
				}
	...
	public String runAction() {
		...
		try {
			...
			if (IP_REP_INFO_BEAN.getROWID() == null) {
				...
				String pol_no = compositeAction.getPT_IL_POLICY_ACTION_BEAN()
	...
	//end
		...
		.getExternalContext().getRequest();
		 ...
		 try{
				...
				String SCHEDULE_REPORT_TYPE=compositeAction.getPILQ002_PRINT_ACTION_BEAN().getUI_M_QUOT_REPORT();
