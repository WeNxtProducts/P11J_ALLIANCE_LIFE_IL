...
public class PILR278_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR278_012_HELPER helper;
	PILR278_012_DELEGATE delegate;

	private List<SelectItem> listM_POL_NO;

	public PILR278_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR278_012_HELPER();
		delegate = new PILR278_012_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_POL_NO = ListItemUtil.getDropDownListValue(connection,
					"PILR278_012", "REP_PARAM", "REP_PARAM.M_POL_NO", "RSTM01");
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_FM_POL_GRANTEE_CODE", IP_REP_INFO_BEAN.getUI_M_GRANTEE_FM());
				map.put("P_TO_POL_GRANTEE_CODE", IP_REP_INFO_BEAN.getUI_M_GRANTEE_TO());
				map.put("P_FM_USER_CODE", IP_REP_INFO_BEAN.getUI_M_USER_FM());
				map.put("P_TO_USER_CODE", IP_REP_INFO_BEAN.getUI_M_USER_TO());
				map.put("P_FM_PRODUCER_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_FM());
				map.put("P_TO_PRODUCER_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_TO());
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR278_012_HELPER helper = new PILR278_012_HELPER();
	...
	public List<LovBean> lovUI_M_FM_PROD_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR278_012",
	...
	public List<LovBean> lovUI_M_TO_PROD_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR278_012",
					"REP_PARAM", "M_TO_PROD_CODE", null, null, null, null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_FM_PRODUCER_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR278_012",
					"REP_PARAM", "M_FM_PRODUCER_CODE", "BROKER", null, "BROKER", null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_TO_PRODUCER_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR278_012",
					"REP_PARAM", "M_TO_PRODUCER_CODE", "BROKER", null, "BROKER", null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR278_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR278_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR278_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR278_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_GRANTEE(Object value) {
		String code = (String) value;
		List<LovBean> suggestionList = null;
		Object[] object = {};
		String query = null;
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR278_012_QUERY_CONSTANTS.GRANTEE_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR278_012_QUERY_CONSTANTS.GRANTEE_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value) {
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR278_012", "REP_PARAM",
					"M_POL_NO", "GL_ADDL_STAT", "2", null, null, null,
					(String) value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
					e.getMessage());
	...
	public void whenValidateUI_M_GRANTEE_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_GRANTEE_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_GRANTEE_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_GRANTEE_FM(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_PRODUCER_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
	...
	public void whenValidateUI_M_PRODUCER_TO(ActionEvent actionEvent) {
		cancelModalPanel();
	...
	public void whenValidateUI_M_GRANTEE_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		...
		if (input.getSubmittedValue() == null
				|| input.getSubmittedValue().toString().isEmpty()) {
			if (IP_REP_INFO_BEAN.getUI_M_GRANTEE_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_GRANTEE_FM())) {
					this.IP_REP_INFO_BEAN
							.setUI_M_GRANTEE_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_GRANTEE_TO_DESC(null);
				} else {
					this.IP_REP_INFO_BEAN.setUI_M_GRANTEE_TO(IP_REP_INFO_BEAN
							.getUI_M_GRANTEE_FM());
					this.IP_REP_INFO_BEAN
							.setUI_M_GRANTEE_TO_DESC(IP_REP_INFO_BEAN
									.getUI_M_GRANTEE_FM_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_GRANTEE_TO(input.getValue()
						.toString());
			}
		}
		...
		if (input.getSubmittedValue() == null
			...
			if (IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
					...
					this.IP_REP_INFO_BEAN.setUI_M_PROD_CODE_TO(IP_REP_INFO_BEAN.getUI_M_PROD_CODE_FM());
					this.IP_REP_INFO_BEAN.setUI_M_PROD_TO_DESC(IP_REP_INFO_BEAN.getUI_M_PROD_FM_DESC());
				}
			}
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
	...
	public void whenValidateUI_USER_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
	...
	public void whenValidateUI_USER_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		...
		if (input.getSubmittedValue() == null
			...
			if (IP_REP_INFO_BEAN.getUI_M_USER_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
					...
					this.IP_REP_INFO_BEAN.setUI_M_USER_TO(IP_REP_INFO_BEAN
							.getUI_M_USER_FM());
					this.IP_REP_INFO_BEAN
							.setUI_M_USER_TO_DESC(IP_REP_INFO_BEAN
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_USER_TO(input.getValue()
						.toString());
			}
		}
