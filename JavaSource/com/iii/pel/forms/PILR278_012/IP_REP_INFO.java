...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_GRANTEE_FM;
	private String UI_M_GRANTEE_TO;
	...
	private String UI_M_GRANTEE_FM_DESC;
	private String UI_M_GRANTEE_TO_DESC;
	...
	public String getUI_M_GRANTEE_FM_DESC() {
		return UI_M_GRANTEE_FM_DESC;
	}

	public void setUI_M_GRANTEE_FM_DESC(String ui_m_GRANTEE_fm_desc) {
		UI_M_GRANTEE_FM_DESC = ui_m_GRANTEE_fm_desc;
	}

	public String getUI_M_GRANTEE_TO_DESC() {
		return UI_M_GRANTEE_TO_DESC;
	}

	public void setUI_M_GRANTEE_TO_DESC(String ui_m_GRANTEE_to_desc) {
		UI_M_GRANTEE_TO_DESC = ui_m_GRANTEE_to_desc;
	}

	public String getUI_M_GRANTEE_FM() {
		return UI_M_GRANTEE_FM;
	}

	public void setUI_M_GRANTEE_FM(String ui_m_GRANTEE_fm) {
		UI_M_GRANTEE_FM = ui_m_GRANTEE_fm;
	}

	public String getUI_M_GRANTEE_TO() {
		return UI_M_GRANTEE_TO;
	}

	public void setUI_M_GRANTEE_TO(String ui_m_GRANTEE_to) {
		UI_M_GRANTEE_TO = ui_m_GRANTEE_to;
	}
