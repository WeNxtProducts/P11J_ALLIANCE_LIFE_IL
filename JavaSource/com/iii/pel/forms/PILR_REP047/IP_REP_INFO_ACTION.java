...
import com.iii.pel.forms.PILR_DEFLT_LIST.PILR_DEFLT_LIST_HELPER;
...
public class IP_REP_INFO_ACTION  extends CommonReportAction{
	
	private static final String Messa = null;
	...
	private HtmlOutputLabel COMP_FROM_CLAIM_NO_LABEL;
	
	private HtmlInputText  COMP_FROM_CLAIM_NO;
	
	private HtmlOutputLabel COMP_TO_CLAIM_NO_LABEL;
	
	private HtmlInputText  COMP_TO_CLAIM_NO;
	...
	private HtmlOutputLabel BROKER_CODE_FROM_LABEL;
	
	private HtmlInputText BROKER_CODE_FROM;
	
	private HtmlOutputLabel BROKER_CODE_TO_LABEL;
	
	private HtmlInputText BROKER_CODE_TO;
	
	private HtmlOutputLabel PREMIUM_TYPE_LABEL;
	
	private HtmlSelectOneMenu PREMIUM_TYPE;
...
/*		CommonUtils.setGlobalVariable("GLOBAL.M_CURR_CODE", "BND");//TODO HARD CODED CURR CODE
		CommonUtils.setGlobalVariable("MENU_PARAMETER_01", "PILR_REP047");
		...
		PREMIUM_TYPE_LIST.add(new  SelectItem("I","Installment"));
		PREMIUM_TYPE_LIST.add(new SelectItem("A","Adjustment"));
		PREMIUM_TYPE_LIST.add(new SelectItem("N","New"));
		PREMIUM_TYPE_LIST.add(new SelectItem("R","Renewal"));
	...
	public HtmlOutputLabel getCOMP_FROM_CLAIM_NO_LABEL() {
		return COMP_FROM_CLAIM_NO_LABEL;
	}

	public void setCOMP_FROM_CLAIM_NO_LABEL(HtmlOutputLabel COMP_FROM_CLAIM_NO_LABEL) {
		this.COMP_FROM_CLAIM_NO_LABEL = COMP_FROM_CLAIM_NO_LABEL;
	}

	public HtmlInputText getCOMP_FROM_CLAIM_NO() {
		return COMP_FROM_CLAIM_NO;
	}

	public void setCOMP_FROM_CLAIM_NO(HtmlInputText COMP_FROM_CLAIM_NO) {
		this.COMP_FROM_CLAIM_NO = COMP_FROM_CLAIM_NO;
	}

	public HtmlOutputLabel getCOMP_TO_CLAIM_NO_LABEL() {
		return COMP_TO_CLAIM_NO_LABEL;
	}

	public void setCOMP_TO_CLAIM_NO_LABEL(HtmlOutputLabel COMP_TO_CLAIM_NO_LABEL) {
		this.COMP_TO_CLAIM_NO_LABEL = COMP_TO_CLAIM_NO_LABEL;
	}

	public HtmlInputText getCOMP_TO_CLAIM_NO() {
		return COMP_TO_CLAIM_NO;
	}

	public void setCOMP_TO_CLAIM_NO(HtmlInputText COMP_TO_CLAIM_NO) {
		this.COMP_TO_CLAIM_NO = COMP_TO_CLAIM_NO;
	}
	...
	public List suggestionActionBrokerTo(Object event) {
		String BrokerToCode = (String) event;
		toBranchList = new IP_REP_INFO_DELEGATE()
				.prepareToBranchCodeList(BrokerToCode, toBranchList);
	
		return toBranchList;
	}
	public List suggestionActionBrokerFrom(Object event) {
		String BrokerFromCode = (String) event;
		fromBranchList = new IP_REP_INFO_DELEGATE()
				.prepareFromBranchCodeList(BrokerFromCode, fromBranchList);
		
		return fromBranchList;
	}
	public List suggestionActionToClaim(Object event) {
		String toClaimCode = (String) event;
		toClaimList = new IP_REP_INFO_DELEGATE()
				.prepareToClaimCodeList(toClaimCode, toClaimList);
	
		return toClaimList;
	}
	public List suggestionActionFromClaim(Object event) {
		String fromClaimCode = (String) event;
		fromClaimList = new IP_REP_INFO_DELEGATE()
				.prepareFromClaimCodeList(fromClaimCode, fromClaimList);
		...
		try
		{
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				if (IP_REP_INFO_BEAN.getROWID() == null) {
					...
					IP_REP_INFO_BEAN.setREP_KEY_NO(repKeyNo);
					IP_REP_INFO_BEAN.setREP_ID(CommonUtils.getGlobalVariable("GLOBAL.M_PARAM_1"));
					IP_REP_INFO_BEAN.setREP_VALUE_1(CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getFROM_DATE()));
					IP_REP_INFO_BEAN.setREP_VALUE_2(CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getTO_DATE()));
					IP_REP_INFO_BEAN.setREP_VALUE_11(IP_REP_INFO_BEAN.getPREMIUM_TYPE());
					IP_REP_INFO_BEAN.setREP_VALUE_3(IP_REP_INFO_BEAN.getBROKER_CODE_FROM());
					IP_REP_INFO_BEAN.setREP_VALUE_4(IP_REP_INFO_BEAN.getBROKER_CODE_TO());
					IP_REP_INFO_BEAN.setREP_CR_DT(new CommonUtils().getCurrentDate());
					IP_REP_INFO_BEAN.setREP_CR_UID(CommonUtils.getControlBean().getM_USER_ID());
				} else {
					IP_REP_INFO_BEAN.setREP_UPD_DT(new CommonUtils().getCurrentDate());
...
//				response.sendRedirect(redirectUrl);
	...
	public String check_Empty() {
		...
		if(IP_REP_INFO_BEAN.getREP_VALUE_1() == null || IP_REP_INFO_BEAN.getREP_VALUE_1().trim().length()<=0){
			return_Value =  Messages.getString("messageProperties_PILR_REP047", "PILR_REP047$INT_REP_INFO$PREM_PAID_FROM_DATE$caption")+required;
		}else if(IP_REP_INFO_BEAN.getREP_VALUE_2() == null || IP_REP_INFO_BEAN.getREP_VALUE_2().trim().length()<=0){
			return_Value = Messages.getString("messageProperties_PILR_REP047", "PILR_REP047$INT_REP_INFO$PREM_PAID_TO_DATE$caption")+required;
		}else if(IP_REP_INFO_BEAN.getREP_VALUE_3() == null || IP_REP_INFO_BEAN.getREP_VALUE_3().trim().length()<=0){
			return_Value = Messages.getString("messageProperties_PILR_REP047", "PILR_REP047$INT_REP_INFO$BROKER_CODE_FROM$caption")+required;
		}else if(IP_REP_INFO_BEAN.getREP_VALUE_4() == null || IP_REP_INFO_BEAN.getREP_VALUE_4().trim().length()<=0){
			return_Value = Messages.getString("messageProperties_PILR_REP047", "PILR_REP047$INT_REP_INFO$BROKER_CODE_TO$caption")+required;
		}else if(IP_REP_INFO_BEAN.getREP_VALUE_5() == null || IP_REP_INFO_BEAN.getREP_VALUE_5().trim().length()<=0){
			return_Value = Messages.getString("messageProperties_PILR_REP047", "PILR_REP047$INT_REP_INFO$PREM_TYPE$caption")+required;
		}
		return return_Value;
	}
	...
	public void submitBrokercodeFrom(ActionEvent e) {
	...
	public void submitBrokercodeTo(ActionEvent e) {
		WHEN_VALIDATE_COMP_TO_BROKER_CODE();
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
		System.out.println("submitBrokercodeTo Set :" + inputString);
		if (inputString != null) {
			IP_REP_INFO_BEAN.setREP_VALUE_4(inputString);
			System.out.println("submitBrokercodeTo :"
					+ IP_REP_INFO_BEAN.getREP_VALUE_4());
		}
		ErrorHelpUtil.validate(input, getErrorMap());
	}
	
	public void PremiumType(ActionEvent e) {
		HtmlSelectOneMenu input = (HtmlSelectOneMenu) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
	...
	public void submitToClaim(ActionEvent e) {
		HtmlInputText input = (HtmlInputText) e.getComponent().getParent();
		String inputString = input.getSubmittedValue().toString();
	...
	public HtmlOutputLabel getBROKER_CODE_FROM_LABEL() {
		return BROKER_CODE_FROM_LABEL;
	}

	public void setBROKER_CODE_FROM_LABEL(HtmlOutputLabel broker_code_from_label) {
		BROKER_CODE_FROM_LABEL = broker_code_from_label;
	}

	public HtmlInputText getBROKER_CODE_FROM() {
		return BROKER_CODE_FROM;
	}

	public void setBROKER_CODE_FROM(HtmlInputText broker_code_from) {
		BROKER_CODE_FROM = broker_code_from;
	}

	public HtmlOutputLabel getBROKER_CODE_TO_LABEL() {
		return BROKER_CODE_TO_LABEL;
	}

	public void setBROKER_CODE_TO_LABEL(HtmlOutputLabel broker_code_to_label) {
		BROKER_CODE_TO_LABEL = broker_code_to_label;
	}

	public HtmlInputText getBROKER_CODE_TO() {
		return BROKER_CODE_TO;
	}

	public void setBROKER_CODE_TO(HtmlInputText broker_code_to) {
		BROKER_CODE_TO = broker_code_to;
	}

	public HtmlOutputLabel getPREMIUM_TYPE_LABEL() {
		return PREMIUM_TYPE_LABEL;
	}

	public void setPREMIUM_TYPE_LABEL(HtmlOutputLabel premium_type_label) {
		PREMIUM_TYPE_LABEL = premium_type_label;
	}

	public void setPREMIUM_TYPE(HtmlSelectOneMenu premium_type) {
		PREMIUM_TYPE = premium_type;
	}

	public List<SelectItem> getPREMIUM_TYPE_LIST() {
		if (PREMIUM_TYPE_LIST.size() ==0)
		{ 
			PREMIUM_TYPE_LIST.clear();
			PREMIUM_TYPE_LIST = ListItemUtil.getDropDownListValue(getConnection(),"PILR_REP047","IP_REP_INFO","IP_REP_INFO.REP_VALUE_5","PREMTYPE");
		}
	...
	public HtmlSelectOneMenu getPREMIUM_TYPE() {
		return PREMIUM_TYPE;
	}
	
	public void UI_M_FROM_DT_WHEN_VALIDATE(ActionEvent ae){
		Date from_Date = getCOMP_FROM_DT().getAsDate(getCOMP_FROM_DT().getSubmittedValue());
		System.out.println("from_Date"+from_Date);
		Date to_Date   = getCOMP_TO_DT().getAsDate(getCOMP_TO_DT().getSubmittedValue());
		System.out.println("to_Date"+to_Date);
		if(from_Date == null){
			getErrorMap().put("current", Messages.getMessage("com.iii.premia.common.errorUtil.PELErrorMessages", "90018").getDetail());
		} else{
			getErrorMap().clear();
	...
	public void WHEN_VALIDATE_COMP_FROM_BROKER_CODE(){
		if("".equals(getBROKER_CODE_FROM().getSubmittedValue().toString()) ){
			getBROKER_CODE_FROM().setSubmittedValue(P_SET_FIRST_FIELD(getBROKER_CODE_FROM().getSubmittedValue().toString(),getBROKER_CODE_TO().getSubmittedValue().toString()));
		}else if(!"".equals(getBROKER_CODE_TO().getSubmittedValue().toString()))
			L_VAL_FROM_TO(getBROKER_CODE_FROM().getSubmittedValue().toString(),getBROKER_CODE_TO().getSubmittedValue().toString());
	}
	
	
	public void WHEN_VALIDATE_COMP_TO_BROKER_CODE(){
		if("".equals(getBROKER_CODE_TO().getSubmittedValue().toString())){
			getBROKER_CODE_TO().setSubmittedValue(P_SET_SECOND_FIELD(getBROKER_CODE_FROM().getSubmittedValue().toString(),getBROKER_CODE_TO().getSubmittedValue().toString()));
		}else{
			L_VAL_FROM_TO(getBROKER_CODE_FROM().getSubmittedValue().toString(),getBROKER_CODE_TO().getSubmittedValue().toString());
		}
	}
	...
	public void submitFileType(ActionEvent event){
		HtmlSelectOneRadio input = (HtmlSelectOneRadio) event.getComponent().getParent();
	...
	public void whenValidateUI_M_PR_DIVN_FM_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setBROKER_CODE_FROM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setBROKER_CODE_FROM_DESC(null);
			COMP_1_INPUT_TEXT.setSubmittedValue(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setBROKER_CODE_FROM(input.getValue().toString());
				COMP_1_INPUT_TEXT.setSubmittedValue(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_PR_DIVN_TO_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getBROKER_CODE_FROM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getBROKER_CODE_FROM())){
					this.IP_REP_INFO_BEAN.setBROKER_CODE_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setBROKER_CODE_TO_DESC(null);
					COMP_2_INPUT_TEXT.setSubmittedValue(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setBROKER_CODE_TO(IP_REP_INFO_BEAN.getBROKER_CODE_FROM());
					this.IP_REP_INFO_BEAN.setBROKER_CODE_TO_DESC(IP_REP_INFO_BEAN.getBROKER_CODE_FROM_DESC());
					COMP_2_INPUT_TEXT.setSubmittedValue(IP_REP_INFO_BEAN.getBROKER_CODE_FROM());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setBROKER_CODE_TO(input.getValue().toString());
				COMP_2_INPUT_TEXT.setSubmittedValue(input.getValue().toString());
			}
		}
	}
	...
	public IP_REP_INFO_DELEGATE getHelper() {
		return helper;
	}

	public void setHelper(IP_REP_INFO_DELEGATE helper) {
		this.helper = helper;
	}

	public static String getMessa() {
		return Messa;
	}
}
