...
public class PILRA002_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILRA002_HELPER helper;
	PILRA002_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILRA002_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILRA002_HELPER();
		delegate=new PILRA002_DELEGATE();
...
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_FM_UNIT_CODE",IP_REP_INFO_BEAN.getUI_M_FM_UNIT_CODE());
				map.put("P_TO_UNIT_CODE",IP_REP_INFO_BEAN.getUI_M_TO_UNIT_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILRA002_HELPER helper=new PILRA002_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovAgentCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILRA002_QUERY_CONSTANTS.AGENT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILRA002_QUERY_CONSTANTS.AGENT_CODE_QUERY_LIKE;
		}
	...
	public List<LovBean> lovGranteeCode1(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILRA002_QUERY_CONSTANTS.CUST_CLASS;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILRA002_QUERY_CONSTANTS.CUST_CLASS_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUnitCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILRA002_QUERY_CONSTANTS.UNIT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILRA002_QUERY_CONSTANTS.UNIT_CODE_QUERY_LIKE;
		}
