package com.iii.pel.forms.PILR386_012;
...
public class PILR386_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	private HtmlInputText COMP_14_INPUT_TEXT_DESC;
	private HtmlInputText COMP_13_INPUT_TEXT_DESC;
	private HtmlInputText COMP_15_INPUT_TEXT_DESC;
	
	PILR386_012_HELPER helper;
	PILR386_012_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR386_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR386_012_HELPER();
		delegate=new PILR386_012_DELEGATE();
...
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						...
						.getResponse();
				map.put("P_FM_POL_APPRV_DT",IP_REP_INFO_BEAN.getREP_VALUE_7());
				map.put("P_TO_POL_APPRV_DT",IP_REP_INFO_BEAN.getREP_VALUE_8());
				...
				map.put("P_FM_CUST_AGENCY_CODE",IP_REP_INFO_BEAN.getUI_M_FM_CUST_AGENCY_CODE());
				map.put("P_TP_CUST_AGENCY_CODE",IP_REP_INFO_BEAN.getUI_M_TO_CUST_AGENCY_CODE());
				//map.put("P_COMP_NAME",CommonUtils.getGlobalVariable("GLOBAL.M_NAME"));   
				map.put("P_REGION_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FM_UNIT_CODE());
				map.put("P_REGION_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TO_UNIT_CODE());
				map.put("P_FM_BRANCH_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
				map.put("P_TO_BRANCH_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
				map.put("P_FM_STATUS_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
				map.put("P_TO_STATUS_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR386_012_HELPER helper=new PILR386_012_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public void whenValidateUI_M_FM_AGENT_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_AGENT_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_AGENT_NAME(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_AGENT_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_FM_CUST_AGENCY_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_CUST_AGENCY_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_CUST_AGENCY_NAME(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_CUST_AGENCY_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_CUST_AGENCY_CODE(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_CUST_AGENCY_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_CUST_AGENCY_CODE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_CUST_AGENCY_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_CUST_AGENCY_NAME(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_CUST_AGENCY_CODE(IP_REP_INFO_BEAN.getUI_M_FM_CUST_AGENCY_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_CUST_AGENCY_NAME(IP_REP_INFO_BEAN.getUI_M_FM_CUST_AGENCY_NAME());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_CUST_AGENCY_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_FM_UNIT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_UNIT_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_UNIT_NAME(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_UNIT_CODE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_UNIT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_UNIT_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_UNIT_CODE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_UNIT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_UNIT_NAME(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_UNIT_CODE(IP_REP_INFO_BEAN.getUI_M_FM_UNIT_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_UNIT_NAME(IP_REP_INFO_BEAN.getUI_M_FM_UNIT_NAME());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_UNIT_CODE(input.getValue().toString());
			}
		}
		COMP_8_INPUT_TEXT.resetValue();
		COMP_8_INPUT_TEXT_DESC.resetValue();
	}
	public void validateUI_M_FM_AGENT_CODE(FacesContext facesContext,
		...
		try {
			if(!"*".equals(uiDivnFmCode)){
				...
				IP_REP_INFO_BEAN.setUI_M_FM_AGENT_NAME(divnCodeName);
			}
			COMP_1_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_FM_CUST_AGENCY_NAME(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			if(!"*".equals(uiDeptFmCode)){
				...
				IP_REP_INFO_BEAN.setUI_M_FM_CUST_AGENCY_NAME(deptCodeName);
			}
			COMP_1_INPUT_TEXT_DESC.resetValue();
	...
	public List<LovBean> lovAgentCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR386_012_QUERY_CONSTANTS.AGENT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR386_012_QUERY_CONSTANTS.AGENT_CODE_QUERY_LIKE;
		}
	...
	public void whenValidateUI_M_TO_AGENT_CODE(ActionEvent actionEvent) {
		...
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_AGENT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_AGENT_NAME(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_AGENT_CODE(IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_AGENT_NAME(IP_REP_INFO_BEAN.getUI_M_FM_AGENT_NAME());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_AGENT_CODE(input.getValue().toString());
			}
		}
	...
	public List<LovBean> lovDivnCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR107", "REP_PARAM", "M_FM_AGENT_CODE", 
	...
	public List<LovBean> lovDeptCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR107", "REP_PARAM", "M_FM_CUST_AGENCY_NAME", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovGranteeCode1(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR386_012_QUERY_CONSTANTS.CUST_CLASS;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR386_012_QUERY_CONSTANTS.CUST_CLASS_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUnitCode(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR386_012_QUERY_CONSTANTS.UNIT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR386_012_QUERY_CONSTANTS.UNIT_CODE_QUERY_LIKE;
		}
	...
	public void whenValidateUI_TO_DIVN_CODE(ActionEvent actionEvent) {
		...
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE())){
					...
					this.IP_REP_INFO_BEAN.setUI_M_PR_DIVN_TO_CODE(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DIVN_NAME(IP_REP_INFO_BEAN.getUI_M_TO_DIVN_NAME());
				}
			}
	...
	public HtmlInputText getCOMP_14_INPUT_TEXT_DESC() {
		return COMP_14_INPUT_TEXT_DESC;
	}

	public void setCOMP_14_INPUT_TEXT_DESC(HtmlInputText comp_14_input_text_desc) {
		COMP_14_INPUT_TEXT_DESC = comp_14_input_text_desc;
	}

	public HtmlInputText getCOMP_13_INPUT_TEXT_DESC() {
		return COMP_13_INPUT_TEXT_DESC;
	}

	public void setCOMP_13_INPUT_TEXT_DESC(HtmlInputText comp_13_input_text_desc) {
		COMP_13_INPUT_TEXT_DESC = comp_13_input_text_desc;
	}
