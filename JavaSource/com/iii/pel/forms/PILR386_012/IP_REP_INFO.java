...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_FM_AGENT_NAME;
	private String UI_M_TO_AGENT_CODE;
	private String UI_M_TO_AGENT_NAME;
	private String UI_M_FM_CUST_AGENCY_CODE;
	private String UI_M_FM_CUST_AGENCY_NAME;
	private String UI_M_TO_CUST_AGENCY_CODE;
	private String UI_M_TO_CUST_AGENCY_NAME;
	private String UI_M_FM_UNIT_CODE;
	private String UI_M_FM_UNIT_NAME;
	private String UI_M_TO_UNIT_CODE;
	private String UI_M_TO_UNIT_NAME;
	private String UI_M_FM_PROD_CODE;
	private String UI_M_TO_PROD_CODE;
	private Date UI_M_DATE_FM;
	private Date UI_M_DATE_TO;
	private String UI_M_PR_DIVN_FM_CODE;
	private String UI_M_FM_DIVN_NAME;
	private String UI_M_PR_DIVN_TO_CODE;
	private String UI_M_TO_DIVN_NAME;
	...
	private String UI_M_PROJECT_CODE;
	private String UI_M_PROJ_DESC;
	private String UI_M_GRANTEE_CODE;
	private String UI_M_GRANTEE_NAME;
	private String UI_M_DEVELOPER_CODE;
	private String UI_M_DEV_DESC;
	...
	public Date getUI_M_DATE_FM() {
		return UI_M_DATE_FM;
	}

	public void setUI_M_DATE_FM(Date ui_m_date_fm) {
		setREP_VALUE_7(new ReportUtils().changeDatetoString(ui_m_date_fm,PELConstants.pelDateFormat));
		UI_M_DATE_FM = ui_m_date_fm;
	}

	public Date getUI_M_DATE_TO() {
		return UI_M_DATE_TO;
	}

	public void setUI_M_DATE_TO(Date ui_m_date_to) {
		setREP_VALUE_8(new ReportUtils().changeDatetoString(ui_m_date_to,PELConstants.pelDateFormat));
		UI_M_DATE_TO = ui_m_date_to;
	}
	...
	public void setUI_M_FM_AGENT_CODE(String ui_m_pr_divn_fm_code) {
		UI_M_FM_AGENT_CODE = ui_m_pr_divn_fm_code;
	}

	public String getUI_M_FM_AGENT_NAME() {
		return UI_M_FM_AGENT_NAME;
	}

	public void setUI_M_FM_AGENT_NAME(String ui_m_fm_divn_name) {
		UI_M_FM_AGENT_NAME = ui_m_fm_divn_name;
	}
	...
	public void setUI_M_TO_AGENT_CODE(String ui_m_pr_divn_to_code) {
		UI_M_TO_AGENT_CODE = ui_m_pr_divn_to_code;
	}

	public String getUI_M_TO_AGENT_NAME() {
		return UI_M_TO_AGENT_NAME;
	}

	public void setUI_M_TO_AGENT_NAME(String ui_m_to_divn_name) {
		UI_M_TO_AGENT_NAME = ui_m_to_divn_name;
	}

	public String getUI_M_FM_CUST_AGENCY_CODE() {
		return UI_M_FM_CUST_AGENCY_CODE;
	}

	public void setUI_M_FM_CUST_AGENCY_CODE(String ui_m_dept_fm_code) {
		UI_M_FM_CUST_AGENCY_CODE = ui_m_dept_fm_code;
	}

	public String getUI_M_FM_CUST_AGENCY_NAME() {
		return UI_M_FM_CUST_AGENCY_NAME;
	}

	public void setUI_M_FM_CUST_AGENCY_NAME(String ui_m_dept_fm_name) {
		UI_M_FM_CUST_AGENCY_NAME = ui_m_dept_fm_name;
	}

	public String getUI_M_TO_CUST_AGENCY_CODE() {
		return UI_M_TO_CUST_AGENCY_CODE;
	}

	public void setUI_M_TO_CUST_AGENCY_CODE(String ui_m_dept_to_code) {
		UI_M_TO_CUST_AGENCY_CODE = ui_m_dept_to_code;
	}

	public String getUI_M_TO_CUST_AGENCY_NAME() {
		return UI_M_TO_CUST_AGENCY_NAME;
	}

	public void setUI_M_TO_CUST_AGENCY_NAME(String ui_m_dept_to_desc) {
		UI_M_TO_CUST_AGENCY_NAME = ui_m_dept_to_desc;
	}
	...
	public String getUI_M_FM_UNIT_CODE() {
		return UI_M_FM_UNIT_CODE;
	}

	public void setUI_M_FM_UNIT_CODE(String ui_m_fm_pol_class_code) {
		UI_M_FM_UNIT_CODE = ui_m_fm_pol_class_code;
	}

	public String getUI_M_FM_UNIT_NAME() {
		return UI_M_FM_UNIT_NAME;
	}

	public void setUI_M_FM_UNIT_NAME(String ui_m_fm_pol_class_name) {
		UI_M_FM_UNIT_NAME = ui_m_fm_pol_class_name;
	}

	public String getUI_M_TO_UNIT_CODE() {
		return UI_M_TO_UNIT_CODE;
	}

	public void setUI_M_TO_UNIT_CODE(String ui_m_to_pol_class_code) {
		UI_M_TO_UNIT_CODE = ui_m_to_pol_class_code;
	}

	public String getUI_M_TO_UNIT_NAME() {
		return UI_M_TO_UNIT_NAME;
	}

	public void setUI_M_TO_UNIT_NAME(String ui_m_to_pol_class_name) {
		UI_M_TO_UNIT_NAME = ui_m_to_pol_class_name;
	}

	public String getUI_M_PROJECT_CODE() {
		return UI_M_PROJECT_CODE;
	}

	public void setUI_M_PROJECT_CODE(String ui_m_project_code) {
		UI_M_PROJECT_CODE = ui_m_project_code;
	}

	public String getUI_M_PROJ_DESC() {
		return UI_M_PROJ_DESC;
	}

	public void setUI_M_PROJ_DESC(String ui_m_prod_desc) {
		UI_M_PROJ_DESC = ui_m_prod_desc;
	}

	public String getUI_M_GRANTEE_CODE() {
		return UI_M_GRANTEE_CODE;
	}

	public void setUI_M_GRANTEE_CODE(String ui_m_grantee_code) {
		UI_M_GRANTEE_CODE = ui_m_grantee_code;
	}

	public String getUI_M_GRANTEE_NAME() {
		return UI_M_GRANTEE_NAME;
	}

	public void setUI_M_GRANTEE_NAME(String ui_m_grantee_name) {
		UI_M_GRANTEE_NAME = ui_m_grantee_name;
	}

	public String getUI_M_DEVELOPER_CODE() {
		return UI_M_DEVELOPER_CODE;
	}

	public void setUI_M_DEVELOPER_CODE(String ui_m_developer_code) {
		UI_M_DEVELOPER_CODE = ui_m_developer_code;
	}

	public String getUI_M_DEV_DESC() {
		return UI_M_DEV_DESC;
	}

	public void setUI_M_DEV_DESC(String ui_m_dev_desc) {
		UI_M_DEV_DESC = ui_m_dev_desc;
	}

	public String getUI_M_PR_DIVN_FM_CODE() {
		return UI_M_PR_DIVN_FM_CODE;
	}

	public void setUI_M_PR_DIVN_FM_CODE(String ui_m_pr_divn_fm_code) {
		UI_M_PR_DIVN_FM_CODE = ui_m_pr_divn_fm_code;
	}

	public String getUI_M_FM_DIVN_NAME() {
		return UI_M_FM_DIVN_NAME;
	}

	public void setUI_M_FM_DIVN_NAME(String ui_m_fm_divn_name) {
		UI_M_FM_DIVN_NAME = ui_m_fm_divn_name;
	}

	public String getUI_M_PR_DIVN_TO_CODE() {
		return UI_M_PR_DIVN_TO_CODE;
	}

	public void setUI_M_PR_DIVN_TO_CODE(String ui_m_pr_divn_to_code) {
		UI_M_PR_DIVN_TO_CODE = ui_m_pr_divn_to_code;
	}

	public String getUI_M_TO_DIVN_NAME() {
		return UI_M_TO_DIVN_NAME;
	}

	public void setUI_M_TO_DIVN_NAME(String ui_m_to_divn_name) {
		UI_M_TO_DIVN_NAME = ui_m_to_divn_name;
	}
