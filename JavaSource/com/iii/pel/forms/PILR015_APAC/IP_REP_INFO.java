...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_FM_SRC_BUS_CLASS;
	private String UI_M_TO_SRC_BUS_CLASS;
	private String UI_M_FM_SRC_BUS_NAME;
	private String UI_M_TO_SRC_BUS_NAME;
	private String UI_M_FM_PROD_CODE;
	private String UI_M_TO_PROD_CODE;
	private Date UI_M_DATE_FM;
	private Date UI_M_DATE_TO;
	private String UI_M_MODULE_CODE_FM;
	private String UI_M_MODULE_CODE_TO;
	...
	public String getUI_M_FM_SRC_BUS_CLASS() {
		return UI_M_FM_SRC_BUS_CLASS;
	}

	public void setUI_M_FM_SRC_BUS_CLASS(String ui_m_fm_src_bus_class) {
		UI_M_FM_SRC_BUS_CLASS = ui_m_fm_src_bus_class;
	}

	public String getUI_M_TO_SRC_BUS_CLASS() {
		return UI_M_TO_SRC_BUS_CLASS;
	}

	public void setUI_M_TO_SRC_BUS_CLASS(String ui_m_to_src_bus_class) {
		UI_M_TO_SRC_BUS_CLASS = ui_m_to_src_bus_class;
	}

	public String getUI_M_FM_SRC_BUS_NAME() {
		return UI_M_FM_SRC_BUS_NAME;
	}

	public void setUI_M_FM_SRC_BUS_NAME(String ui_m_fm_src_bus_name) {
		UI_M_FM_SRC_BUS_NAME = ui_m_fm_src_bus_name;
	}

	public String getUI_M_TO_SRC_BUS_NAME() {
		return UI_M_TO_SRC_BUS_NAME;
	}

	public void setUI_M_TO_SRC_BUS_NAME(String ui_m_to_src_bus_name) {
		UI_M_TO_SRC_BUS_NAME = ui_m_to_src_bus_name;
	}

	public String getUI_M_MODULE_CODE_FM() {
		return UI_M_MODULE_CODE_FM;
	}

	public void setUI_M_MODULE_CODE_FM(String ui_m_module_code_fm) {
		UI_M_MODULE_CODE_FM = ui_m_module_code_fm;
	}

	public String getUI_M_MODULE_CODE_TO() {
		return UI_M_MODULE_CODE_TO;
	}

	public void setUI_M_MODULE_CODE_TO(String ui_m_module_code_to) {
		UI_M_MODULE_CODE_TO = ui_m_module_code_to;
	}
