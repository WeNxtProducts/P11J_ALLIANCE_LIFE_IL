package com.iii.pel.forms.PILR_FBN047;
...
public class PILR_FBN047_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR_FBN047_HELPER helper;
	PILR_FBN047_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR_FBN047_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR_FBN047_HELPER();
		delegate=new PILR_FBN047_DELEGATE();
		...
		try
		{
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				if (IP_REP_INFO_BEAN.getROWID() == null) {
					IP_REP_INFO_BEAN.setREP_VALUE_1(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_2(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_3(IP_REP_INFO_BEAN.getUI_M_DEPT_FM_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_4(IP_REP_INFO_BEAN.getUI_M_DEPT_TO_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_5(IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_6(IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_7(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE());
					IP_REP_INFO_BEAN.setREP_VALUE_8(IP_REP_INFO_BEAN.getUI_M_TO_PLAN_TYPE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR_FBN047_HELPER helper=new PILR_FBN047_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR_FBN047_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_FBN047_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovDeptCode(Object value){
		...
		String retItem=(String)requestMap.get("sssss");
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
	...
	public void lovDeptCode(ActionEvent value){
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_FBN047_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_FBN047_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
