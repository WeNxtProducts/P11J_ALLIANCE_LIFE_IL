...
public class PILR_REP061_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR_REP061_HELPER helper;
	PILR_REP061_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	private List<SelectItem> listGENERATE_LIST = new ArrayList<SelectItem>();
	
	public PILR_REP061_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR_REP061_HELPER();
		delegate=new PILR_REP061_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listGENERATE_LIST.clear();
			listM_MODULE_CODE_FM = new ArrayList<SelectItem>();
			listGENERATE_LIST.add(new SelectItem("EXITED POLICIES"));
			listGENERATE_LIST.add(new SelectItem("INFORCE POLICIES"));
			listM_MODULE_CODE_FM = ListItemUtil.getDropDownListValue(connection, "PILR104", 
		...
		try
		{
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				if (IP_REP_INFO_BEAN.getROWID() == null) {
					IP_REP_INFO_BEAN.setREP_VALUE_5(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_6(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_7(IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_8(IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_1(CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_DATE_FM()));
					IP_REP_INFO_BEAN.setREP_VALUE_2(CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_DATE_FM()));
					IP_REP_INFO_BEAN.setREP_VALUE_9(IP_REP_INFO_BEAN.getUI_M_DEPT_FM_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_10(IP_REP_INFO_BEAN.getUI_M_DEPT_TO_CODE());
					IP_REP_INFO_BEAN.setREP_VALUE_11(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE());
					IP_REP_INFO_BEAN.setREP_VALUE_12(IP_REP_INFO_BEAN.getUI_M_TO_PLAN_TYPE());
					...
					new CRUDHandler().executeUpdate(IP_REP_INFO_BEAN, CommonUtils.getConnection());
					CommonUtils.getConnection().commit();
				}
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						...
						.getResponse();
				map.put("P_DIVN_FM_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
				map.put("P_DIVN_TO_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
				map.put("P_DEPT_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_DEPT_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
				map.put("P_SC_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_SC_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TO_PROD_CODE());
				map.put("P_FM_PLAN_TYPE",IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE());
				map.put("P_TO_PLAN_TYPE",IP_REP_INFO_BEAN.getUI_M_TO_PLAN_TYPE());
				map.put("P_GENERATE_ID", IP_REP_INFO_BEAN.getUI_M_GENERATE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR_REP061_HELPER helper=new PILR_REP061_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public void whenValidateUI_M_FM_PLAN_TYPE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_PLAN_TYPE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_PLAN_NAME(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_PLAN_TYPE(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TO_PLAN_TYPE(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_TYPE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_PLAN_NAME(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_TYPE(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_TYPE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_NAME(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_NAME());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_TYPE(input.getValue().toString());
			}
		}
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR_REP061_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP061_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovDivnCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR104", "REP_PARAM", "M_PR_DIVN_FM_CODE", 
	...
	public List<LovBean> lovDeptCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR104", "REP_PARAM", "M_DEPT_FM_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR104", "REP_PARAM", "M_FM_PROD_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovPlanType(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR104", "REP_PARAM", "M_FM_PLAN_TYPE", 
					"ILPLANTYPE", null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
		}
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR_REP061_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR_REP061_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovPolCode(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			String currentValue = (String) value;
			String Query = "SELECT POL_NO,POL_CONT_CODE  FROM PT_IL_POLICY WHERE POL_NO LIKE  ? OR POL_CONT_CODE LIKE ? AND ROWNUM < ?";
			currentValue = "*".equals(currentValue) ? "%" : currentValue + "%";
			list = listItemUtil.prepareSuggestionList(Query, new Object[]{currentValue,currentValue, PELConstants.suggetionRecordSize});
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
		}
	...
	public List<SelectItem> getListGENERATE_LIST() {
		return listGENERATE_LIST;
	}

	public void setListGENERATE_LIST(List<SelectItem> listGENERATE_LIST) {
		this.listGENERATE_LIST = listGENERATE_LIST;
	}
