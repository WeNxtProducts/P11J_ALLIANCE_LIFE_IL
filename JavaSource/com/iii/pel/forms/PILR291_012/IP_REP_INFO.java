...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_FM_DEPT_CODE;
	private String UI_TO_DEPT_CODE;
	private String UI_M_FM_PLAN_CODE;
	private String UI_M_TO_PLAN_CODE;
	...
	private String UI_M_CUST_CODE_FM;
	private String UI_M_CUST_CODE_TO;
	...
	private String UI_M_FM_PLAN_DESC;
	...
	public String getUI_M_CUST_CODE_FM() {
		return UI_M_CUST_CODE_FM;
	}

	public void setUI_M_CUST_CODE_FM(String ui_m_cust_code_fm) {
		UI_M_CUST_CODE_FM = ui_m_cust_code_fm;
	}

	public String getUI_M_CUST_CODE_TO() {
		return UI_M_CUST_CODE_TO;
	}

	public void setUI_M_CUST_CODE_TO(String ui_m_cust_code_to) {
		UI_M_CUST_CODE_TO = ui_m_cust_code_to;
	}
	...
	public String getUI_FM_DEPT_CODE() {
		return UI_FM_DEPT_CODE;
	}

	public void setUI_FM_DEPT_CODE(String ui_fm_dept_code) {
		UI_FM_DEPT_CODE = ui_fm_dept_code;
	}

	public String getUI_TO_DEPT_CODE() {
		return UI_TO_DEPT_CODE;
	}

	public void setUI_TO_DEPT_CODE(String ui_to_dept_code) {
		UI_TO_DEPT_CODE = ui_to_dept_code;
	}
	...
	public String getUI_M_FM_PLAN_CODE() {
		return UI_M_FM_PLAN_CODE;
	}

	public void setUI_M_FM_PLAN_CODE(String ui_m_fm_plan_code) {
		UI_M_FM_PLAN_CODE = ui_m_fm_plan_code;
	}

	public String getUI_M_TO_PLAN_CODE() {
		return UI_M_TO_PLAN_CODE;
	}

	public void setUI_M_TO_PLAN_CODE(String ui_m_to_plan_code) {
		UI_M_TO_PLAN_CODE = ui_m_to_plan_code;
	}

	public String getUI_M_FM_PLAN_DESC() {
		return UI_M_FM_PLAN_DESC;
	}

	public void setUI_M_FM_PLAN_DESC(String ui_m_fm_plan_desc) {
		UI_M_FM_PLAN_DESC = ui_m_fm_plan_desc;
	}
