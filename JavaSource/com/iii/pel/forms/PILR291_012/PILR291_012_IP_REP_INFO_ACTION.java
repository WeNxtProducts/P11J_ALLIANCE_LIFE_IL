package com.iii.pel.forms.PILR291_012;
...
public class PILR291_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR291_012_HELPER helper;
	PILR291_012_DELEGATE delegate;

	private List<SelectItem> listM_FM_STATUS;

	public PILR291_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR291_012_HELPER();
		delegate = new PILR291_012_DELEGATE();
	...
	public String runAction() {
		...
		try {
			...
			//	new PILR291_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
	...
	public void onLoad(PhaseEvent phaseEvent) throws Exception {
		...
		PILR291_012_HELPER helper = new PILR291_012_HELPER();
	...
	public void whenValidateUI_M_TO_PLAN_CODE(ActionEvent actionEvent) {
		...
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_CODE()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_CODE())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_PLAN_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_CODE(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_PLAN_DESC(IP_REP_INFO_BEAN.getUI_M_FM_PLAN_DESC());
				}
			}
	...
	public ArrayList<LovBean> SuggestionActionDivnFm(Object object) {
			...
			String query=PILR291_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
			try {
	...
	public ArrayList<LovBean> SuggestionActionDivnTo(Object object) {
		...
		String query1 = PILR291_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		try {
	...
	public ArrayList<LovBean> SuggestionActionDeptFm(Object object) {
		...
		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR291_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
		try {
	...
	public List<LovBean> SuggestionActionPlanCodeFm(Object currValue) {
		...
		try {
			suggestionList  = listitemutil.P_CALL_LOV("PILR291_012", "REP_PARAM", "M_FM_PLAN_TYPE", 
	...
	public List<LovBean> SuggestionActionPlanTo(Object currValue) {
		...
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList  = listitemutil.P_CALL_LOV("PILR291_012", "REP_PARAM", "M_TO_PLAN_TYPE", 
					"ILPLANTYPE", null, null, null, null, (String)currValue);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<LovBean> SuggestionActionProdCodeFm(Object object) {
		ArrayList<LovBean> suggestionList = null;
		String query1 = PILR291_012_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		try {
