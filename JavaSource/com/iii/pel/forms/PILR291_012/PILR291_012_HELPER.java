...
public class PILR291_012_HELPER {

	CRUDHandler handler = new CRUDHandler();

	public void whenCreateRecord(PILR291_012_IP_REP_INFO_ACTION action)
			throws Exception {
	...
	public void PRE_INSERT(
			com.iii.pel.forms.PILR291_012.IP_REP_INFO IP_REP_INFO_BEAN) {
	...
	public void whenValidateUI_M_FM_PLAN_CODE(PILR291_012_IP_REP_INFO_ACTION action)
			throws Exception {
		IP_REP_INFO IP_REP_INFO_BEAN = action.getIP_REP_INFO_BEAN();
	...
	public void whenValidateUI_M_TO_PLAN_CODE(PILR291_012_IP_REP_INFO_ACTION action)
			throws Exception {
		IP_REP_INFO IP_REP_INFO_BEAN = action.getIP_REP_INFO_BEAN();
		ResultSet resultSet = null;
		Connection connection = null;
	...
	public void whenValidateUI_M_FM_PROD_CODE(PILR291_012_IP_REP_INFO_ACTION action)
			throws Exception {
		IP_REP_INFO IP_REP_INFO_BEAN = action.getIP_REP_INFO_BEAN();
		String M_PLAN_DESC = null;
	...
	public void whenValidateUI_M_TO_PROD_CODE(PILR291_012_IP_REP_INFO_ACTION action)
			throws Exception {
		IP_REP_INFO IP_REP_INFO_BEAN = action.getIP_REP_INFO_BEAN();
		String M_PLAN_DESC = null;
