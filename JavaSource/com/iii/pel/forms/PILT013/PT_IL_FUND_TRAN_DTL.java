...
public class PT_IL_FUND_TRAN_DTL extends BaseValueBean {
	...
	private Double UI_M_FTD_UNIT_LC_AMT;
	...
	public void setUI_M_FTD_UNIT_LC_AMT(Double UI_M_FTD_UNIT_LC_AMT) {
		this.UI_M_FTD_UNIT_LC_AMT = UI_M_FTD_UNIT_LC_AMT;
	}

	public Double getUI_M_FTD_UNIT_LC_AMT() {
		return UI_M_FTD_UNIT_LC_AMT;
	}
