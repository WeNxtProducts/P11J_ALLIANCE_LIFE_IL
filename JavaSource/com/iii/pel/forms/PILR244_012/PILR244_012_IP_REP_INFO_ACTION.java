...
public class PILR244_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR244_012_HELPER helper;
	PILR244_012_DELEGATE delegate;

	public PILR244_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR244_012_HELPER();
		delegate = new PILR244_012_DELEGATE();
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_PROD_CODE_FM", IP_REP_INFO_BEAN.getUI_M_PROD_FM());
				map.put("P_PROD_CODE_TO", IP_REP_INFO_BEAN.getUI_M_PROD_TO());
				map.put("P_POL_NO_FM", IP_REP_INFO_BEAN.getUI_M_FM_POLICY_CODE());
				map.put("P_POL_NO_TO", IP_REP_INFO_BEAN.getUI_M_TO_POLICY_CODE());
				map.put("P_TO_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_AS_ON_DT()));
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR244_012_HELPER helper = new PILR244_012_HELPER();
	...
	public PILR244_012_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR244_012_HELPER helper) {
		this.helper = helper;
	}

	public PILR244_012_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR244_012_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR244_012",
					"REP_PARAM", "M_BRANCH_FM", null, null, null, null, null,
					(String) obj);
	...
	public List<LovBean> lovUI_M_POLICY_FM(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR244_012",
					"REP_PARAM", "M_POL_FM", null, null, null, null, null,
					(String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_POLICY_TO(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR244_012",
					"REP_PARAM", "M_POL_TO", null, null, null, null, null,
					(String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_PROD_CODE(Object obj) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR244_012",
					"REP_PARAM", "M_PROD_FM", null, null, null, null, null,
					(String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void whenValidateUI_M_FM_POLICY_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_FM_POLICY_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_POLICY_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_POLICY_CODE(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_TO_POLICY_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FM_POLICY_CODE() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_FM_POLICY_CODE())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_TO_POLICY_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_POLICY_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_TO_POLICY_CODE(IP_REP_INFO_BEAN
							.getUI_M_FM_POLICY_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_POLICY_DESC(IP_REP_INFO_BEAN
							.getUI_M_FM_POLICY_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_TO_POLICY_CODE(submittedValue);
