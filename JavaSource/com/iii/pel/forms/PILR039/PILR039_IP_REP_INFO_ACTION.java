...
import com.iii.pel.forms.PILRA002.PILRA002_QUERY_CONSTANTS;
...
public class PILR039_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR030_A_HELPER helper;
	PILR039_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR039_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR030_A_HELPER();
		delegate=new PILR039_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_MODULE_CODE_FM = ListItemUtil.getDropDownListValue(connection, "PILR030_A", 
...
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						...
						.getResponse();
				map.put("P_FM_DIVN_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
				map.put("P_TO_DIVN_CODE",IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
				map.put("P_FM_DEPT_CODE",IP_REP_INFO_BEAN.getUI_M_DEPT_FM_CODE());
				map.put("P_TO_DEPT_CODE",IP_REP_INFO_BEAN.getUI_M_DEPT_TO_CODE());
				//map.put("P_COMP_NAME",CommonUtils.getGlobalVariable("GLOBAL.M_NAME"));   
				map.put("P_FM_CLASS_CODE",IP_REP_INFO_BEAN.getUI_M_FM_POL_CLASS_CODE());
				map.put("P_TO_CLASS_CODE",IP_REP_INFO_BEAN.getUI_M_TO_POL_CLASS_CODE());
				
				map.put("P_FM_DT",IP_REP_INFO_BEAN.getREP_VALUE_7());
				map.put("P_FM_PLAN_CODE",IP_REP_INFO_BEAN.getUI_M_FM_PROD_CODE());
				map.put("P_TO_PLAN_CODE",IP_REP_INFO_BEAN.getUI_M_GRANTEE_CODE());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR030_A_HELPER helper=new PILR030_A_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR039_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR039_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovDivnCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR030_A", "REP_PARAM", "M_PR_DIVN_FM_CODE", 
	...
	public List<LovBean> lovDeptCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR030_A", "REP_PARAM", "M_DEPT_FM_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR030_A", "REP_PARAM", "M_FM_PROD_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovPlanType(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR011", "REP_PARAM", "M_FM_PLAN_TYPE", 
...
/*	public List<LovBean> lovGranteeCode1(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.CUST_CLASS;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR030_A_QUERY_CONSTANTS.CUST_CLASS_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
*/	public List<LovBean> lovProjectCode(Object value){
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR039_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR039_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean>lovAgentCode(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR039_QUERY_CONSTANTS.AGENT_CODE_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR039_QUERY_CONSTANTS.AGENT_CODE_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
...
*/
	public PILR030_A_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR030_A_HELPER helper) {
		this.helper = helper;
	}

	public PILR039_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR039_DELEGATE delegate) {
