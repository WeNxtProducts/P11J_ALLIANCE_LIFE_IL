...
public class PILR_LOAN_SCHD_HELPER {

	CRUDHandler handler = new CRUDHandler();
	public void whenCreateRecord(PILR_LOAN_SCHD_IP_REP_INFO_ACTION PILR104_IP_REP_INFO_ACTION_BEAN) {
		Calendar cal = Calendar.getInstance();
		IP_REP_INFO IP_REP_INFO_BEAN=PILR104_IP_REP_INFO_ACTION_BEAN.getIP_REP_INFO_BEAN(); 
		try {
			IP_REP_INFO_BEAN.setUI_M_DATE_FM(PILR104_IP_REP_INFO_ACTION_BEAN.getDefaultFromDate());
			IP_REP_INFO_BEAN.setUI_M_DATE_TO(PILR104_IP_REP_INFO_ACTION_BEAN.getDefaultToDate());
	...
	public void PRE_INSERT(IP_REP_INFO IP_REP_INFO_BEAN) {
		...
		try {
			...
			IP_REP_INFO_BEAN.setREP_VALUE_3(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_FM_CODE());
			IP_REP_INFO_BEAN.setREP_VALUE_4(IP_REP_INFO_BEAN.getUI_M_PR_DIVN_TO_CODE());
