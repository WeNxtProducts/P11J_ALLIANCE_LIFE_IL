...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_FIN_QTR;
	private String UI_M_RD_YEAR;
	...
	public String getUI_M_FIN_QTR() {
		return UI_M_FIN_QTR;
	}

	public void setUI_M_FIN_QTR(String ui_m_fin_qtr) {
		UI_M_FIN_QTR = ui_m_fin_qtr;
	}

	public String getUI_M_RD_YEAR() {
		return UI_M_RD_YEAR;
	}

	public void setUI_M_RD_YEAR(String ui_m_rd_year) {
