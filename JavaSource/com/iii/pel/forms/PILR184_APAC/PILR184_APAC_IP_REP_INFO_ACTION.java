...
import com.iii.pel.forms.PILP039_APAC.RI_CLOSING_LOV;
...
public class PILR184_APAC_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	private HtmlInputText COMP_UI_M_FIN_QTR;
	private HtmlInputText COMP_UI_M_RD_YEAR;
	...
	private HtmlSelectOneMenu COMP_UI_M_FIN_QTR_SELECT_ONE_MENU;
	private HtmlSelectOneMenu COMP_UI_M_RD_YEAR_SELECT_ONE_MENU;
	...
	private boolean COMP_UI_M_FIN_QTR_SELECT_ONE_MENU_RENDERED;
	private boolean COMP_UI_M_RD_YEAR_SELECT_ONE_MENU_RENDERED;
	...
	private HtmlInputText COMP_15_INPUT_TEXT_DESC;
	private HtmlInputText COMP_16_INPUT_TEXT_DESC;

	PILR184_APAC_HELPER helper;
	PILR184_APAC_DELEGATE delegate;

	private List<SelectItem> listM_INSTR_FM;
	private List<SelectItem> listM_INSTR_TO;
	private List<SelectItem> listM_DEPT_TO;

	public List<SelectItem> getListM_DEPT_TO() {
		return listM_DEPT_TO;
	}

	public void setListM_DEPT_TO(List<SelectItem> listM_DEPT_TO) {
		this.listM_DEPT_TO = listM_DEPT_TO;
	}

	public PILR184_APAC_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR184_APAC_HELPER();
		delegate = new PILR184_APAC_DELEGATE();

		// prepare list for policy , customer type, customer status
		prepareDropDownListM_INSTR_FM();
		prepareDropDownListM_INSTR_TO();
		prepareDropDownListM_DEPT_TO();
	
	}

	/*
	 * public void prepareCustTypeList(){ try{ custTypeList = new ArrayList<SelectItem>();
	 * custTypeList.add(new SelectItem(
	...
	public void setCOMP_SELECT_FILE_TYPE(
			HtmlSelectOneRadio comp_select_file_type) {
	...
	public void setCOMP_1_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_1_select_one_menu) {
	...
	public void setCOMP_10_INPUT_TEXT_RENDERED(
			boolean comp_10_input_text_rendered) {
	...
	public void setCOMP_11_INPUT_TEXT_RENDERED(
			boolean comp_11_input_text_rendered) {
	...
	public void setCOMP_12_INPUT_TEXT_RENDERED(
			boolean comp_12_input_text_rendered) {
	...
	public void setCOMP_13_INPUT_TEXT_RENDERED(
			boolean comp_13_input_text_rendered) {
	...
	public void setCOMP_14_INPUT_TEXT_RENDERED(
			boolean comp_14_input_text_rendered) {
	...
	public void setCOMP_15_INPUT_TEXT_RENDERED(
			boolean comp_15_input_text_rendered) {
	...
	public void setCOMP_16_INPUT_TEXT_RENDERED(
			boolean comp_16_input_text_rendered) {
	...
	public void setCOMP_17_INPUT_TEXT_RENDERED(
			boolean comp_17_input_text_rendered) {
	...
	public void setCOMP_18_INPUT_TEXT_RENDERED(
			boolean comp_18_input_text_rendered) {
	...
	public void setCOMP_19_INPUT_TEXT_RENDERED(
			boolean comp_19_input_text_rendered) {
	...
	public void setCOMP_20_INPUT_TEXT_RENDERED(
			boolean comp_20_input_text_rendered) {
	...
	public void setCOMP_21_INPUT_TEXT_RENDERED(
			boolean comp_21_input_text_rendered) {
	...
	public void setCOMP_22_INPUT_TEXT_RENDERED(
			boolean comp_22_input_text_rendered) {
	...
	public void setCOMP_23_INPUT_TEXT_RENDERED(
			boolean comp_23_input_text_rendered) {
	...
	public void setCOMP_24_INPUT_TEXT_RENDERED(
			boolean comp_24_input_text_rendered) {
	...
	public void setCOMP_25_INPUT_TEXT_RENDERED(
			boolean comp_25_input_text_rendered) {
	...
	public void setCOMP_26_INPUT_TEXT_RENDERED(
			boolean comp_26_input_text_rendered) {
	...
	public void setCOMP_27_INPUT_TEXT_RENDERED(
			boolean comp_27_input_text_rendered) {
	...
	public void setCOMP_28_INPUT_TEXT_RENDERED(
			boolean comp_28_input_text_rendered) {
	...
	public void setCOMP_29_INPUT_TEXT_RENDERED(
			boolean comp_29_input_text_rendered) {
	...
	public void setCOMP_30_INPUT_TEXT_RENDERED(
			boolean comp_30_input_text_rendered) {
	...
	public void setCOMP_31_INPUT_TEXT_RENDERED(
			boolean comp_31_input_text_rendered) {
	...
	public void setCOMP_32_INPUT_TEXT_RENDERED(
			boolean comp_32_input_text_rendered) {
	...
	public void setCOMP_33_INPUT_TEXT_RENDERED(
			boolean comp_33_input_text_rendered) {
	...
	public void setCOMP_34_INPUT_TEXT_RENDERED(
			boolean comp_34_input_text_rendered) {
	...
	public void setCOMP_35_INPUT_TEXT_RENDERED(
			boolean comp_35_input_text_rendered) {
	...
	public void setCOMP_36_INPUT_TEXT_RENDERED(
			boolean comp_36_input_text_rendered) {
	...
	public void setCOMP_37_INPUT_TEXT_RENDERED(
			boolean comp_37_input_text_rendered) {
	...
	public void setCOMP_38_INPUT_TEXT_RENDERED(
			boolean comp_38_input_text_rendered) {
	...
	public void setCOMP_39_INPUT_TEXT_RENDERED(
			boolean comp_39_input_text_rendered) {
	...
	public void setCOMP_40_INPUT_TEXT_RENDERED(
			boolean comp_40_input_text_rendered) {
	...
	public void setCOMP_41_INPUT_TEXT_RENDERED(
			boolean comp_41_input_text_rendered) {
	...
	public void setCOMP_42_INPUT_TEXT_RENDERED(
			boolean comp_42_input_text_rendered) {
	...
	public void setCOMP_43_INPUT_TEXT_RENDERED(
			boolean comp_43_input_text_rendered) {
	...
	public void setCOMP_44_INPUT_TEXT_RENDERED(
			boolean comp_44_input_text_rendered) {
	...
	public void setCOMP_45_INPUT_TEXT_RENDERED(
			boolean comp_45_input_text_rendered) {
	...
	public void setCOMP_46_INPUT_TEXT_RENDERED(
			boolean comp_46_input_text_rendered) {
	...
	public void setCOMP_47_INPUT_TEXT_RENDERED(
			boolean comp_47_input_text_rendered) {
	...
	public void setCOMP_48_INPUT_TEXT_RENDERED(
			boolean comp_48_input_text_rendered) {
	...
	public void setCOMP_49_INPUT_TEXT_RENDERED(
			boolean comp_49_input_text_rendered) {
	...
	public void setCOMP_50_INPUT_TEXT_RENDERED(
			boolean comp_50_input_text_rendered) {
	...
	public void setCOMP_51_INPUT_TEXT_RENDERED(
			boolean comp_51_input_text_rendered) {
	...
	public void setCOMP_52_INPUT_TEXT_RENDERED(
			boolean comp_52_input_text_rendered) {
	...
	public void setCOMP_53_INPUT_TEXT_RENDERED(
			boolean comp_53_input_text_rendered) {
	...
	public void setCOMP_54_INPUT_TEXT_RENDERED(
			boolean comp_54_input_text_rendered) {
	...
	public void setCOMP_55_INPUT_TEXT_RENDERED(
			boolean comp_55_input_text_rendered) {
	...
	public void setCOMP_56_INPUT_TEXT_RENDERED(
			boolean comp_56_input_text_rendered) {
	...
	public void setCOMP_57_INPUT_TEXT_RENDERED(
			boolean comp_57_input_text_rendered) {
	...
	public void setCOMP_58_INPUT_TEXT_RENDERED(
			boolean comp_58_input_text_rendered) {
	...
	public void setCOMP_59_INPUT_TEXT_RENDERED(
			boolean comp_59_input_text_rendered) {
	...
	public void setCOMP_60_INPUT_TEXT_RENDERED(
			boolean comp_60_input_text_rendered) {
	...
	public void setCOMP_2_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_2_select_one_menu) {
	...
	public void setCOMP_3_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_3_select_one_menu) {
	...
	public void setCOMP_4_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_4_select_one_menu) {
	...
	public void setCOMP_5_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_5_select_one_menu) {
	...
	public void setCOMP_6_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_6_select_one_menu) {
	...
	public void setCOMP_7_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_7_select_one_menu) {
	...
	public void setCOMP_8_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_8_select_one_menu) {
	...
	public void setCOMP_9_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_9_select_one_menu) {
	...
	public void setCOMP_10_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_10_select_one_menu) {
	...
	public void setCOMP_11_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_11_select_one_menu) {
	...
	public void setCOMP_12_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_12_select_one_menu) {
	...
	public void setCOMP_13_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_13_select_one_menu) {
	...
	public void setCOMP_14_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_14_select_one_menu) {
	...
	public void setCOMP_15_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_15_select_one_menu) {
	...
	public void setCOMP_16_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_16_select_one_menu) {
	...
	public void setCOMP_17_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_17_select_one_menu) {
	...
	public void setCOMP_18_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_18_select_one_menu) {
	...
	public void setCOMP_19_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_19_select_one_menu) {
	...
	public void setCOMP_20_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_20_select_one_menu) {
	...
	public void setCOMP_21_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_21_select_one_menu) {
	...
	public void setCOMP_22_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_22_select_one_menu) {
	...
	public void setCOMP_23_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_23_select_one_menu) {
	...
	public void setCOMP_24_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_24_select_one_menu) {
	...
	public void setCOMP_25_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_25_select_one_menu) {
	...
	public void setCOMP_26_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_26_select_one_menu) {
	...
	public void setCOMP_27_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_27_select_one_menu) {
	...
	public void setCOMP_28_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_28_select_one_menu) {
	...
	public void setCOMP_29_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_29_select_one_menu) {
	...
	public void setCOMP_30_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_30_select_one_menu) {
	...
	public void setCOMP_31_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_31_select_one_menu) {
	...
	public void setCOMP_32_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_32_select_one_menu) {
	...
	public void setCOMP_33_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_33_select_one_menu) {
	...
	public void setCOMP_34_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_34_select_one_menu) {
	...
	public void setCOMP_35_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_35_select_one_menu) {
	...
	public void setCOMP_36_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_36_select_one_menu) {
	...
	public void setCOMP_37_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_37_select_one_menu) {
	...
	public void setCOMP_38_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_38_select_one_menu) {
	...
	public void setCOMP_39_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_39_select_one_menu) {
	...
	public void setCOMP_40_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_40_select_one_menu) {
	...
	public void setCOMP_41_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_41_select_one_menu) {
	...
	public void setCOMP_42_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_42_select_one_menu) {
	...
	public void setCOMP_43_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_43_select_one_menu) {
	...
	public void setCOMP_44_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_44_select_one_menu) {
	...
	public void setCOMP_45_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_45_select_one_menu) {
	...
	public void setCOMP_46_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_46_select_one_menu) {
	...
	public void setCOMP_47_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_47_select_one_menu) {
	...
	public void setCOMP_48_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_48_select_one_menu) {
	...
	public void setCOMP_49_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_49_select_one_menu) {
	...
	public void setCOMP_50_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_50_select_one_menu) {
	...
	public void setCOMP_51_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_51_select_one_menu) {
	...
	public void setCOMP_52_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_52_select_one_menu) {
	...
	public void setCOMP_53_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_53_select_one_menu) {
	...
	public void setCOMP_54_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_54_select_one_menu) {
	...
	public void setCOMP_55_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_55_select_one_menu) {
	...
	public void setCOMP_56_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_56_select_one_menu) {
	...
	public void setCOMP_57_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_57_select_one_menu) {
	...
	public void setCOMP_58_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_58_select_one_menu) {
	...
	public void setCOMP_59_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_59_select_one_menu) {
	...
	public void setCOMP_60_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_60_select_one_menu) {
	...
	public void getSelectedFileType(ActionEvent e) {
		HtmlSelectOneRadio input = (HtmlSelectOneRadio) e.getComponent()
				.getParent();
	...
	private List<SelectItem> itemM_FIN_QTR = new ArrayList<SelectItem>();
	...
	/*
	 * public String runAction() { CommonUtils.clearMaps(this); String
	 * redirectUrl = null; HttpServletResponse response=null; String
	 * moduleCode=CommonUtils.getGlobalVariable("GLOBAL.M_MODULE_CODE"); Map<String,
	 * String> parameterMap=new HashMap<String, String>(); try { if
	 * (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
	 * 
	 * response = (HttpServletResponse)
	 * FacesContext.getCurrentInstance().getExternalContext().getResponse();
	 * 
	 * parameterMap.put("P_FM_DATE",new
	 * ReportUtils().changeDatetoString(IP_REP_INFO_BEAN.getUI_M_FM_DT(),PELConstants.pelDateFormat));
	 * parameterMap.put("P_TO_DATE",new
	 * ReportUtils().changeDatetoString(IP_REP_INFO_BEAN.getUI_M_TO_DT(),PELConstants.pelDateFormat));
	 ...
	 * parameterMap.put("P_FM_BANK_CODE",IP_REP_INFO_BEAN.getUI_M_FM_BANK_CODE());
	 * parameterMap.put("P_TO_BANK_CODE",IP_REP_INFO_BEAN.getUI_M_TO_BANK_CODE());
	 * 
	 * redirectUrl = ReportUtils.getReportRedirectString("PBR016", moduleCode,
	 * IP_REP_INFO_BEAN.getSelectedFileType(), parameterMap);
	 * response.sendRedirect(redirectUrl); } } catch (IOException e) {
	 * e.printStackTrace(); } return redirectUrl; }
	 */
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_DIVN_FM", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_DIVN_TO", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_DEPT_FM", IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
				map.put("P_DEPT_TO", IP_REP_INFO_BEAN.getUI_M_TO_DEPT_CODE());
				map.put("P_SRC_FM", IP_REP_INFO_BEAN.getUI_M_CLASS_FM());
				map.put("P_SRC_TO", IP_REP_INFO_BEAN.getUI_M_CLASS_TO());
				map.put("P_CUST_FM", IP_REP_INFO_BEAN.getUI_M_USER_ID_FM());
				map.put("P_CUST_TO", IP_REP_INFO_BEAN.getUI_M_USER_ID_TO());
				map.put("P_BRK_FM", IP_REP_INFO_BEAN.getUI_M_BANK_FM());
				map.put("P_BRK_TO", IP_REP_INFO_BEAN.getUI_M_BANK_TO());
				map.put("P_STST_FM", IP_REP_INFO_BEAN.getUI_M_POL_NO());
				map.put("P_STST_TO", IP_REP_INFO_BEAN.getUI_M_TEMP_RCPT_NO());
				map.put("P_UID_FM", "0");
				map.put("P_UID_TO", "zzzzzz");
				map.put("P_FM_DT", IP_REP_INFO_BEAN.getREP_VALUE_7());
				map.put("P_TO_DT", IP_REP_INFO_BEAN.getREP_VALUE_8());
				map.put("P_M_USER_ID", IP_REP_INFO_BEAN.getREP_CR_UID());
				map.put("P_COMP_CODE", IP_REP_INFO_BEAN.getREP_VALUE_20());
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {

		PILR184_APAC_HELPER helper = new PILR184_APAC_HELPER();
	...
	public void whenValidateUI_FM_DIVN_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();

		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_FM_DIVN_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_DIVN_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE(input.getValue()
						.toString());
			}
		}
	...
	public void validateUI_FM_DIVN_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		String uiDivnFmCode = (String) value;
		try {
			if (!"*".equals(uiDivnFmCode)) {
				String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_DIVN_CODE(
						uiDivnFmCode, IP_REP_INFO_BEAN);
				IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(divnCodeName);
			}
			COMP_1_INPUT_TEXT_DESC.resetValue();
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR184_APAC_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR184_APAC_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}

	public void whenValidateUI_TO_DIVN_CODE(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if (input.getSubmittedValue() == null
				|| input.getSubmittedValue().toString().isEmpty()) {
			if (IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE())) {
					this.IP_REP_INFO_BEAN
							.setUI_TO_DIVN_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_DIVN_DESC(null);
				} else {
					this.IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(IP_REP_INFO_BEAN
							.getUI_FM_DIVN_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DIVN_DESC(IP_REP_INFO_BEAN
							.getUI_M_FM_DIVN_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(input.getValue()
						.toString());
			}
		}
	...
	public void validateUI_TO_DIVN_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiDivnToCode = (String) value;
		try {
			String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_DIVN_CODE(
					uiDivnToCode, IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_FM_DIVN_DESC(divnCodeName);
			COMP_2_INPUT_TEXT_DESC.resetValue();
	...
	public List<LovBean> lovUI_M_DEPARTMENT(Object value) {
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(),
						PELConstants.suggetionRecordSize };
				query = PILR184_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getREP_VALUE_1(),
						IP_REP_INFO_BEAN.getREP_VALUE_2(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR184_APAC_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		String code = (String) value;
		List<LovBean> suggestionList = null;
		Object[] object = {};
		String query = null;
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR184_APAC_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR184_APAC_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}

	public List<LovBean> lovStsCode(Object value) {
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR001", "REP_PARAM", "M_POL_NO",
					"GL_ADDL_STAT", "2", null, null, null, (String) value);
		} catch (Exception e) {
	...
	public List<LovBean> lovUI_M_BANK(Object value) {
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR001", "REP_PARAM",
					"M_FM_BANK_CODE", "006", null, null, null, null,
					(String) value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
					e.getMessage());
	...
	public void whenValidateUI_M_FM_DEPT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_FM_DEPT_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_DEPT_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_DEPT_CODE(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_CLASS_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_CLASS_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_CLASS_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_CLASS_FM(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_CLASS_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		...
		if (input.getSubmittedValue() == null
				|| input.getSubmittedValue().toString().isEmpty()) {
			if (IP_REP_INFO_BEAN.getUI_M_CLASS_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_CLASS_FM())) {
					this.IP_REP_INFO_BEAN
							.setUI_M_CLASS_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_CLASS_TO_DESC(null);
				} else {
					this.IP_REP_INFO_BEAN.setUI_M_CLASS_TO(IP_REP_INFO_BEAN
							.getUI_FM_DIVN_CODE());
					this.IP_REP_INFO_BEAN
							.setUI_M_CLASS_TO_DESC(IP_REP_INFO_BEAN
									.getUI_M_FM_DIVN_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_CLASS_TO(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_USER_ID_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_USER_ID_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_USER_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_USER_ID_FM(input.getValue()
						.toString());
			}
		}
		COMP_9_INPUT_TEXT.resetValue();
		COMP_9_INPUT_TEXT_DESC.resetValue();
	}

	public void whenValidateUI_M_USER_ID_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if (input.getSubmittedValue() == null
				|| input.getSubmittedValue().toString().isEmpty()) {
			if (IP_REP_INFO_BEAN.getUI_M_USER_ID_FM() != null) {
				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_USER_ID_FM())) {
					this.IP_REP_INFO_BEAN
							.setUI_M_USER_ID_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_USER_TO_DESC(null);
				} else {
					this.IP_REP_INFO_BEAN.setUI_M_USER_ID_TO(IP_REP_INFO_BEAN
							.getUI_M_USER_FM_DESC());
					this.IP_REP_INFO_BEAN.setUI_M_USER_TO_DESC(IP_REP_INFO_BEAN
							.getUI_M_USER_TO_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_USER_ID_TO(input.getValue()
						.toString());
			}
		}
		COMP_10_INPUT_TEXT.resetValue();
		COMP_10_INPUT_TEXT_DESC.resetValue();
	}

	public void validateUI_M_FM_DEPT_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiDeptFmCode = (String) value;
		try {
			/*
			 * If the branch code is zero it will not validate the dept
			 * code.because for zero record there is no any dept code
			 */
			if (!REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
					.equals(IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE())) {
				String DEPTuctName = helper.WHEN_VALIDATE_ITEM_UI_M_DEPT_CODE(
						uiDeptFmCode, IP_REP_INFO_BEAN);
				IP_REP_INFO_BEAN.setUI_M_FM_DEPT_DESC(DEPTuctName);
				COMP_3_INPUT_TEXT_DESC.resetValue();
			}
	...
	public void whenValidateUI_M_TO_DEPT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_TO_DEPT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_DEPT_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(IP_REP_INFO_BEAN
							.getUI_M_FM_DEPT_CODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_DESC(IP_REP_INFO_BEAN
							.getUI_M_FM_DEPT_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(submittedValue);
	...
	public void whenValidateUI_M_BANK_FM(ActionEvent actionEvent) {
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_BANK_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_BANK_DESC_FM(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_BANK_FM(input.getValue()
						.toString());
			}
		}

		COMP_11_INPUT_TEXT.resetValue();
		COMP_11_INPUT_TEXT_DESC.resetValue();
	}

	public void whenValidateUI_M_BANK_TO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_BANK_FM() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_BANK_FM())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_BANK_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_BANK_DESC_TO(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_BANK_TO(IP_REP_INFO_BEAN
							.getUI_M_BANK_TO());
					this.IP_REP_INFO_BEAN.setUI_M_BANK_DESC_TO(IP_REP_INFO_BEAN
							.getUI_M_BANK_DESC_TO());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_BANK_TO(submittedValue);

			// }
		}
		COMP_12_INPUT_TEXT.resetValue();
		COMP_12_INPUT_TEXT_DESC.resetValue();
	}

	public void validateUI_M_TO_DEPT_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiDivnToCode = (String) value;
		try {

			String DEPTName = helper.WHEN_VALIDATE_ITEM_UI_M_DEPT_CODE(
					uiDivnToCode, IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_TO_DEPT_DESC(DEPTName);
			COMP_4_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_CLASS_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiCLASS = (String) value;
		try {

			String classCode = helper.WHEN_VALIDATE_ITEM_UI_M_CLASS(uiCLASS,
					IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CLASS_FM_DESC(classCode);
			COMP_7_INPUT_TEXT_DESC.resetValue();
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_CLASS_FM", getWarningMap());
	...
	public void validateUI_M_CLASS_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			String classCode = helper.WHEN_VALIDATE_ITEM_UI_M_CLASS(uiCLASS,
					IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_CLASS_TO_DESC(classCode);
			COMP_8_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_USER_ID_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiCust_Code = (String) value;
		try {

			String custName = helper.WHEN_VALIDATE_ITEM_UI_M_USER_ID_FM(
					uiCust_Code, IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_USER_FM_DESC(custName);
			COMP_9_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_USER_ID_TO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String custCode = (String) value;
		try {

			String custName = helper.WHEN_VALIDATE_ITEM_UI_M_USER_ID_FM(
					custCode, IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_USER_FM_DESC(custName);
			COMP_10_INPUT_TEXT_DESC.resetValue();
	...
	public List<LovBean> lovUI_M_USER_ID(Object obj) {
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object = {};
		String query = null;
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR184_APAC_QUERY_CONSTANTS.USER_ID_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR184_APAC_QUERY_CONSTANTS.USER_ID_QUERY_LIKE;
		}
	...
	public void setCOMP_SELECT_POL_STATUS(
			HtmlSelectOneRadio comp_select_pol_status) {
	...
	public void setCOMP_SELECT_CUST_TYPE(
			HtmlSelectOneRadio comp_select_cust_type) {
	...
	public HtmlInputText getCOMP_15_INPUT_TEXT_DESC() {
		return COMP_15_INPUT_TEXT_DESC;
	}

	public void setCOMP_15_INPUT_TEXT_DESC(HtmlInputText comp_15_input_text_desc) {
		COMP_15_INPUT_TEXT_DESC = comp_15_input_text_desc;
	}

	public HtmlInputText getCOMP_16_INPUT_TEXT_DESC() {
		return COMP_16_INPUT_TEXT_DESC;
	}

	public void setCOMP_16_INPUT_TEXT_DESC(HtmlInputText comp_16_input_text_desc) {
		COMP_16_INPUT_TEXT_DESC = comp_16_input_text_desc;
	}

	public void prepareDropDownListM_INSTR_FM() {
		Connection connection;
		try {
			connection = CommonUtils.getConnection();
			listM_INSTR_FM = new ArrayList<SelectItem>();
			listM_INSTR_FM = ListItemUtil.getDropDownListValue(connection,
					"PILR001", "REP_PARAM", "REP_PARAM.M_INSTR_FM",
					"IL_PAY_MODE");
	...
	public void prepareDropDownListM_INSTR_TO() {
		Connection connection;
		try {
			connection = CommonUtils.getConnection();
			listM_INSTR_TO = new ArrayList<SelectItem>();
			listM_INSTR_TO = ListItemUtil.getDropDownListValue(connection,
					"PILR001", "REP_PARAM", "REP_PARAM.M_INSTR_TO",
					"IL_PAY_MODE");
	...
	public void prepareDropDownListM_DEPT_TO() {
		Connection connection;
		try {
			connection = CommonUtils.getConnection();
			listM_INSTR_TO = new ArrayList<SelectItem>();
	...
	public List<SelectItem> getListM_INSTR_FM() {
		prepareDropDownListM_INSTR_FM();
		return listM_INSTR_FM;
	}

	public void setListM_INSTR_FM(List<SelectItem> listM_INSTR_FM) {
		this.listM_INSTR_FM = listM_INSTR_FM;

	}

	public List<SelectItem> getListM_INSTR_TO() {
		prepareDropDownListM_INSTR_TO();
		return listM_INSTR_TO;
	}

	public void setListM_INSTR_TO(List<SelectItem> listM_INSTR_TO) {
		this.listM_INSTR_TO = listM_INSTR_TO;
	}
	public List<LovBean> lovUI_M_POL_NO(Object obj){
		String code = (String) obj;
		List<LovBean> suggestionList = null;
		Object[] object={};
		String query=null;
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR184_APAC_QUERY_CONSTANTS.POL_NO ;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR184_APAC_QUERY_CONSTANTS.POL_NO_LIKE;
		}
		suggestionList = delegate.prepareLovListSingleColoumn(query, object);
		return suggestionList;
	}
	
	
	public void validateInstrFm(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setUI_M_INSTR_FM((String)value);
		}catch(Exception e){
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	}
	
	public void validateInstrTo(FacesContext context,UIComponent component ,Object value){
		try{
			IP_REP_INFO_BEAN.setUI_M_INSTR_TO((String)value);
		}catch(Exception e){
			throw new ValidatorException(new FacesMessage(e.getMessage()));
		}
	}
	...
	public void setCOMP_UI_M_FIN_QTR_LABEL(HtmlOutputLabel comp_ui_m_fin_qtr_label) {
		COMP_UI_M_FIN_QTR_LABEL = comp_ui_m_fin_qtr_label;
	}

/*	public HtmlInputText getCOMP_UI_M_FIN_QTR_INPUT_TEXT() {
		return COMP_UI_M_FIN_QTR_INPUT_TEXT;
	}

	public void setCOMP_UI_M_FIN_QTR_INPUT_TEXT(
			HtmlInputText comp_ui_m_fin_qtr_input_text) {
		COMP_UI_M_FIN_QTR_INPUT_TEXT = comp_ui_m_fin_qtr_input_text;
	}
*/
	public HtmlSelectOneMenu getCOMP_UI_M_FIN_QTR_SELECT_ONE_MENU() {
		return COMP_UI_M_FIN_QTR_SELECT_ONE_MENU;
	}

	public void setCOMP_UI_M_FIN_QTR_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_ui_m_fin_qtr_select_one_menu) {
		COMP_UI_M_FIN_QTR_SELECT_ONE_MENU = comp_ui_m_fin_qtr_select_one_menu;
	}

	public boolean isCOMP_UI_M_FIN_QTR_SELECT_ONE_MENU_RENDERED() {
		return COMP_UI_M_FIN_QTR_SELECT_ONE_MENU_RENDERED;
	}

	public void setCOMP_UI_M_FIN_QTR_SELECT_ONE_MENU_RENDERED(
			boolean comp_ui_m_fin_qtr_select_one_menu_rendered) {
		COMP_UI_M_FIN_QTR_SELECT_ONE_MENU_RENDERED = comp_ui_m_fin_qtr_select_one_menu_rendered;
	}

	public List<RI_CLOSING_LOV> getRiCloseLovList() {
		return riCloseLovList;
	}

	public void setRiCloseLovList(List<RI_CLOSING_LOV> riCloseLovList) {
		this.riCloseLovList = riCloseLovList;
	}
	...
	public void setCOMP_UI_M_RD_YEAR_LABEL(HtmlOutputLabel comp_ui_m_rd_year_label) {
		COMP_UI_M_RD_YEAR_LABEL = comp_ui_m_rd_year_label;
	}

/*	public HtmlInputText getCOMP_UI_M_RD_YEAR_INPUT_TEXT() {
		return COMP_UI_M_RD_YEAR_INPUT_TEXT;
	}

	public void setCOMP_UI_M_RD_YEAR_INPUT_TEXT(
			HtmlInputText comp_ui_m_rd_year_input_text) {
		COMP_UI_M_RD_YEAR_INPUT_TEXT = comp_ui_m_rd_year_input_text;
	}
*/
	public HtmlSelectOneMenu getCOMP_UI_M_RD_YEAR_SELECT_ONE_MENU() {
		return COMP_UI_M_RD_YEAR_SELECT_ONE_MENU;
	}

	public void setCOMP_UI_M_RD_YEAR_SELECT_ONE_MENU(
			HtmlSelectOneMenu comp_ui_m_rd_year_select_one_menu) {
		COMP_UI_M_RD_YEAR_SELECT_ONE_MENU = comp_ui_m_rd_year_select_one_menu;
	}

	public boolean isCOMP_UI_M_RD_YEAR_SELECT_ONE_MENU_RENDERED() {
		return COMP_UI_M_RD_YEAR_SELECT_ONE_MENU_RENDERED;
	}

	public void setCOMP_UI_M_RD_YEAR_SELECT_ONE_MENU_RENDERED(
			boolean comp_ui_m_rd_year_select_one_menu_rendered) {
		COMP_UI_M_RD_YEAR_SELECT_ONE_MENU_RENDERED = comp_ui_m_rd_year_select_one_menu_rendered;
	}

	public PILR184_APAC_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR184_APAC_HELPER helper) {
		this.helper = helper;
	}

	public PILR184_APAC_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR184_APAC_DELEGATE delegate) {
	...
	public HtmlInputText getCOMP_UI_M_FIN_QTR() {
		return COMP_UI_M_FIN_QTR;
	}

	public void setCOMP_UI_M_FIN_QTR(HtmlInputText comp_ui_m_fin_qtr) {
		COMP_UI_M_FIN_QTR = comp_ui_m_fin_qtr;
	}

	public HtmlInputText getCOMP_UI_M_RD_YEAR() {
		return COMP_UI_M_RD_YEAR;
	}

	public void setCOMP_UI_M_RD_YEAR(HtmlInputText comp_ui_m_rd_year) {
		COMP_UI_M_RD_YEAR = comp_ui_m_rd_year;
	}
