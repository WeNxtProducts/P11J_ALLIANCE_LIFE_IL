...
public interface IP_REP_INFO_SQL_QUERY_CONSTANTS {
	...
	final String VALIDATE_POLICY_NO_LOV = "SELECT 1 FROM PT_IL_POLICY WHERE POL_NO = ?";
	
	final String POL_SYS_ID_QUERY = "SELECT POL_SYS_ID FROM PT_IL_POLICY WHERE POL_NO = ?";
