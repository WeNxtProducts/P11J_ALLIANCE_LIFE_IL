...
public class IP_REP_INFO_DELEGATE {
	...
	public List preparePolicyCodeList(String policyCode, List policyList) {

		String query = null;
		if ("*".equalsIgnoreCase(policyCode)) {
			query = IP_REP_INFO_SQL_QUERY_CONSTANTS.IP_REP_INFO_POLICY_NO_LOV;
				...
				policyList = policyCodeLOV(query,object);

		} else {
			policyCode=policyCode+IP_REP_INFO_CONSTANTS.IP_REP_INFO_PERCENTILE_FOR_SELECT_LIKE;
				System.out.println("fromDivnCode :"+policyCode);
				Object[] object={policyCode,IP_REP_INFO_CONSTANTS.IP_REP_INFO_ROW_NUM_TO_DIPLAY_LESS_THEN};
	...
	public List<IP_REP_INFO> policyCodeLOV(String query,Object[] object)
	{
	List<IP_REP_INFO> policyList = new ArrayList<IP_REP_INFO>();
	...
	ResultSet resultSet = null;
		...
		try
		{
			...
			while(resultSet.next())
			{
				...
				ip_rep_info.setREP_VALUE_1(resultSet.getString(1));
				System.out.println("ip_rep_info :"+ip_rep_info.getREP_VALUE_1());
				ip_rep_info.setUI_M_POLICY_NO_DESC(resultSet.getString(2));
				policyList.add(ip_rep_info);
