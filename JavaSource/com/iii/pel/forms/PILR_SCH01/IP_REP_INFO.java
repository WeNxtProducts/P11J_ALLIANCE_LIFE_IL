...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_POLICY_NO_DESC;
	
	private String UI_M_TO_POLICY_NO_DESC;
	
	private String POL_SYS_ID;
	
	private String targetValue = null;

	private boolean UI_BUT_MAIN_REND;
	...
	public String getREP_VALUE_1() {
		...
		try {
			REP_VALUE_1=format.parse(dateString);
	...
	public void setREP_VALUE_1(String rep_value_1) {
		...
		System.out.println("Date REP_VALUE_1 :"+REP_VALUE_1);*/
	...
	public String getREP_VALUE_2() {
		...
		System.out.println("Date String :"+dateString);
		try {
			REP_VALUE_2=format.parse(dateString);
		} catch (ParseException e) {
	...
	public String getUI_M_POLICY_NO_DESC() {
		return UI_M_POLICY_NO_DESC;
	}

	public void setUI_M_POLICY_NO_DESC(String UI_M_POLICY_NO_DESC) {
		this.UI_M_POLICY_NO_DESC = UI_M_POLICY_NO_DESC;
	}

	public String getUI_M_TO_POLICY_NO_DESC() {
		return UI_M_TO_POLICY_NO_DESC;
	}

	public void setUI_M_TO_POLICY_NO_DESC(String ui_m_to_policy_no_desc) {
		UI_M_TO_POLICY_NO_DESC = ui_m_to_policy_no_desc;
	}
	...
	public boolean isUI_BUT_MAIN_REND() {
		return UI_BUT_MAIN_REND;
	}

	public void setUI_BUT_MAIN_REND(boolean ui_but_main_rend) {
		UI_BUT_MAIN_REND = ui_but_main_rend;
	}   
