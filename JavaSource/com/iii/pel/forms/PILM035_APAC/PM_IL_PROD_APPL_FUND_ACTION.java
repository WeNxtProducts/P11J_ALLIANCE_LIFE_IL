...
public class PM_IL_PROD_APPL_FUND_ACTION extends CommonAction {
	...
	private PM_IL_PROD_APPL_FUND PM_IL_PROD_APPL_FUND_BEAN;

	public PILM035_APAC_COMPOSITE_ACTION compositeAction;

	private PM_IL_PROD_APPL_FUND_HELPER helper;

	private List<PM_IL_PROD_APPL_FUND> dataList_PM_IL_PROD_APPL_FUND = new ArrayList<PM_IL_PROD_APPL_FUND>();

	private UIData dataTable;
	
	private Double percTotal=0.0;

	private List<SelectItem> listPAF_DEFAULT_YN = new ArrayList<SelectItem>();

	public PM_IL_PROD_APPL_FUND_ACTION() {

		PM_IL_PROD_APPL_FUND_BEAN = new PM_IL_PROD_APPL_FUND();
		helper = new PM_IL_PROD_APPL_FUND_HELPER();
		prepareDropDowns();
	}
	...
	public PM_IL_PROD_APPL_FUND getPM_IL_PROD_APPL_FUND_BEAN() {
		return PM_IL_PROD_APPL_FUND_BEAN;
	}

	public void setPM_IL_PROD_APPL_FUND_BEAN(
			PM_IL_PROD_APPL_FUND PM_IL_PROD_APPL_FUND_BEAN) {
		this.PM_IL_PROD_APPL_FUND_BEAN = PM_IL_PROD_APPL_FUND_BEAN;
	}

	public List<PM_IL_PROD_APPL_FUND> getDataList_PM_IL_PROD_APPL_FUND() {
		return dataList_PM_IL_PROD_APPL_FUND;
	}

	public void setDataListPM_IL_PROD_APPL_FUND(
			List<PM_IL_PROD_APPL_FUND> dataList_PM_IL_PROD_APPL_FUND) {
		this.dataList_PM_IL_PROD_APPL_FUND = dataList_PM_IL_PROD_APPL_FUND;
	}
	...
	public void deleteRow(ActionEvent event) {
		try {
			if (isDELETE_ALLOWED()) {
				new CRUDHandler().executeDelete(PM_IL_PROD_APPL_FUND_BEAN,
				...
				getWarningMap().put(
						...
						Messages.getString(
								PELConstants.pelMessagePropertiesPath,
								"errorPanel$message$delete"));
				dataList_PM_IL_PROD_APPL_FUND.remove(PM_IL_PROD_APPL_FUND_BEAN);
				if (dataList_PM_IL_PROD_APPL_FUND.size() > 0) {

					PM_IL_PROD_APPL_FUND_BEAN = dataList_PM_IL_PROD_APPL_FUND
							.get(0);
				} else if (dataList_PM_IL_PROD_APPL_FUND.size() == 0) {
					PM_IL_PROD_APPL_FUND_BEAN=new PM_IL_PROD_APPL_FUND();
					addRow(null);
				}
				resetAllComponent();
	...
	public void postRecord(ActionEvent event) {
		try {
			if (PM_IL_PROD_APPL_FUND_BEAN.getROWID() == null
				...
				new CRUDHandler().executeInsert(PM_IL_PROD_APPL_FUND_BEAN,
						CommonUtils.getConnection());
				getWarningMap().put(
						PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
						Messages.getString(
				...
				dataList_PM_IL_PROD_APPL_FUND.add(PM_IL_PROD_APPL_FUND_BEAN);
			} else if (PM_IL_PROD_APPL_FUND_BEAN.getROWID() != null
					&& isUPDATE_ALLOWED()) {
				helper.PRE_UPDATE(compositeAction);
				new CRUDHandler().executeUpdate(PM_IL_PROD_APPL_FUND_BEAN,
						CommonUtils.getConnection());
				getWarningMap().put(
						PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
						Messages.getString(
			...
			totalPerc();
			/* NEWLY ADDED BY SUJATHA FOR FUND PERC VALIDATION */
			if(percTotal > 100){
	...
	public void displayRecords() {
		...
		try {
			resetSelectedRow();
			PM_IL_PROD_APPL_FUND_BEAN = (PM_IL_PROD_APPL_FUND) dataTable
					.getRowData();
			PM_IL_PROD_APPL_FUND_BEAN.setRowSelected(true);
	...
	private void resetSelectedRow() {
		Iterator<PM_IL_PROD_APPL_FUND> PM_IL_PROD_APPL_FUND_ITR = dataList_PM_IL_PROD_APPL_FUND
				.iterator();
		while (PM_IL_PROD_APPL_FUND_ITR.hasNext()) {
			PM_IL_PROD_APPL_FUND_ITR.next().setRowSelected(false);
		}
	}
	...
	public void PAF_FUND_CODE_Validator(FacesContext context,
		...
		try {
			PM_IL_PROD_APPL_FUND_BEAN.setPAF_FUND_CODE((String) value);
	...
	public void PAF_FUND_PERC_Validator(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		try {
			PM_IL_PROD_APPL_FUND_BEAN.setPAF_FUND_PERC((Double) value);
	...
	public void PAF_DEFAULT_YN_Validator(FacesContext context,
			UIComponent component, Object value) throws ValidatorException {
		try {
			PM_IL_PROD_APPL_FUND_BEAN.setPAF_DEFAULT_YN((String) value);
	...
	public void onLoad(PhaseEvent event) {
		try {
			if (isBlockFlag()) {
				...
				if(getPM_IL_PROD_APPL_FUND_BEAN().getROWID() != null){
					helper.POST_QUERY(compositeAction);
					totalPerc();
				}
	...
	public List<LovBean> lovPAF_FUND_CODE(Object currValue) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILM035_APAC",
					"PM_IL_PROD_APPL_FUND", "PAF_FUND_CODE", null, null, null, null,
	...
	private void totalPerc(){
		Double uItotal = 0.0;
		for(PM_IL_PROD_APPL_FUND PM_IL_PROD_APPL_FUND_BEAN : dataList_PM_IL_PROD_APPL_FUND){
			uItotal = uItotal + PM_IL_PROD_APPL_FUND_BEAN.getPAF_FUND_PERC();
		}
		setPercTotal(uItotal);
	}
	
	
	public String goDetail(){
		compositeAction.getPM_IL_PROD_APPL_FUND_1_ACTION_BEAN().setBlockFlag(true);
