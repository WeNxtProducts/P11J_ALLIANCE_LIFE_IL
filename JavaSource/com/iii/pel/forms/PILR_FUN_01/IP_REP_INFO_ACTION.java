...
public class IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	private HtmlOutputLabel COMP_TO_DATE_LABEL;
	private HtmlCalendar COMP_TO_DATE;
	...
	public String runAction() {
		...
		try
		{
			IP_REP_INFO_BEAN.setREP_VALUE_61(CommonUtils
			...
			//new PILR_FUN_01_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_PROCESS_DATE_FM", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getFROM_DATE()));
				map.put("P_PROCESS_DATE_TO", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getTO_DATE()));
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 //PILR_FUN_01_HELPER helper=new PILR_FUN_01_HELPER();
		 try{
			 if(isFormFlag()){
	...
	//				preparePolicyStatusList();
				// prepareDropDownList();
				 ...
				 IP_REP_INFO_BEAN.setFROM_DATE(new CommonUtils().getCurrentDate());
				 IP_REP_INFO_BEAN.setTO_DATE(getDefaultToDate());
	...
	public List<LovBean> lovAgentCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR_FUN_01", "REP_PARAM", "M_AGENT_FM", 
	...
	public List<LovBean> lovSrcBus(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR_FUN_01", "REP_PARAM", "M_SRC_BUS_FM", 
	...
	public HtmlOutputLabel getCOMP_TO_DATE_LABEL() {
		return COMP_TO_DATE_LABEL;
	}

	public void setCOMP_TO_DATE_LABEL(HtmlOutputLabel comp_to_date_label) {
		COMP_TO_DATE_LABEL = comp_to_date_label;
	}

	public HtmlCalendar getCOMP_TO_DATE() {
		return COMP_TO_DATE;
	}

	public void setCOMP_TO_DATE(HtmlCalendar comp_to_date) {
		COMP_TO_DATE = comp_to_date;
	}
