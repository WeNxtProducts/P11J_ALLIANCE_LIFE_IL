...
public class PILP100_APAC_COMPOSITE_ACTION{
	...
	public String callCTRL(){
		preTabClick();
		return "PGLP100_APAC_CTRL";
		
	}
	public String callBP(){
		preTabClick();
		return "PGLP100_APAC_BP";
		
	}
	public String callDUMMY1(){
		preTabClick();
		return "PGLP100_APAC_DUMMY1";
	...
	private void preTabClick(){
		...
		switch(currentTabId){
			case 1 :CTRL_ACTION_BEAN.setBlockFlag(true);
			setImmediate(false);
			break;
			case 2 :BP_ACTION_BEAN.setBlockFlag(true);
			setImmediate(false);
			break;
			case 3 :DUMMY_ACTION_BEAN.setBlockFlag(true);
			setImmediate(false);
			break;
	...
	public void setDUMMY_ACTION_BEAN(DUMMY_ACTION DUMMY_ACTION_BEAN){
		this.DUMMY_ACTION_BEAN=DUMMY_ACTION_BEAN;
	...
	public PILP100_APAC_COMPOSITE_ACTION(){
		...
		try{
			tabbedBar.addTab(TAB_CTRL, "#{PGLP100_APAC_COMPOSITE_ACTION.callCTRL}", Messages.getString("messageProperties_PGLP100_APAC", "PGLP100_APAC$CTRL$displayCaption"), false);
			tabbedBar.addTab(TAB_BP, "#{PGLP100_APAC_COMPOSITE_ACTION.callBP}", Messages.getString("messageProperties_PGLP100_APAC", "PGLP100_APAC$BP$displayCaption"), false);
			tabbedBar.addTab(TAB_DUMMY1, "#{PGLP100_APAC_COMPOSITE_ACTION.callDUMMY1}", Messages.getString("messageProperties_PGLP100_APAC", "PGLP100_APAC$DUMMY1$displayCaption"), false);
