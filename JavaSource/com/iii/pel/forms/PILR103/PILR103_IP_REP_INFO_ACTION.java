...
public class PILR103_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR103_HELPER helper;
	PILR103_DELEGATE delegate;
	
	private List<SelectItem> listM_FM_STATUS;
	
	public PILR103_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR103_HELPER();
		delegate=new PILR103_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_FM_STATUS = ListItemUtil.getDropDownListValue(connection, "PGLR035_012", 
					"REP_PARAM", "REP_PARAM.M_FM_STATUS", "RSTM01");
	...
	public String runAction() {
		...
		try
		{
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				new PILR103_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent) throws Exception{
		 ...
		 PILR103_HELPER helper=new PILR103_HELPER();
