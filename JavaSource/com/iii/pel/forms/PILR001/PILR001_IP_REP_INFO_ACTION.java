package com.iii.pel.forms.PILR001;
...
public class PILR001_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR001_HELPER helper;
	PILR001_DELEGATE delegate;

	private List<SelectItem> listM_INSTR_FM;
	private List<SelectItem> listM_INSTR_TO;

	public PILR001_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR001_HELPER();
		delegate = new PILR001_DELEGATE();
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				new PILR001_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_PR_DIVN_FM_CODE", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_PR_DIVN_TO_CODE", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_PR_DEPT_FM_CODE", IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
				map.put("P_PR_DEPT_TO_CODE", IP_REP_INFO_BEAN.getUI_M_TO_DEPT_CODE());
				map.put("P_FM_USER_ID", IP_REP_INFO_BEAN.getUI_M_USER_ID_FM());
				map.put("P_TO_USER_ID", IP_REP_INFO_BEAN.getUI_M_USER_ID_TO());
				map.put("P_POL_NO", IP_REP_INFO_BEAN.getUI_M_POL_NO());
				map.put("P_FM_BANK_CODE", IP_REP_INFO_BEAN.getUI_M_BANK_FM());
				map.put("P_TO_BANK_CODE", IP_REP_INFO_BEAN.getUI_M_BANK_TO());
				map.put("P_FM_CLASS_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_FM());
				map.put("P_TO_CLASS_CODE", IP_REP_INFO_BEAN.getUI_M_CLASS_TO());
				map.put("P_TEMP_RCPT_NO", IP_REP_INFO_BEAN.getUI_M_TEMP_RCPT_NO());
				//map.put("P_UID_FM", "0");
				//map.put("P_UID_TO", "zzzzzz");
				map.put("P_INSTR_FM", IP_REP_INFO_BEAN.getUI_M_INSTR_FM());
				map.put("P_INSTR_TO", IP_REP_INFO_BEAN.getUI_M_INSTR_TO());
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR001_HELPER helper = new PILR001_HELPER();
	...
	public void validateUI_FM_DIVN_CODE(FacesContext facesContext,
		...
		try {
			...
			if (!"*".equals(uiDivnFmCode)) {
				...
				IP_REP_INFO_BEAN.setUI_FM_DIVN_CODE(uiDivnFmCode);
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR001_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR001_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public void validateUI_TO_DIVN_CODE(FacesContext facesContext,
		...
		try {
			...
			if (!"*".equals(uiDivnToCode)) {
				IP_REP_INFO_BEAN.setUI_TO_DIVN_CODE(uiDivnToCode);
			String divnCodeName = helper.WHEN_VALIDATE_ITEM_UI_DIVN_CODE(
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR001_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR001_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_CLASS(Object value) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR001_QUERY_CONSTANTS.CLASS_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR001_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public void validateUI_M_FM_DEPT_CODE(FacesContext facesContext,
		...
		try {
			...
			if (!"*".equals(uiDeptFmCode)) {
				IP_REP_INFO_BEAN.setUI_M_FM_DEPT_CODE(uiDeptFmCode);
	...
	public void validateUI_M_TO_DEPT_CODE(FacesContext facesContext,
		...
		try {
			...
			if (!"*".equals(uiDivnToCode)) {
				IP_REP_INFO_BEAN.setUI_M_TO_DEPT_CODE(uiDivnToCode);
	...
	public List<LovBean> lovUI_M_USER_ID(Object obj) {
		...
		if ("*".equals(code)) {
			object = new Object[] { PELConstants.suggetionRecordSize };
			query = PILR001_QUERY_CONSTANTS.USER_ID_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR001_QUERY_CONSTANTS.USER_ID_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_POL_NO(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR001_QUERY_CONSTANTS.POL_NO ;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR001_QUERY_CONSTANTS.POL_NO_LIKE;
		}
	...
	public void validateUI_M_FM_DT(FacesContext facesContext,
		...
		try {
			...
			if(IP_REP_INFO_BEAN.getUI_M_FM_DT().after(new CommonUtils().getCurrentDate())){
	...
	public void validateUI_M_TO_DT(FacesContext facesContext,
		...
		try {
			IP_REP_INFO_BEAN.setUI_M_TO_DT((Date)value);
			if(IP_REP_INFO_BEAN.getUI_M_TO_DT().after(new CommonUtils().getCurrentDate())){
				throw new Exception (Messages.getString(PELConstants.pelErrorMessagePath, "2181")) ;
			}else if (IP_REP_INFO_BEAN.getUI_M_TO_DT().before(IP_REP_INFO_BEAN.getUI_M_FM_DT())){
