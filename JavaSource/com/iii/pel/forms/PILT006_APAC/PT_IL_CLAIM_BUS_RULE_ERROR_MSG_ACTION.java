...
public class PT_IL_CLAIM_BUS_RULE_ERROR_MSG_ACTION extends CommonAction {
	    ...
	    private PT_IL_CLAIM_BUS_RULE_ERROR_MSG  PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN;

	    public PILT006_APAC_COMPOSITE_ACTION compositeAction;

	    private PT_IL_CLAIM_BUS_RULE_ERROR_MSG_HELPER helper;

	    private List<PT_IL_CLAIM_BUS_RULE_ERROR_MSG> dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG = new ArrayList<PT_IL_CLAIM_BUS_RULE_ERROR_MSG>();
		...
		public PT_IL_CLAIM_BUS_RULE_ERROR_MSG getPT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN() {
			return PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN;
		}

		public void setPT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN(
				PT_IL_CLAIM_BUS_RULE_ERROR_MSG pT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN) {
		...
		public PT_IL_CLAIM_BUS_RULE_ERROR_MSG_HELPER getHelper() {
			return helper;
		}

		public void setHelper(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_HELPER helper) {
			this.helper = helper;
		}

		public List<PT_IL_CLAIM_BUS_RULE_ERROR_MSG> getDataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG() {
			return dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG;
		}

		public void setDataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG(
				List<PT_IL_CLAIM_BUS_RULE_ERROR_MSG> dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG) {
			this.dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG = dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG;
		}

		

	    public PT_IL_CLAIM_BUS_RULE_ERROR_MSG_ACTION() {

	    	PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN = new PT_IL_CLAIM_BUS_RULE_ERROR_MSG();
	    	helper = new PT_IL_CLAIM_BUS_RULE_ERROR_MSG_HELPER();
	    }
		...
		try {
			...
			new CRUDHandler().executeDelete(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN,
			...
			getWarningMap().put(
				...
				Messages.getString(
					PELConstants.pelMessagePropertiesPath,
					"errorPanel$message$delete"));
			dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG
				.remove(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN);
			if (dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG.size() > 0) {

				PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN = dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG
				    .get(0);
			} else if (dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG.size() == 0) {
		...
		try {
		    if (PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN.getROWID() == null
			    && isINSERT_ALLOWED()) {

			new CRUDHandler().executeInsert(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN,
				CommonUtils.getConnection());
			getWarningMap().put(
				PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
				Messages.getString(
			...
			getWarningMap().put(
				...
				Messages.getString(
					PELConstants.pelMessagePropertiesPath,
					"errorPanel$message$save"));
			dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG.add(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN);
		    } else if (PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN.getROWID() != null
			    && isUPDATE_ALLOWED()) {

			new CRUDHandler().executeUpdate(PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN,
				CommonUtils.getConnection());
			getWarningMap().put(
				PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
				Messages.getString(
		...
		try {
		    resetSelectedRow();
		    PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN = (PT_IL_CLAIM_BUS_RULE_ERROR_MSG) dataTable
			    .getRowData();
		    PT_IL_CLAIM_BUS_RULE_ERROR_MSG_BEAN.setRowSelected(true);
		    resetAllComponent();
		} catch (Exception exc) {
		...
		Iterator<PT_IL_CLAIM_BUS_RULE_ERROR_MSG> PT_BUS_RULE_ERROR_MSG_ITR = dataList_PT_IL_CLAIM_BUS_RULE_ERROR_MSG
			.iterator();
