...
public class PT_IL_CLAIM_STATUS_1 extends BaseValueBean {
	...
	private String UI_M_CS_STATUS_CODE_DESC;
	...
	public void setUI_M_CS_STATUS_CODE_DESC(String UI_M_CS_STATUS_CODE_DESC) {
		this.UI_M_CS_STATUS_CODE_DESC = UI_M_CS_STATUS_CODE_DESC;
	}
	public String getUI_M_CS_STATUS_CODE_DESC() {
		 return UI_M_CS_STATUS_CODE_DESC;
	}
	...
	public String getUI_CS_STATUS_DT(){
		return CommonUtils.dateToStringFormatter(CS_STATUS_DT);
	}
