...
public class PILP057_APAC_COMPOSITE_ACTION {
	...
	public String callBP() {
		preTabClick();
		return "PILP057_APAC_BP";

	}

	public String callCTRL() {
		preTabClick();
		return "PILP057_APAC_CTRL";
	...
	public PILP057_APAC_COMPOSITE_ACTION() {
		...
		try {
			tabbedBar.addTab(TAB_BP, "#{PILP057_APAC_COMPOSITE_ACTION.callBP}",
					Messages.getString("messageProperties_PILP057_APAC",
							"PILP057_APAC$BP$displayCaption"), false);
			tabbedBar.addTab(TAB_CTRL,
					"#{PILP057_APAC_COMPOSITE_ACTION.callCTRL}", Messages
							.getString("messageProperties_PILP057_APAC",
									"PILP057_APAC$CTRL$displayCaption"), false);
