...
public class PT_IL_PYMT_DTLS extends BaseValueBean{
	...
	private String UI_PD_ADDR_01_DESC;
	private String UI_PD_ADDR_02_DESC;
	private String UI_PD_ADDR_03_DESC;
	...
	private Double PD_LC_CHARGE=0d;

	@Column(name="PD_FC_CHARGE")
	private Double PD_FC_CHARGE=0d;
	...
	public String getUI_PD_ADDR_01_DESC() {
		return UI_PD_ADDR_01_DESC;
	}

	public void setUI_PD_ADDR_01_DESC(String ui_pd_addr_01_desc) {
		UI_PD_ADDR_01_DESC = ui_pd_addr_01_desc;
	}

	public String getUI_PD_ADDR_02_DESC() {
		return UI_PD_ADDR_02_DESC;
	}

	public void setUI_PD_ADDR_02_DESC(String ui_pd_addr_02_desc) {
		UI_PD_ADDR_02_DESC = ui_pd_addr_02_desc;
	}

	public String getUI_PD_ADDR_03_DESC() {
		return UI_PD_ADDR_03_DESC;
	}

	public void setUI_PD_ADDR_03_DESC(String ui_pd_addr_03_desc) {
		UI_PD_ADDR_03_DESC = ui_pd_addr_03_desc;
	}
	...
	private int PD_CVV_NO;

	
	
	public String getMERCHANT_BANK() {
		return MERCHANT_BANK;
	}

	public void setMERCHANT_BANK(String mERCHANT_BANK) {
