...
public class IP_REP_INFO extends BaseValueBean {
	...
	private String UI_M_FUND_FM;
	private String UI_M_FUND_FM_NAME;
	private String UI_M_FUND_TO;
	private String UI_M_FUND_TO_NAME;
	private String UI_M_TXN_FM;
	private String UI_M_TXN_FM_DESC;
	private String UI_M_TXN_TO;
	...
	public void setUI_M_FUND_FM(String ui_m_pr_divn_fm_code) {
		UI_M_FUND_FM = ui_m_pr_divn_fm_code;
	}

	public String getUI_M_FUND_FM_NAME() {
		return UI_M_FUND_FM_NAME;
	}

	public void setUI_M_FUND_FM_NAME(String ui_m_fm_divn_name) {
		UI_M_FUND_FM_NAME = ui_m_fm_divn_name;
	}

	public String getUI_M_FUND_TO() {
		return UI_M_FUND_TO;
	}

	public void setUI_M_FUND_TO(String ui_m_pr_divn_to_code) {
		UI_M_FUND_TO = ui_m_pr_divn_to_code;
	}

	public String getUI_M_FUND_TO_NAME() {
		return UI_M_FUND_TO_NAME;
	}

	public void setUI_M_FUND_TO_NAME(String ui_m_to_divn_name) {
		UI_M_FUND_TO_NAME = ui_m_to_divn_name;
	}

	public String getUI_M_TXN_FM() {
		return UI_M_TXN_FM;
	}

	public void setUI_M_TXN_FM(String ui_m_dept_fm_code) {
		UI_M_TXN_FM = ui_m_dept_fm_code;
	}
	...
	public void setUI_M_TXN_FM_DESC(String ui_m_dept_fm_name) {
		UI_M_TXN_FM_DESC = ui_m_dept_fm_name;
	}

	public String getUI_M_TXN_TO() {
		return UI_M_TXN_TO;
	}

	public void setUI_M_TXN_TO(String ui_m_dept_to_code) {
		UI_M_TXN_TO = ui_m_dept_to_code;
	}
	...
	public void setUI_M_TXN_TO_DESC(String ui_m_dept_to_desc) {
		UI_M_TXN_TO_DESC = ui_m_dept_to_desc;
	}

	public String getUI_M_FUND_FM() {
		return UI_M_FUND_FM;
	}
