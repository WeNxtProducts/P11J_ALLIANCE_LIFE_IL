...
public class PILR361_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR361_012_HELPER helper;
	PILR361_012_DELEGATE delegate;
	
	private List<SelectItem> listM_MODULE_CODE_FM;
	
	public PILR361_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR361_012_HELPER();
		delegate=new PILR361_012_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listM_MODULE_CODE_FM = ListItemUtil.getDropDownListValue(connection, "PILR361_012", 
...
//				new PGLR039_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				...
				map.put("P_FUND_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FUND_FM());
				map.put("P_FUND_TO_CODE",IP_REP_INFO_BEAN.getUI_M_FUND_TO());
				map.put("P_TXN_FM_CODE",IP_REP_INFO_BEAN.getUI_M_TXN_FM());
				map.put("P_TXN_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TXN_TO());
				map.put("P_POL_FM_CODE",IP_REP_INFO_BEAN.getUI_M_FM_POL_NO());
				map.put("P_POL_TO_CODE",IP_REP_INFO_BEAN.getUI_M_TO_POL_NO());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR361_012_HELPER helper=new PILR361_012_HELPER();
...
//			 IP_REP_INFO_BEAN.setSelectedCustStatus(getCustStatusList().get(0).getValue().toString());
	...
	public void whenValidateUI_M_FUND_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FUND_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FUND_FM_NAME(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FUND_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TXN_FM(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_TXN_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_TXN_FM_DESC(null);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TXN_FM(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_TXN_TO(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_TXN_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_TXN_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_TXN_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TXN_TO_DESC(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TXN_TO(IP_REP_INFO_BEAN.getUI_M_TXN_FM());
					this.IP_REP_INFO_BEAN.setUI_M_TXN_TO_DESC(IP_REP_INFO_BEAN.getUI_M_TXN_FM_DESC());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TXN_TO(input.getValue().toString());
			}
		}
	...
	public void whenValidateUI_M_FM_POL_NO(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		
		if(input.getSubmittedValue()==null || "".equals(input.getSubmittedValue())){
			this.IP_REP_INFO_BEAN.setUI_M_FM_POL_NO(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
		}else{
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_POL_NO(input.getValue().toString());
			}
		}
		COMP_7_INPUT_TEXT.resetValue();
	}
	
	public void whenValidateUI_M_TO_POL_NO(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FM_POL_NO()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FM_POL_NO())){
					this.IP_REP_INFO_BEAN.setUI_M_TO_POL_NO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_TO_POL_NO(IP_REP_INFO_BEAN.getUI_M_FM_POL_NO());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_TO_POL_NO(input.getValue().toString());
			}
		}
		COMP_8_INPUT_TEXT.resetValue();
	}
	public void validateUI_M_FUND_FM(FacesContext facesContext,
		...
		try {
			if(!"*".equals(uiDivnFmCode)){
				...
				IP_REP_INFO_BEAN.setUI_M_FUND_FM_NAME(divnCodeName);
			}
			COMP_1_INPUT_TEXT_DESC.resetValue();
	...
	public void validateUI_M_TXN_FM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			if(!"*".equals(uiDeptFmCode)){
				...
				IP_REP_INFO_BEAN.setUI_M_TXN_FM(deptCodeName);
			}
			COMP_1_INPUT_TEXT_DESC.resetValue();
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR361_012_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR361_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	
	public void whenValidateUI_M_FUND_TO(ActionEvent actionEvent) {
		cancelModalPanel();

		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		if(input.getSubmittedValue()==null || input.getSubmittedValue().toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_FUND_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_FUND_FM())){
					this.IP_REP_INFO_BEAN.setUI_M_FUND_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_FUND_TO_NAME(null);
				}else{
					this.IP_REP_INFO_BEAN.setUI_M_FUND_TO(IP_REP_INFO_BEAN.getUI_M_FUND_FM());
					this.IP_REP_INFO_BEAN.setUI_M_FUND_TO_NAME(IP_REP_INFO_BEAN.getUI_M_FUND_FM_NAME());
				}
			}
			...
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FUND_TO(input.getValue().toString());
			}
		}
	...
	public List<LovBean> lovFundCode(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_FUND_FM", 
	...
	public List<LovBean> lovTxnType(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_TXN_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_FM_PROD_CODE", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovPolNo(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_FM_POL_NO", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovGranteeCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_GRANTEE_CODE", 
	...
	public List<LovBean> lovGranteeCode1(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR361_012_QUERY_CONSTANTS.CUST_CLASS;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR361_012_QUERY_CONSTANTS.CUST_CLASS_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	public List<LovBean> lovProjectCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR361_012", "REP_PARAM", "M_PROJECT_CODE", 
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR361_012_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR361_012_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
