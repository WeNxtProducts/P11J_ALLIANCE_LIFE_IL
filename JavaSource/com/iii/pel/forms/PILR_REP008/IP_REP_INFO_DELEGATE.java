...
public class IP_REP_INFO_DELEGATE {
	...
	public List prepareFromPolicyCodeList(String fromPolicyCode, List fromPolicyList) {

		String query = null;
		if ("*".equalsIgnoreCase(fromPolicyCode)) {
			query = IP_REP_INFO_SQL_QUERY_CONSTANTS.IP_REP_INFO_POLICY_NO_LOV;
				Object[] object={IP_REP_INFO_CONSTANTS.IP_REP_INFO_ROW_NUM_TO_DIPLAY_LESS_THEN};
				fromPolicyList = fromPolicyCodeLOV(query,object);

		} else {
			fromPolicyCode=fromPolicyCode+IP_REP_INFO_CONSTANTS.IP_REP_INFO_PERCENTILE_FOR_SELECT_LIKE;
				System.out.println("fromDivnCode :"+fromPolicyCode);
				Object[] object={fromPolicyCode,IP_REP_INFO_CONSTANTS.IP_REP_INFO_ROW_NUM_TO_DIPLAY_LESS_THEN};
				query = IP_REP_INFO_SQL_QUERY_CONSTANTS.IP_REP_INFO_POLICY_NO_LOV_LIKE;
				System.out.println("Query :"+query);
				fromPolicyList = fromPolicyCodeLOV(query,object);
		}
	...
	public List<IP_REP_INFO> fromPolicyCodeLOV(String query,Object[] object)
	{
	...
	ResultSet resultSet = null;
		...
		try
		{
			...
			while(resultSet.next())
			{
				...
				System.out.println("ip_rep_info :"+ip_rep_info.getREP_VALUE_3());
				ip_rep_info.setUI_M_FROM_POLICY_NO_DESC(resultSet.getString(2));
	...
	public List prepareToPolicyCodeList(String toClaimCode, List toClaimList) {

		String query = null;
		if ("*".equalsIgnoreCase(toClaimCode)) {
			query = IP_REP_INFO_SQL_QUERY_CONSTANTS.IP_REP_INFO_POLICY_NO_LOV;
				Object[] object={IP_REP_INFO_CONSTANTS.IP_REP_INFO_ROW_NUM_TO_DIPLAY_LESS_THEN};
				toClaimList = toPolicyCodeLOV(query,object);
	...
	public List<IP_REP_INFO> toPolicyCodeLOV(String query,Object[] object)
	{
	List<IP_REP_INFO> fromClaimList = new ArrayList<IP_REP_INFO>();
	CRUDHandler handler = new CRUDHandler();
	ResultSet resultSet = null;
		...
		try
		{
			...
			while(resultSet.next())
			{
				...
				ip_rep_info.setUI_M_TO_POLICY_NO_DESC(resultSet.getString(2));
				fromClaimList.add(ip_rep_info);
