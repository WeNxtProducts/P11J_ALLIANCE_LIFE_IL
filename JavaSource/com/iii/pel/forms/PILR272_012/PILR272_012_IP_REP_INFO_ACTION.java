package com.iii.pel.forms.PILR272_012;
...
public class PILR272_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	private HtmlInputText COMP_17_INPUT_TEXT_DESC;
	private HtmlInputText COMP_18_INPUT_TEXT_DESC;

	PILR272_012_HELPER helper;
	PILR272_012_DELEGATE delegate;

	public PILR272_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR272_012_HELPER();
		delegate = new PILR272_012_DELEGATE();
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_SC_FM_CODE", IP_REP_INFO_BEAN.getUI_M_PROD_FM());
				map.put("P_SC_TO_CODE", IP_REP_INFO_BEAN.getUI_M_PROD_TO());
				map.put("P_FM_AGENT_CODE", IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE());
				map.put("P_TO_AGENT_CODE", IP_REP_INFO_BEAN.getUI_M_TO_AGENT_CODE());
				//map.put("P_FM_CR_UID", IP_REP_INFO_BEAN.getUI_M_USER_FM());
				//map.put("P_TO_CR_UID", IP_REP_INFO_BEAN.getUI_M_USER_TO());
				map.put("P_FM_POL_APPRV_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_APR_DT()));
				map.put("P_TO_POL_APPRV_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_APR_DT()));
				//map.put("P_FM_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_CS_DT()));
				//map.put("P_TO_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_CS_DT()));
				//map.put("P_FM_FUND_TYPE", IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_FM());
				//map.put("P_TO_FUND_TYPE", IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_TO());
				map.put("P_FM_PAYMENT_MODE", IP_REP_INFO_BEAN.getUI_M_FM_PYMT_MODE());
				map.put("P_TO_PAYMENT_MODE", IP_REP_INFO_BEAN.getUI_M_TO_PYMT_MODE());
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR272_012_HELPER helper = new PILR272_012_HELPER();
	...
	public PILR272_012_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR272_012_HELPER helper) {
		this.helper = helper;
	}

	public PILR272_012_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR272_012_DELEGATE delegate) {
		this.delegate = delegate;
	}

	public HtmlInputText getCOMP_18_INPUT_TEXT_DESC() {
		return COMP_18_INPUT_TEXT_DESC;
	}

	public void setCOMP_18_INPUT_TEXT_DESC(HtmlInputText comp_18_input_text_desc) {
		COMP_18_INPUT_TEXT_DESC = comp_18_input_text_desc;
	}

	public HtmlInputText getCOMP_17_INPUT_TEXT_DESC() {
		return COMP_17_INPUT_TEXT_DESC;
	}

	public void setCOMP_17_INPUT_TEXT_DESC(HtmlInputText comp_17_input_text_desc) {
		COMP_17_INPUT_TEXT_DESC = comp_17_input_text_desc;
	}
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR272_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR272_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_DEPARTMENT(Object value) {
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(),
						PELConstants.suggetionRecordSize };
				query = PILR272_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] {  IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR272_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_PROD_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_FM_PROD_CODE", null, null, null, null,
					null, (String) obj);
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR272_012_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR272_012_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_M_FM_USER_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_FM_USER_CODE", null, null, null, null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_TO_USER_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_TO_USER_CODE", null, null, null, null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_UNIT_CODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
	...
	public List<LovBean> lovUI_M_FM_FUND_TYPE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_FM_POL_FUND_TYPE", null, null, null, null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_TO_FUND_TYPE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_TO_POL_FUND_TYPE", null, null, null, null,
					null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovPlanType(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR006_APAC", "REP_PARAM", "M_FM_POL_FUND_TYPE", 
	...
	public List<LovBean> lovUI_M_FM_PYMT_MODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_FM_POL_PAYMENT_MODE", null, null, null,
	...
	public List<LovBean> lovUI_M_TO_PYMT_MODE(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
					"REP_PARAM", "M_TO_POL_PAYMENT_MODE", null, null, null,
					null, null, (String) obj);
			System.out.println(" LIST " + suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovUI_M_PROP_NO(Object obj) {
		ArrayList<LovBean> suggestionList = new ArrayList<LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILR006_APAC",
	...
	public void validateUI_TO_PROD_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {

		String uiPROD = (String) value;
		try {

			String prodCode = helper.WHEN_VALIDATE_ITEM_UI_M_PROD(uiPROD,
					IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_PROD_TO_DESC(prodCode);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_PROD_TO", getWarningMap());
	...
	public void validateUI_FM_PROD_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			String prodCode = helper.WHEN_VALIDATE_ITEM_UI_M_PROD(uiPROD,
					IP_REP_INFO_BEAN);
			IP_REP_INFO_BEAN.setUI_M_PROD_FM_DESC(prodCode);
			...
			try {
				...
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "UI_M_PROD_FM", getWarningMap());
	...
	public void whenValidateUI_FM_PROD_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_PROD_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_PROD_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_PROD_FM(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_TO_PROD_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_PROD_FM() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_PROD_FM())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_PROD_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_PROD_TO_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_PROD_TO(IP_REP_INFO_BEAN
							.getUI_M_PROD_FM());
					this.IP_REP_INFO_BEAN.setUI_M_PROD_TO_DESC(IP_REP_INFO_BEAN
							.getUI_M_PROD_FM_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_PROD_TO(submittedValue);
	...
	public void whenValidateUI_M_FM_AGENT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_FM_AGENT_CODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_AGENT_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_AGENT_CODE(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_M_TO_AGENT_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_FM_AGENT_CODE())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_TO_AGENT_CODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_AGENT_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN
							.setUI_M_TO_AGENT_CODE(IP_REP_INFO_BEAN
									.getUI_M_FM_AGENT_CODE());
					this.IP_REP_INFO_BEAN
							.setUI_M_TO_AGENT_DESC(IP_REP_INFO_BEAN
									.getUI_M_FM_AGENT_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_TO_AGENT_CODE(submittedValue);
	...
	public void whenValidateUI_FM_USER_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_USER_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_USER_FM_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_USER_FM(input.getValue()
						.toString());
			}
		}
	...
	public void whenValidateUI_TO_USER_CODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_USER_FM() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_USER_FM())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_USER_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_USER_TO_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_USER_TO(IP_REP_INFO_BEAN
							.getUI_M_USER_FM());
			...
			this.IP_REP_INFO_BEAN.setUI_M_USER_TO(submittedValue);
	...
	public void whenValidateUI_FM_FUND_TYPE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_FUND_TYPE_FM(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_FUND_TYPE_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FUND_TYPE_FM(input.getValue()
						.toString());
			}
		}
		COMP_15_INPUT_TEXT.resetValue();
		COMP_15_INPUT_TEXT_DESC.resetValue();
	}

	public void whenValidateUI_TO_FUND_TYPE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_FM() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_FM())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_FUND_TYPE_TO(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_FUND_TYPE_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_FUND_TYPE_TO(IP_REP_INFO_BEAN
							.getUI_M_FUND_TYPE_FM());
					this.IP_REP_INFO_BEAN.setUI_M_TO_FUND_TYPE_DESC(IP_REP_INFO_BEAN
							.getUI_M_TO_FUND_TYPE_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_FUND_TYPE_TO(submittedValue);

			// }
		}
		COMP_16_INPUT_TEXT.resetValue();
		COMP_16_INPUT_TEXT_DESC.resetValue();
	}

	public void whenValidateUI_FM_PYMT_MODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		...
		if (input.getSubmittedValue() == null
				|| "".equals(input.getSubmittedValue())) {
			this.IP_REP_INFO_BEAN
					.setUI_M_FM_PYMT_MODE(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0);
			getIP_REP_INFO_BEAN().setUI_M_FM_PYMT_MODE_DESC(null);
		} else {
			ErrorHelpUtil.validate(input, getErrorMap());
			if (input.isValid()) {
				this.IP_REP_INFO_BEAN.setUI_M_FM_PYMT_MODE(input.getValue()
						.toString());
			}
		}
		COMP_17_INPUT_TEXT.resetValue();
		COMP_17_INPUT_TEXT_DESC.resetValue();
	}

	public void whenValidateUI_TO_PYMT_MODE(ActionEvent actionEvent) {
		cancelModalPanel();
		CommonUtils.clearMaps(this);
		UIInput input = (UIInput) actionEvent.getComponent().getParent();
		String submittedValue = (String) input.getSubmittedValue();
		if (submittedValue == null || submittedValue.toString().isEmpty()) {
			...
			if (IP_REP_INFO_BEAN.getUI_M_FM_PYMT_MODE() != null) {

				if (REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0
						.equals(IP_REP_INFO_BEAN.getUI_M_FM_PYMT_MODE())) {

					this.IP_REP_INFO_BEAN
							.setUI_M_TO_PYMT_MODE(REPORT_UTIL_CONSTANTS.SET_SECOND_FIELD_DEFAULT_ZZZZ);
					getIP_REP_INFO_BEAN().setUI_M_TO_PYMT_MODE_DESC(null);

				} else {
					this.IP_REP_INFO_BEAN.setUI_M_TO_PYMT_MODE(IP_REP_INFO_BEAN
							.getUI_M_FM_PYMT_MODE());
					this.IP_REP_INFO_BEAN.setUI_M_TO_PYMT_MODE_DESC(IP_REP_INFO_BEAN
							.getUI_M_TO_PYMT_MODE_DESC());
				}
			}
			...
			this.IP_REP_INFO_BEAN.setUI_M_TO_PYMT_MODE(submittedValue);

			// }
		}
		COMP_18_INPUT_TEXT.resetValue();
		COMP_18_INPUT_TEXT_DESC.resetValue();
	}
	


	
	public List<LovBean> lovUI_M_AGENT_CODE(Object event) {
		ArrayList<LovBean> suggestionList=new ArrayList<LovBean>();
		try {
			
			suggestionList = (ArrayList<LovBean>) brokerCodeSuggestion((String) event,
	...
	public List<LovBean> brokerCodeSuggestion(String custCode, String divnCode)
	throws Exception {
		List<LovBean> suggestionList = null;
		try {
			String psCodeDesc = getBrokerCodeDesc();
			String query = "SELECT CUST_CODE, CUST_NAME, CUST_BL_NAME FROM PM_CUSTOMER "
					...
					+ "PP_SYSTEM  WHERE DECODE (PS_VALUE,2,CCLAS_CODE, CCLAS_TYPE)"
					+ "IN (?,?,?,?,?,?,?,?,?,?) AND "
					+ "PS_CODE = 'BROKER' AND PS_TYPE ='LOV_CUST') "
					+ "AND CUST_FRZ_FLAG = 'N' AND ((CUST_CODE IN (SELECT CDIV_CUST_CODE FROM  "
					+ "PM_CUST_DIVN WHERE CDIV_DIVN_CODE = NVL (?, "
					+ "CDIV_DIVN_CODE))) "
					+ "OR (CUST_APPL_ALL_BRAN_YN = 'Y')) ";
			String queryLike = " AND (CUST_CODE LIKE ?  ) ";
		
			String rowNum = " AND ROWNUM < 20  ORDER BY 1";
		
			Object[] object = null;
		
			StringTokenizer st2 = new StringTokenizer(psCodeDesc);
			String[] atr = new String[11];
			int i = 0;
			while (st2.hasMoreTokens()) {
				String st = st2.nextToken("','");
				atr[i] = st;
				i++;
			}
		
			if ("*".equals(custCode)) {
				object = new Object[] { atr[0], atr[1], atr[2], atr[3], atr[4],
						atr[5], atr[6], atr[7], atr[8], atr[9], divnCode };
				query = query + rowNum;
			} else {
				object = new Object[] { atr[0], atr[1], atr[2], atr[3], atr[4],
						atr[5], atr[6], atr[7], atr[8], atr[9], divnCode,
						"%" + custCode + "%" };
				query = query.concat(queryLike).concat(rowNum);
			}
	...
	private String getBrokerCodeDesc() throws Exception {
		String C1 = "SELECT PS_CODE_DESC FROM PP_SYSTEM WHERE PS_TYPE = 'LOV_CUST' AND PS_CODE = 'BROKER'";
	...
	public List<LovBean> lovUI_M_PRODUCER(Object event) {
		ArrayList<LovBean> suggestionList=new ArrayList<LovBean>();
		try {
			
			suggestionList = (ArrayList<LovBean>) brokerCodeSuggestion1((String) event,
					CommonUtils.getControlBean().getM_DIVN_CODE());
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
					e.getMessage());
	...
	public List<LovBean> brokerCodeSuggestion1(String custCode, String divnCode)
	throws Exception {
		List<LovBean> suggestionList = null;
		try {
			String psCodeDesc = getBrokerCodeDesc1();
			String query = "SELECT CUST_CODE, CUST_NAME, CUST_BL_NAME FROM PM_CUSTOMER "
					+ "WHERE CUST_CLASS IN (SELECT CCLAS_CODE FROM PM_CUST_CLASS, "
					+ "PP_SYSTEM  WHERE DECODE (PS_VALUE,2,CCLAS_CODE, CCLAS_TYPE)"
					+ "IN (?,?,?,?,?,?,?,?,?,?) AND "
	...
	private String getBrokerCodeDesc1() throws Exception {
		String C1 = "SELECT PS_CODE_DESC FROM PP_SYSTEM WHERE PS_TYPE = 'LOV_CUST' AND PS_CODE = 'BROKER'";
		CRUDHandler handler = null;
		Connection connection = null;
		ResultSet C1_REC = null;
