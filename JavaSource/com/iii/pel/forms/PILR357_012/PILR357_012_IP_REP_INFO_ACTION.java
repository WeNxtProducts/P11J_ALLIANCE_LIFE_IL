package com.iii.pel.forms.PILR357_012;
...
public class PILR357_012_IP_REP_INFO_ACTION extends CommonReportAction {
	...
	PILR357_012_HELPER helper;
	PILR357_012_DELEGATE delegate;

	public PILR357_012_IP_REP_INFO_ACTION() {

		IP_REP_INFO_BEAN = new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper = new PILR357_012_HELPER();
		delegate = new PILR357_012_DELEGATE();
	...
	public String runAction() {
		...
		try {
			if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
				...
				map.put("P_TXN_FM", IP_REP_INFO_BEAN.getUI_M_USER_FM());
				map.put("P_TXN_TO", IP_REP_INFO_BEAN.getUI_M_USER_TO());
				map.put("P_DATE_FM", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_APR_DT()));
				map.put("P_DATE_TO", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_TO_APR_DT()));
			/*	map.put("P_FM_DT", CommonUtils.dateToPELStringFormatter(IP_REP_INFO_BEAN.getUI_M_FM_CS_DT()));
				...
				map.put("P_FUND_FM", IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_FM());
				map.put("P_FUND_TO", IP_REP_INFO_BEAN.getUI_M_FUND_TYPE_TO());
...
*/
	...
	public void onLoad(PhaseEvent phaseEvent) throws ParseException {
		...
		PILR357_012_HELPER helper = new PILR357_012_HELPER();
	...
	public PILR357_012_HELPER getHelper() {
		return helper;
	}

	public void setHelper(PILR357_012_HELPER helper) {
		this.helper = helper;
	}

	public PILR357_012_DELEGATE getDelegate() {
		return delegate;
	}

	public void setDelegate(PILR357_012_DELEGATE delegate) {
	...
	public List<LovBean> lovUI_M_DIVISION(Object obj) {
		...
		if ("*".equals(code)) {
			...
			query = PILR357_012_QUERY_CONSTANTS.DIVISION_QUERY;
		} else {
			object = new Object[] { code + "%", code + "%",
					PELConstants.suggetionRecordSize };
			query = PILR357_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		...
		try {
			if ("*".equals(code)) {
				object = new Object[] { IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						...
						PELConstants.suggetionRecordSize };
				query = PILR357_012_QUERY_CONSTANTS.DEPARTMENT_QUERY;
			} else {
				object = new Object[] {  IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE(),
						IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE(), code + "%",
						code + "%", PELConstants.suggetionRecordSize };
				query = PILR357_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
			}
			suggestionList = delegate.prepareLovList(query, object);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<LovBean> lovClassCode(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR357_012_QUERY_CONSTANTS.CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR357_012_QUERY_CONSTANTS.CLASS_QUERY_LIKE;
		}
