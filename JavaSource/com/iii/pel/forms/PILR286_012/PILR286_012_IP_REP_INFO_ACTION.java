...
public class PILR286_012_IP_REP_INFO_ACTION  extends CommonReportAction{
	...
	PILR286_012_HELPER helper;
	PILR286_012_DELEGATE delegate;
	...
	public PILR286_012_IP_REP_INFO_ACTION(){
		
		IP_REP_INFO_BEAN=new IP_REP_INFO();
		rerenderComponents();
		setComboBoxValues();
		helper=new PILR286_012_HELPER();
		delegate=new PILR286_012_DELEGATE();
	...
	public void prepareDropDownList() {
		...
		try {
			...
			listPaymentFm = ListItemUtil.getDropDownListValue(connection, "PILR286_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_FM", "PAYMODE");
			listPaymentTo = ListItemUtil.getDropDownListValue(connection, "PILR286_012", 
					"REP_PARAM", "REP_PARAM.M_PAY_TYPE_TO", "PAYMODE");
			listInstrFm= ListItemUtil.getDropDownListValue(connection, "PILR286_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_FM", "IL_CPAY_MODE");
			listInstrTo = ListItemUtil.getDropDownListValue(connection, "PILR286_012", 
					"REP_PARAM", "REP_PARAM.M_INSTR_TO", "IL_CPAY_MODE");
			listM_Lapse = ListItemUtil.getDropDownListValue(connection, "PILR286_012", 
	...
	public String runAction() {
		...
		try
		{
			...
			//new PILR286_012_DELEGATE().executeSaveAction(this.IP_REP_INFO_BEAN);
				response = (HttpServletResponse) FacesContext
						.getCurrentInstance().getExternalContext()
						.getResponse();
				
				map.put("P_NEW_IC_NO_FM", IP_REP_INFO_BEAN.getUI_FM_DIVN_CODE());
				map.put("P_NEW_IC_NO_TO", IP_REP_INFO_BEAN.getUI_TO_DIVN_CODE());
				map.put("P_OLD_IC_NO_FM", IP_REP_INFO_BEAN.getUI_M_FM_DEPT_CODE());
				map.put("P_OLD_IC_NO_TO", IP_REP_INFO_BEAN.getUI_M_TO_DEPT_CODE());
				map.put("P_POL_FM_NO", IP_REP_INFO_BEAN.getUI_M_POL_FM());
				map.put("P_POL_TO_NO", IP_REP_INFO_BEAN.getUI_M_POL_TO());
...
//				response.sendRedirect(redirectUrl);
	 ...
	 public void onLoad(PhaseEvent phaseEvent){
		 ...
		 PILR286_012_HELPER helper=new PILR286_012_HELPER();
		 try{
			 if(isFormFlag()){
	...
	public List<LovBean> lovAgentCode(Object value){
		...
		try {
			...
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_AGENT_FM", 
	...
	public List<LovBean> lovSrcBus(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_SRC_BUS_FM", 
	...
	public List<LovBean> lovCustCode(Object obj){
		...
		if("*".equals(code)){
			...
			query=PILR286_012_QUERY_CONSTANTS.CUST_CODE ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.CUST_CODE_LIKE;
		}
	...
	public List<LovBean> lovCustCode1(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_FM_CUST", 
	...
	public List<LovBean> lovUI_M_PRODUCT(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.PRODUCT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.PRODUCT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovProdCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_PROD_CODE_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovMainAcnt(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_MACNT_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> lovSubAcnt(Object value){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.SUB_ACNT_QRY;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.SUB_ACNT_QRY_LIKE;
		}
		suggestionList = delegate.prepareLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovStsCode(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_FM_STATUS", 
	...
	public List<LovBean> lovCLM(Object value){
		...
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_CLM_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
		...
		if(submittedValue==null ||submittedValue.toString().isEmpty()){
			if(IP_REP_INFO_BEAN.getUI_M_POL_FM()!=null){
				if(REPORT_UTIL_CONSTANTS.SET_FIRST_FIELD_DEFAULT_0.equals(IP_REP_INFO_BEAN.getUI_M_POL_FM())){
					...
					this.IP_REP_INFO_BEAN.setUI_M_POL_TO(IP_REP_INFO_BEAN.getUI_M_POL_FM());
				}
			}
	...
	public List<LovBean> lovUI_M_CUST_CLASS(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.CUST_CLASS_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.CUST_CLASS_QUERY_LIKE;
		}
	...
	public List<LovBean> lovUI_DIVN_CODE(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.DIVISION_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.DIVISION_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovUI_DEPT_CODE(Object obj){
		...
		String query=null;
		 if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.DEPARTMENT_QUERY ;
		}else{
			object=new Object[]{code+"%",code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.DEPARTMENT_QUERY_LIKE;
		}
		suggestionList = delegate.prepareDepttLovList(query, object);
		return suggestionList;
	}
	...
	public List<LovBean> lovPolNoCode(Object obj){
		...
		if("*".equals(code)){
			object=new Object[]{PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.POL_NO;
		}else{
			object=new Object[]{code+"%",PELConstants.suggetionRecordSize};
			query=PILR286_012_QUERY_CONSTANTS.POL_LIKE;
		}
	...
	public List<LovBean> newlovIcNoFm(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_NEW_IC_NO_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> newlovIcNoTo(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_NEW_IC_NO_TO", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> oldlovIcNoFm(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_OLD_IC_NO_FM", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
	...
	public List<LovBean> oldlovIcNoTo(Object value){
		ListItemUtil listItemUtil = null;
		ArrayList<LovBean> list = new ArrayList<LovBean>();
		try {
			listItemUtil = new ListItemUtil();
			list = listItemUtil.P_CALL_LOV("PILR286_012", "REP_PARAM", "M_OLD_IC_NO_TO", 
					null, null, null, null, null, (String)value);
		} catch (Exception e) {
			getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,e.getMessage());
			getErrorMap().put("prepareLovCommCode",e.getMessage());
