...
/*Commented by Janani on 07.03.2017*/
//import org.apache.poi.hssf.record.formula.functions.Covar;
/*end*/
import com.iii.apps.persistence.CRUDHandler;
import com.iii.apps.persistence.OracleParameter;
import com.iii.apps.persistence.OracleProcedureHandler;
import com.iii.pel.forms.PILT002_APAC.BP;
import com.iii.pel.forms.PILT002_APAC.COPY_ACTION;
...
import com.iii.pel.forms.PILT002_APAC.PT_IL_DOC_TODO_LIST_STATUS_ACTION;
...
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ADDL_COVER_1_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ADDL_COVER_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSR_ILLNESS_DTLS_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSR_MED_HIST;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSR_MED_HIST_1;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSR_MED_HIST_1_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSR_MED_HIST_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSURED_DTLS;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSURED_DTLS_1;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_ASSURED_DTLS_1_ACTION;
...
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_BROKER_DTL_ACTION;
...
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_CHARGE_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_CONDITION_ACTION;
...
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_MED_EXAM_DTL_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_POL_STATUS_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_SURR_MAT_VALUES;
import com.iii.pel.forms.PILT002_APAC.PT_IL_SURR_MAT_VALUES_ACTION;
import com.iii.pel.forms.PILT002_APAC.PT_IL_UNPAID_PREM_DTLS_ACTION;
...
public class PKG_PILT002_APAC {
	 ...
	 * P_VALIDATE_DEP
	 */
	public ArrayList<OracleParameter> P_VALIDATE_DEP(Object P_POL_SYS_ID,
			Object POL_END_EFF_FROM_DT, Object M_TEMP)
		...
		try {
			...
			OracleParameter param2 = new OracleParameter("IN2",
					...
					OracleParameter.DIRECTION_TYPE.IN, POL_END_EFF_FROM_DT);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("OUT3",
					OracleParameter.DATA_TYPE.STRING,
					OracleParameter.DIRECTION_TYPE.OUT, M_TEMP);
			parameterList.add(param3);
	 ...
	 * @param P_M_TD_MIN_RATE-IN OUT
	 * @param P_M_TD_MAX_RATE-IN OUT
	 ...
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> IL_SUM_ASURED_CAL(
			Object P_POL_SYS_ID,
			Object P_END_NO_IDX,
			...
			Object P_POL_LC_MON_ANNU_AMT) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_POL_SYS_ID);
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_END_NO_IDX);
			parameterList.add(param2);
			...
			parameterList.add(param4);
			OracleParameter param5 = new OracleParameter("IN5", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_PREM_PAY_YRS);
			parameterList.add(param5);
			...
			parameterList.add(param6);
			OracleParameter param7 = new OracleParameter("IN7", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA_CURR_CODE);
			parameterList.add(param7);
			...
			parameterList.add(param9);
			OracleParameter param10 = new OracleParameter("IN10", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_NO_OF_INST);
			parameterList.add(param10);
			OracleParameter param11 = new OracleParameter("IN11", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_SUM_ASSURED);
			parameterList.add(param11);
			OracleParameter param12 = new OracleParameter("IN12", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_PLAN_CODE);
			parameterList.add(param12);
			OracleParameter param13 = new OracleParameter("IN13", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_POAD_SYS_ID);
			parameterList.add(param13);
			OracleParameter param14 = new OracleParameter("IN14", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_MODAL_PREM);
			parameterList.add(param14);
			OracleParameter param15 = new OracleParameter("IN15", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_BASE_CURR);
			parameterList.add(param15);
			OracleParameter param16 = new OracleParameter("IN16", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_COVER_VAR_VALUE);
			parameterList.add(param16);
			OracleParameter param17 = new OracleParameter("IN17", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_RECORD_STATUS);
			parameterList.add(param17);
			OracleParameter param18 = new OracleParameter("IN18", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_SA_FACTOR);
			parameterList.add(param18);
			OracleParameter param19 = new OracleParameter("IN19", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_SA_TARIFF);
			parameterList.add(param19);
			OracleParameter param20 = new OracleParameter("IN20", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_COVER_SA_CALC);
			parameterList.add(param20);
			OracleParameter param21 = new OracleParameter("IN21", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PS_CODE);
			parameterList.add(param21);
			OracleParameter param22 = new OracleParameter("IN22", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_POL_PLAN_TYPE);
			parameterList.add(param22);
			OracleParameter param23 = new OracleParameter("IN23", OracleParameter.DATA_TYPE.DATE, OracleParameter.DIRECTION_TYPE.IN, P_POL_START_DT);
			parameterList.add(param23);
			OracleParameter param24 = new OracleParameter("IN24", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POAD_AGE);
			parameterList.add(param24);
			OracleParameter param25 = new OracleParameter("IN25", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_M_EXACT_AGE);
			parameterList.add(param25);
			OracleParameter param26 = new OracleParameter("IN26", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_DEF_PERIOD_TO);
			parameterList.add(param26);
			OracleParameter param27 = new OracleParameter("IN OUT27", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_M_TD_MIN_RATE);
			parameterList.add(param27);
			OracleParameter param28 = new OracleParameter("IN OUT28", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_M_TD_MAX_RATE);
			parameterList.add(param28);
			OracleParameter param29 = new OracleParameter("IN OUT29", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_POL_NEW_FC_SA);
			parameterList.add(param29);
			OracleParameter param30 = new OracleParameter("IN OUT30", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_POL_FC_MODAL_PREM);
	...
	public ArrayList<OracleParameter> POL_END_EFF_FROM_DT_W_V_I(
			...
			Object P_M_SUCCESS,
			Object P_MOP_END) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			parameterList.add(param6);
			OracleParameter param7 = new OracleParameter("IN7", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_M_CALC_METHOD);
			parameterList.add(param7);
			...
			parameterList.add(param29);
			OracleParameter param30 = new OracleParameter("IN30", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_MOP_END);
			parameterList.add(param30);
	 ...
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> P_SET_DOC_NO_PROP(
			Object P_DOC_TYPE,
			Object P_DOC_CODE,
			Object P_DIVN_CODE,
			Object P_CLASS_CODE,
			...
			Object P_REG_DATE,
			Object P_ROWID,
			Object P_DISABLE_YN) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			parameterList.add(param7);
			OracleParameter param8 = new OracleParameter("IN OUT8", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN_OUT, P_DOC_NO_FN);
			parameterList.add(param8);
			...
			parameterList.add(param10);
			OracleParameter param11 = new OracleParameter("IN11", OracleParameter.DATA_TYPE.DATE, OracleParameter.DIRECTION_TYPE.IN, P_DATE);
			parameterList.add(param11);
			OracleParameter param12 = new OracleParameter("IN12", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_CLAIM_TYPE);
			parameterList.add(param12);
			OracleParameter param13 = new OracleParameter("IN13", OracleParameter.DATA_TYPE.DATE, OracleParameter.DIRECTION_TYPE.IN, P_REG_DATE);
			parameterList.add(param13);
			OracleParameter param14 = new OracleParameter("IN14", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_ROWID);
			parameterList.add(param14);
	...
	public Integer IL_DISC_AGE(Integer P_CURR_AGE, String P_CATG_CODE,
		...
		ResultSet resultSet = null;
		ResultSet resultSet1 = null;
		String POL_PLAN_CODE = new PILT002_APAC_COMPOSITE_ACTION()
		.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN()
		.getPOL_PLAN_CODE();
		Object[] values = null;
		Connection connection = null;
	...
	public void L_LOAD_MEDICAL_HISTORY(PT_IL_POLICY PT_IL_POLICY_BEAN,
			PT_IL_POL_ASSR_MED_HIST_ACTION medHistAction , com.iii.pel.forms.PILT002_APAC.BP bpBean) throws Exception {
		int M_COUNT;
	...
	public void IL_BLOCK_POL_ENABLED(
		...
		try {
			...
			if ("N".equals(compositeAction.getDUMMY_ACTION_BEAN()
				...
				compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN()
				.setDELETE_ALLOWED(false);
			} else if ("O".equals(compositeAction.getDUMMY_ACTION_BEAN()
					.getDUMMY_BEAN().getUI_M_NOTIONAL())) {
				if ("Y".equals(CommonUtils.getGlobalVariable(
						"GLOBAL.M_PRIVILEGE").substring(0, 1))) {
					compositeAction.getPT_IL_POL_FUND_DTL_ACTION_BEAN()
	...
	public ArrayList<String> P_GET_EXCHANGE_RATE( 
			...
			String P_EFF_DT,
			String P_EXHG_RATE,
			String P_WAR_ERR) throws Exception {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		ArrayList<String> returnList = null;
		try {
			...
			//ErrorHelpUtil.getErrorForProcedure(connection);
			String message=ErrorHelpUtil.extractDBErrorMessage(e.getMessage());
	...
	public void L_LOAD_MEDICAL_HISTORY_1(PT_IL_POLICY PT_IL_POLICY_BEAN,
			PT_IL_POL_ASSR_MED_HIST_1_ACTION medHistActBean, com.iii.pel.forms.PILT002_APAC.BP bpBean) throws Exception {
		int M_COUNT;
		String M_DMH_CAPTION = null;
		String M_DMH_BL_CAPTION = null;
		String M_DMH_DATA_TYPE = null;
	 ...
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> IL_CALC_SA_FACT_VALID(
			Object P_POL_SYS_ID, 
			Object P_POL_PLAN_CODE,
			Object P_POL_END_TYPE,
			...
			Object P_POL_ORG_NEW_LC_SA,
			Object P_POL_FC_SUM_ASSURED,
			Object P_POL_LC_SUM_ASSURED) throws Exception {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_PLAN_CODE);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_END_TYPE);
			parameterList.add(param3);
			OracleParameter param4 = new OracleParameter("IN4", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, RECORD_STATUS);
			parameterList.add(param4);
			OracleParameter param5 = new OracleParameter("IN5", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_SA_TARIFF);
			parameterList.add(param5);
			...
			parameterList.add(param6);
			OracleParameter param7 = new OracleParameter("IN7", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_FC_MODAL_PREM);
			parameterList.add(param7);
			OracleParameter param8 = new OracleParameter("IN8", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_MODAL_PREM);
			parameterList.add(param8);
			OracleParameter param9 = new OracleParameter("IN9", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_NO_OF_INST);
			parameterList.add(param9);
			OracleParameter param10 = new OracleParameter("IN10", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_NO_OF_UNIT);
			parameterList.add(param10);
			OracleParameter param11 = new OracleParameter("IN11", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PLAN_CALC_TYPE);
			parameterList.add(param11);
			OracleParameter param12 = new OracleParameter("IN12", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA_CURR_CODE);
			parameterList.add(param12);
			OracleParameter param13 = new OracleParameter("IN13", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_NO_OF_INST);
			parameterList.add(param13);
			OracleParameter param14 = new OracleParameter("IN14", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_PROD_CODE);
			parameterList.add(param14);
			OracleParameter param15 = new OracleParameter("IN15", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_SUM_ASSURED);
			parameterList.add(param15);
			OracleParameter param16 = new OracleParameter("IN16", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA_EXCH_RATE);
			parameterList.add(param16);
			OracleParameter param17 = new OracleParameter("IN OUT17", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_POL_NO_OF_UNIT);
			parameterList.add(param17);
	...
	public ArrayList<OracleParameter> POL_PERIOD_W_V_I( 
			...
			Object P_POL_LC_SUM_ASSURED,
			Object P_POL_FC_CURR_SA,
			Object P_POL_LC_CURR_SA) throws Exception {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		...
		try {
			...
			parameterList.add(param19);
			OracleParameter param20 = new OracleParameter("IN20", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN,P_POL_END_NO_IDX);
			parameterList.add(param20);
	...
	public ArrayList<OracleParameter> P_M_POL_CONT_AD_ACC_NO_W_VAL_I(
		...
		try {
			...
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_M_POL_CONT_AD_ACC_NO);
			parameterList.add(param2);
			...
			OracleParameter param5 = new OracleParameter("IN5", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_END_TYPE);
			parameterList.add(param5);
			OracleParameter param6 = new OracleParameter("OUT6", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.OUT, "");
			parameterList.add(param6);
...
/*ADDED BY SIVARAJAN on 12-08-2018 for KICLIFEQC-1761314 */
	...
	public ArrayList<OracleParameter> P_END_EFF_DT(Object P_POL_SYS_ID,
			Object P_END_ALT_DT,Object P_EFF_DT_TYPE,Object P_END_EFF_DT)
					throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		...
		try {
			...
			OracleParameter param2 = new OracleParameter("IN2",
					OracleParameter.DATA_TYPE.DATE,
					OracleParameter.DIRECTION_TYPE.IN, P_END_ALT_DT);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("IN3",
					OracleParameter.DATA_TYPE.STRING,
					OracleParameter.DIRECTION_TYPE.IN, P_EFF_DT_TYPE);
			parameterList.add(param3);
			OracleParameter param4 = new OracleParameter("IN OUT4",
					OracleParameter.DATA_TYPE.DATE,
					OracleParameter.DIRECTION_TYPE.IN_OUT, P_END_EFF_DT);
			parameterList.add(param4);
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
					"PKG_PILT002_APAC.P_END_EFF_DT");
		} catch (Exception e) {
			e.printStackTrace();
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
	...
	public ArrayList<String> IL_POAC_GET_TARIFF_RATE(String POAC_COVER_CODE,
		...
		try {
			...
			//WAITING FOR VISHNU TO DISCUSS......

			/*else{
				throw new Exception ("Tarrif code not availale" + POAC_COVER_CODE);
			}*/
			if(M_POAD_AGE != null){
	...
	public void IL_ENDT_002_PROPS(PILT002_APAC_COMPOSITE_ACTION compositeAction) throws Exception {
	...
	public ArrayList<String> L_CHECK_MED_AMT(Long POAC_SYS_ID, Long POL_SYS_ID,
		...
		try {
			...
			list = ILProcedure.P_CALC_MIN_MAX_CVR_SA(POL_SYS_ID.toString(),
					POL_PROD_CODE,
					POAC_COVER_CODE, 
					CommonUtils.getProcedureValue(M_MIN_SA),
					CommonUtils.getProcedureValue(M_MAX_SA),
					CommonUtils.getProcedureValue(POAC_LC_SA));
			if(list.get(0) != null){
	...
	public void IL_UNIQUE_BROKER_SRNO(PT_IL_POL_BROKER_HEAD brokerBean)
			throws Exception {
		String CURSOR_C1 = "SELECT 'X' FROM   PT_IL_POL_BROKER_HEAD WHERE  POBH_SRNO =  ? AND POBH_POL_SYS_ID  =  ? AND POBH_BROKER_CODE=?";
		String CURSOR_C2 = "SELECT 'X' FROM   PT_IL_POL_BROKER_HEAD WHERE  POBH_SRNO =  ? AND POBH_POL_SYS_ID  = ? AND POBH_BROKER_CODE=? AND ROWID != ? ";
	...
	public void IL_UNIQUE_BROKER_COVER_CODE(PT_IL_POL_BROKER_HEAD brokerBean,
		...
		/*Added extra condition by ganesh on 10-04-2018 to avoid below error in live */
		...
		String CURSOR_C1 = "SELECT 'X' FROM   PT_IL_POL_BROKER_HEAD WHERE  POBH_BROKER_CODE  =  ? "
				+ "AND  POBH_COVER_CODE = ? AND  POBH_POL_SYS_ID =  ?  AND  NVL(POBH_DEL_FLAG,'N') <> 'Y' AND POBH_SRNO =  1 ";

		String CURSOR_C2 = "SELECT 'X' FROM   PT_IL_POL_BROKER_HEAD WHERE  POBH_BROKER_CODE  =  ?  "
				+ "AND POBH_COVER_CODE =  ? AND POBH_POL_SYS_ID =  ? AND NVL(POBH_DEL_FLAG,'N') <> 'Y' AND POBH_SRNO = 1 AND ROWID != ? ";
	...
	public ArrayList<OracleParameter> IL_POAD_AGE_CHECK(
		...
		try {
			...
			parameterList.add(param7);
			OracleParameter param8 = new OracleParameter("IN8", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_PERIOD);
			parameterList.add(param8);
	...
	public ArrayList<OracleParameter> L_BMI_CALC(
		...
		try {
			...
			/*Added by saritha on 30-May-2017 for ssp call id ZBILQC-1727734*/
			...
			OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, "C");
			parameterList.add(param3);
			...
			OracleParameter param4 = new OracleParameter("IN4", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, "K");
			/*End*/
			parameterList.add(param4);
	...
	// For com.iii.pel.forms.PILT002_APAC.PT_IL_POLICY_HELPER
	/**
	 *
	 * @param P_POL_SYS_ID-IN
	 * @param P_POL_NO-IN
	 * @param P_DS_TYPE-IN
	 * @param P_AMEND_IDX-OUT
	 *
	 * @return ArrayList of type Oracle Parameter
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> IL_AMEND_IDX(
			Object P_POL_SYS_ID,
			Object P_POL_NO,
			Object P_DS_TYPE,
			Object P_AMEND_IDX) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_DS_TYPE);
			parameterList.add(param3);
	 ...
	 * @param P_POAD_SYS_ID-IN
	 * @param P_PROD_CODE-IN
	 * @param P_POAD_REF_ID1-IN
	 * @param P_POAD_REF_ID2-IN
	 ...
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> L_INS_MED_EXAM_DTL(
			Object P_AGE,
			Object P_POL_SA,
			Object P_POL_SYS_ID,
			Object P_POAD_SYS_ID,
			Object P_PROD_CODE,
			Object P_POAD_REF_ID1,
			Object P_POAD_REF_ID2,
			Object P_POAD_ASSR_CODE,
			Object P_CALC_METHOD,
			Object P_USER_ID,
		...
		try {
			...
			parameterList = new ArrayList<OracleParameter>();
			outputList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_AGE);
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA);
			parameterList.add(param2);
			...
			parameterList.add(param3);
			OracleParameter param4 = new OracleParameter("IN4", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_POAD_SYS_ID);
			parameterList.add(param4);
			...
			parameterList.add(param5);
			OracleParameter param6 = new OracleParameter("IN6", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POAD_REF_ID1);
			parameterList.add(param6);
			OracleParameter param7 = new OracleParameter("IN7", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POAD_REF_ID2);
			parameterList.add(param7);
			OracleParameter param8 = new OracleParameter("IN8", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POAD_ASSR_CODE);
			parameterList.add(param8);
			OracleParameter param9 = new OracleParameter("IN9", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_CALC_METHOD);
			parameterList.add(param9);
			OracleParameter param10 = new OracleParameter("IN10", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_USER_ID);
			parameterList.add(param10);
			OracleParameter param11 = new OracleParameter("IN11", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_CONT_CODE);
			parameterList.add(param11);
			OracleParameter param12 = new OracleParameter("IN12", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_DIVN_CODE);
			parameterList.add(param12);
			OracleParameter param13 = new OracleParameter("IN13", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_LC_SUM_ASSURED);
			parameterList.add(param13);

			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
					"PKG_PILT002.L_INS_MED_EXAM_DTL");
		} catch(Exception e) {
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
		}
	...
	/**
	 *
	 * @param P_POL_PROD_GROUP_CODE-IN
	 * @param P_M_PROD_PREM_TARIFF-IN
	 * @param P_POL_SYS_ID-IN
	 * @param P_END_NO_IDX-IN
	 * @param P_POL_END_CODE-IN
	 * @param P_POL_END_TYPE-IN
	 ...
	 * @throws Exception
	 */
	public ArrayList<OracleParameter> IL_SUM_ASURED_CAL_PGC(
			Object P_POL_PROD_GROUP_CODE,
			Object P_M_PROD_PREM_TARIFF,
			Object P_POL_SYS_ID,
			Object P_END_NO_IDX,
			Object P_POL_END_CODE,
			Object P_POL_END_TYPE,
		...
		try {
			...
			parameterList = new ArrayList<OracleParameter>();
			outputList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_PROD_GROUP_CODE);
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_PREM_TARIFF);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_POL_SYS_ID);
			parameterList.add(param3);
			OracleParameter param4 = new OracleParameter("IN4", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_END_NO_IDX);
			parameterList.add(param4);
			...
			parameterList.add(param5);
			OracleParameter param6 = new OracleParameter("IN6", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_END_TYPE);
			parameterList.add(param6);
			OracleParameter param7 = new OracleParameter("IN7", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_PREM_PAY_YRS);
			parameterList.add(param7);
			OracleParameter param8 = new OracleParameter("IN8", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_NO_OF_INST);
			parameterList.add(param8);
			OracleParameter param9 = new OracleParameter("IN9", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA_CURR_CODE);
			parameterList.add(param9);
			OracleParameter param10 = new OracleParameter("IN10", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_SA_EXCH_RATE);
			parameterList.add(param10);
			OracleParameter param11 = new OracleParameter("IN11", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_NO_OF_UNIT);
			parameterList.add(param11);
			OracleParameter param12 = new OracleParameter("IN12", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POL_NO_OF_INST);
			parameterList.add(param12);
			OracleParameter param13 = new OracleParameter("IN13", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_SUM_ASSURED);
			parameterList.add(param13);
			OracleParameter param14 = new OracleParameter("IN14", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_POL_PLAN_CODE);
			parameterList.add(param14);
			OracleParameter param15 = new OracleParameter("IN15", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN, P_POAD_SYS_ID);
			parameterList.add(param15);
			OracleParameter param16 = new OracleParameter("IN16", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_ORG_FC_MODAL_PREM);
			parameterList.add(param16);
			OracleParameter param17 = new OracleParameter("IN17", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_BASE_CURR);
			parameterList.add(param17);
			OracleParameter param18 = new OracleParameter("IN18", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_COVER_VAR_VALUE);
			parameterList.add(param18);
			OracleParameter param19 = new OracleParameter("IN19", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_RECORD_STATUS);
			parameterList.add(param19);
			OracleParameter param20 = new OracleParameter("IN20", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_SA_FACTOR);
			parameterList.add(param20);
			OracleParameter param21 = new OracleParameter("IN21", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PROD_SA_TARIFF);
			parameterList.add(param21);
			OracleParameter param22 = new OracleParameter("IN22", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_COVER_SA_CALC);
			parameterList.add(param22);
			OracleParameter param23 = new OracleParameter("IN23", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_PS_CODE);
			parameterList.add(param23);
			OracleParameter param24 = new OracleParameter("IN24", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_M_POL_PLAN_TYPE);
			parameterList.add(param24);
			OracleParameter param25 = new OracleParameter("IN25", OracleParameter.DATA_TYPE.DATE, OracleParameter.DIRECTION_TYPE.IN, P_POL_START_DT);
			parameterList.add(param25);
			OracleParameter param26 = new OracleParameter("IN26", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN, P_POAD_AGE);
			parameterList.add(param26);
			OracleParameter param27 = new OracleParameter("IN27", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_M_EXACT_AGE);
			parameterList.add(param27);
			OracleParameter param28 = new OracleParameter("IN28", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_POL_DEF_PERIOD_TO);
			parameterList.add(param28);
			OracleParameter param29 = new OracleParameter("IN OUT29", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_M_TD_MIN_RATE);
			parameterList.add(param29);
			OracleParameter param30 = new OracleParameter("IN OUT30", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_M_TD_MAX_RATE);
			parameterList.add(param30);
			OracleParameter param31 = new OracleParameter("IN OUT31", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_POL_NEW_FC_SA);
			parameterList.add(param31);
			OracleParameter param32 = new OracleParameter("IN OUT32", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN_OUT, P_POL_FC_MODAL_PREM);
			parameterList.add(param32);
			OracleParameter param33 = new OracleParameter("OUT33", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.OUT, "");
			parameterList.add(param33);
			OracleParameter param34 = new OracleParameter("OUT34", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.OUT, "");
			...
			OracleParameter param43 = new OracleParameter("OUT43", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.OUT, "");
	...
	public ArrayList<OracleParameter> L_UPDATE_JE_STATUS(Object P_POL_SYS_ID)
			throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
					"PKG_PILT002_APAC.L_UPDATE_JE_STATUS");
		} catch (Exception e) {
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
		}
	...
	public ArrayList<OracleParameter> L_UPDATE_JE_STATUS_HTWT(
		...
		try {
			...
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
					"PKG_PILT002_APAC.L_UPDATE_JE_STATUS_HTWT");
		} catch (Exception e) {
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
		}
	...
	public ArrayList<OracleParameter> L_UPDATE_JE_STATUS_MED(
			Object P_POL_SYS_ID) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		try {
			...
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
					"PKG_PILT002_APAC.L_UPDATE_JE_STATUS_MED");
		} catch (Exception e) {
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
		}
	...
	public void callpolicyreviewsheet(String pol_sys_id,String PC_SYS_ID,
			String reportDate ,String freeze,
		...
		try {
			...
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,PC_SYS_ID);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("IN3",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,reportDate);
			parameterList.add(param3);
			OracleParameter param4 = new OracleParameter("IN4",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,freeze);
			parameterList.add(param4);
			OracleParameter param5 = new OracleParameter("IN5",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,value);
			parameterList.add(param5);
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, con,
					"P9ILPK_RI_ALLOC.P_APPRV_FAC");
			System.out.println("before commit");

			System.out.println("after commit sysout");
			/* Iterator<OracleParameter> iterator = outputList.iterator();
	       while (iterator.hasNext()) {
	...
	public ArrayList<OracleParameter> P_POL_COV_DT_DFT(
		...
		try {
			...
			System.out.println("outputList in P_POL_COV_DT_DFT         "+outputList);
	...
	/*Added by Dhinesh on 13-09-2016 for Cover max min sum Sa validation issues  date issue*/
	
	public ArrayList<OracleParameter> callCoverMaxMinSA_Check(
			String P_POL_SYS_ID,String POL_PROD_CODE,String COVER_CODE) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		...
		try {
			...
			parameterList = new ArrayList<OracleParameter>();
			outputList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,P_POL_SYS_ID);
			OracleParameter param2 = new OracleParameter("IN2",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,POL_PROD_CODE);
			OracleParameter param3 = new OracleParameter("IN3",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,COVER_CODE);
			OracleParameter param4 = new OracleParameter("OUT4",OracleParameter.DATA_TYPE.DOUBLE,OracleParameter.DIRECTION_TYPE.OUT,"");
			OracleParameter param5 = new OracleParameter("OUT5",OracleParameter.DATA_TYPE.DOUBLE,OracleParameter.DIRECTION_TYPE.OUT,"");
			OracleParameter param6 = new OracleParameter("IN6", OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,LC_SA);
			...
			System.out.println("outputList in size        : "+outputList.size());
	...
	/*Added by Ameen on 18/11/2016 for Endorsement Cancellation process*/
	public void callP_PRORATE_CAN_ENDORS(
			Long P_POL_SYS_ID,String POL_END_CODE) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		...
		try {
			...
			outputList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1",OracleParameter.DATA_TYPE.LONG,OracleParameter.DIRECTION_TYPE.IN,P_POL_SYS_ID);
			OracleParameter param2 = new OracleParameter("IN1",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,POL_END_CODE);
			...
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			/*
			 * commented by Ameen on 17-11-2013 as per Somnath Suggestion
			 * outputList = procHandler.executeProc(parameterList, connection,
					"P_TRANS_TO_ORG_ON_CANL");*/
			
			//Added by Ameen on 17-11-2013 as per Somnath Suggestion
			outputList = procHandler.executeProc(parameterList, connection,
					"P9ILPK_ENDORSE.P_PRORATE_CAN_ENDORS");
...
/*End*/
	...
	/*added by raja on  13-03-2017* FOR BUSSINESS RULE ISSUE*/
	
	public void callL_VAL_IL_BUS_RULE(String GROUP_ID,String APPLY_LEVEL,Long P_POL_SYS_ID) throws ProcedureException {
		Connection connection = null;
		ArrayList<OracleParameter> parameterList = null;
		ArrayList<OracleParameter> outputList = null;
		...
		try {
			...
			parameterList = new ArrayList<OracleParameter>();
			outputList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,GROUP_ID);
			OracleParameter param2 = new OracleParameter("IN2",OracleParameter.DATA_TYPE.STRING,OracleParameter.DIRECTION_TYPE.IN,APPLY_LEVEL);
			OracleParameter param3 = new OracleParameter("IN3",OracleParameter.DATA_TYPE.LONG,OracleParameter.DIRECTION_TYPE.IN,P_POL_SYS_ID);
	...
	/*added by sankaranarayanan on 28/03/2017*/
	
	
	public void P_ASSURED_DETAILS(Long P_POL_SYS_ID) throws ProcedureException {
		ArrayList<OracleParameter> parameterList = null;
		try {
			parameterList = new ArrayList<OracleParameter>();
			OracleParameter param1 = new OracleParameter("IN1",OracleParameter.DATA_TYPE.LONG,OracleParameter.DIRECTION_TYPE.IN,P_POL_SYS_ID);
			parameterList.add(param1);
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			procHandler.executeProc(parameterList, CommonUtils.getConnection(),
					"P9ILPK_POLICY_NR.P_ASSURED_DETAILS");
		} catch(Exception e) {
	...
	/*Added by Janani on 12.05.2017 for Hands-on-feedback point*/
	  ...
	  public ArrayList<OracleParameter> PR_IL_WARNING_MSG_SUB_STD_REG(
        
Object P_CONT_CODE,Object P_STATUS) throws ProcedureException {
Connection connection = null;
	 ArrayList<OracleParameter> parameterList = null;
	 ArrayList<OracleParameter> outputList = null;
	 ArrayList<OracleParameter> returnList = null;
	 ...
	 try {
		 ...
		 System.out.println("Enters into PR_IL_WARNING_MSG_SUB_STD_REG");
...
OracleProcedureHandler procHandler = new OracleProcedureHandler();
outputList = procHandler.executeProc(parameterList, connection,
       "P9ILPK_POLICY_NR.PR_IL_WARNING_MSG_SUB_STD_REG");
} catch(Exception e) {
	ErrorHelpUtil.getErrorForProcedure(connection);
    throw new ProcedureException(e.getMessage());
}
	 ...
	 Iterator<OracleParameter> iterator = outputList.iterator();
		while (iterator.hasNext()) {
			OracleParameter oracleParameter = iterator.next();
			System.out.println("Output value:::" + oracleParameter.getValue());
			returnList.addAll(oracleParameter.getValue().toString());
		}*/
...
return outputList;
	...
	/*End*/
	  ...
	  public ArrayList<OracleParameter> P_MOP_EFF_DT_VAL(Object POL_SYS_ID,
			 Object DUMMY_POL_MODE_OY_PYMT,
			  Object END_EFF_FROM_DT) throws ProcedureException {
			Connection connection = null;
			ArrayList<OracleParameter> parameterList = null;
			ArrayList<OracleParameter> outputList = null;
			try {
			...
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, DUMMY_POL_MODE_OY_PYMT);
			parameterList.add(param2);
			OracleParameter param3 = new OracleParameter("OUT1", OracleParameter.DATA_TYPE.DATE, OracleParameter.DIRECTION_TYPE.OUT, END_EFF_FROM_DT);
			parameterList.add(param3);
			
						
			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection,
			"PKG_PILT002_APAC.P_MOP_EFF_DT_VAL");
			} catch (Exception e) {
			ErrorHelpUtil.getErrorForProcedure(connection);
			throw new ProcedureException(e.getMessage());
			}
	  ...
	  /*Added by Janani on 05.04.2018 for KIC dispatch screen changing addl status to cancelled*/
		public ArrayList<OracleParameter> P_DISP_STATUS(
				Object P_POL_SYS_ID) throws ProcedureException {
			Connection connection = null;
			ArrayList<OracleParameter> parameterList = null;
			ArrayList<OracleParameter> outputList = null;
			try {
				...
				OracleProcedureHandler procHandler = new OracleProcedureHandler();
				outputList = procHandler.executeProc(parameterList, connection,
						"P9ILPK_POLICY_NR.P_DISP_STATUS");
			} catch(Exception e) {
				e.printStackTrace();
				ErrorHelpUtil.getErrorForProcedure(connection);
				throw new ProcedureException(e.getMessage());
		...
		/* Newly Added By Dhinesh on 13-04-2018*/
		  public ArrayList<OracleParameter> P_INS_CUST_ASSR_DTLS(
					String ASSURED_CODE) throws ProcedureException {
				Connection connection = null;
				ArrayList<OracleParameter> parameterList = null;
				ArrayList<OracleParameter> outputList = null;
				try {
					...
					parameterList = new ArrayList<OracleParameter>();
					outputList = new ArrayList<OracleParameter>();
					OracleParameter param1 = new OracleParameter("IN1", "STRING", "IN",ASSURED_CODE);
					parameterList.add(param1);


					OracleProcedureHandler procHandler = new OracleProcedureHandler();
					outputList = procHandler.execute(parameterList, connection,
							"P_INS_CUST_ASSR_DTLS");

					System.out.println("P_INS_CUST_ASSR_DTLS CALLED SUCCESSFULLY.......");
		 ...
		 /* 
		  * modified by Ameen on 08-05-2018 as per Chandramohan Sugg. to add GEN013 end. in condition
		  * public ArrayList<OracleParameter> P_PR_UPD_RIDER_TERM(Object POL_SYS_ID,
					 Object P_POL_PERIOD) throws ProcedureException {*/
		  public ArrayList<OracleParameter> P_PR_UPD_RIDER_TERM(Object POL_SYS_ID,
					 Object P_POL_PERIOD,
					 Object P_POL_PREM_PAY_YRS) throws ProcedureException {
				Connection connection = null;
				ArrayList<OracleParameter> parameterList = null;
				ArrayList<OracleParameter> outputList = null;
				try {
					...
					outputList = new ArrayList<OracleParameter>();
					OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN,POL_SYS_ID);
					OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN,P_POL_PERIOD);
					OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN,P_POL_PREM_PAY_YRS);
					parameterList.add(param1);
					parameterList.add(param2);
					parameterList.add(param3);
					...
					OracleProcedureHandler procHandler = new OracleProcedureHandler();
					/*
					 * modified by Ameen on 08-05-2018 as per Chandramohan Sugg. to include GEN013 end. in condition
					 * outputList = procHandler.execute(parameterList, connection,
							"PR_UPD_RIDER_TERM");*/
					outputList = procHandler.executeProc(parameterList, connection,
							"P9ILPK_END_VALIDATION.PR_UPD_RIDER_TERM");

					System.out.println("P_PR_UPD_RIDER_TERM CALLED SUCCESSFULLY.......");
		  ...
		  /*Added by Aneen on 27-04-2018 for KIC AS PER Chandramohan Sugg.*/
		  public ArrayList<OracleParameter> PR_ENDO_VALIDATE(Object P_POL_SYS_ID,
					 Object P_POL_END_CODE,
					 Object P_POL_PERIOD,Object P_POL_FC_SUM_ASSURED) throws ProcedureException {
				Connection connection = null;
				ArrayList<OracleParameter> parameterList = null;
				ArrayList<OracleParameter> outputList = null;
				try {
					...
					outputList = new ArrayList<OracleParameter>();
					OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.LONG, OracleParameter.DIRECTION_TYPE.IN,P_POL_SYS_ID);
					OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN,P_POL_END_CODE);
					OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.INTEGER, OracleParameter.DIRECTION_TYPE.IN,P_POL_PERIOD);
					...
					OracleProcedureHandler procHandler = new OracleProcedureHandler();
					outputList = procHandler.executeProc(parameterList, connection,
							"P9ILPK_END_VALIDATION.PR_ENDO_VALIDATE");
		  ...
		  public ArrayList<OracleParameter> PR_CALC_TERM(
					Object P_P_PROD_CODE,
					Object P_PLAN_CODE,
					Object P_ASSR_REF_ID1,
					Object P_PROD_AGE_CALC_FLAG) throws ProcedureException {
				Connection connection = null;
				ArrayList<OracleParameter> parameterList = null;
				ArrayList<OracleParameter> outputList = null;
				try {
					...
					parameterList = new ArrayList<OracleParameter>();
					outputList = new ArrayList<OracleParameter>();
					OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_P_PROD_CODE);
					parameterList.add(param1);
					OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_PLAN_CODE);
					parameterList.add(param2);
					OracleParameter param3 = new OracleParameter("IN3", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_ASSR_REF_ID1);
					parameterList.add(param3);
					OracleParameter param4 = new OracleParameter("IN4", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_PROD_AGE_CALC_FLAG);
					parameterList.add(param4);
		  ...
		  /*Added by Ameen on 10-05-2018 for KIC as per Ajoy sugg. for GEN014*/
		  public ArrayList<String> P_CAL_PLAN_PERIOD2(
					String P_CUST_DOB,
					String P_POL_PLAN_CODE,
					String P_POL_JOINT_LIFE_YN,
					String P_POAD_CATG_CODE,
				...
				try {
					...
					OracleParameter param14 = new OracleParameter("OUT14", "STRING", "OUT","");
					parameterList.add(param14);
					OracleParameter param15 = new OracleParameter("IN OUT15", "STRING", "IN OUT",P_POL_PERIOD);
					parameterList.add(param15);
					OracleParameter param16 = new OracleParameter("IN OUT16", "STRING", "IN OUT",P_POL_PREM_PAY_YRS);
					parameterList.add(param16);
		  ...
		  /*Added by Janani on 12.07.2018 for FLALIFEQC-1756799*/
		
		  
		  public ArrayList<OracleParameter> P_MIN_MAX_SA_VALID(
					String P_POL_LC_SUM_ASSURED,
					String P_POL_PLAN_CODE,
					String P_CHECK) throws ProcedureException {
				Connection connection = null;
				ArrayList<OracleParameter> parameterList = null;
				ArrayList<OracleParameter> outputList = null;
				ArrayList<OracleParameter> returnList = null;
				try {
					...
					outputList = new ArrayList<OracleParameter>();
					returnList = new ArrayList<OracleParameter>();
					OracleParameter param1 = new OracleParameter("IN1", "DOUBLE", "IN",P_POL_LC_SUM_ASSURED);
					parameterList.add(param1);
					OracleParameter param2 = new OracleParameter("IN2", "STRING", "IN",P_POL_PLAN_CODE);
					parameterList.add(param2);
					OracleParameter param3 = new OracleParameter("OUT3", "STRING", "OUT","");
				...
				while (iterator.hasNext()) {
					OracleParameter oracleParameter = iterator.next();
					System.out.println("Output value:::" + oracleParameter.getValue());
					returnList.addAll(oracleParameter.getValue());
				}*/
				return outputList;
			}
		  ...
		  /*Newly added by pidugu raj dt: 25-08-2020 as suggested by kk for Alliance IL*/
		  public ArrayList<String> P_GET_EXCHANGE_RATE_AI_IL( 
					String P_CURR_CODE_FM,
					String P_CURR_CODE_TO,
					String P_BUY_SELL,
					String P_EFF_DT,
					String P_EXHG_RATE,
					String P_WAR_ERR) throws Exception {
				...
				try {
					...
					outputList = new ArrayList<OracleParameter>();
					returnList = new ArrayList<String>();
					OracleParameter param1 = new OracleParameter("IN1", "STRING", "IN",P_CURR_CODE_FM);
					parameterList.add(param1);
					OracleParameter param2 = new OracleParameter("IN2", "STRING", "IN",P_CURR_CODE_TO);
					parameterList.add(param2);
					OracleParameter param3 = new OracleParameter("IN3", "STRING", "IN",P_BUY_SELL);
					parameterList.add(param3);
					OracleParameter param4 = new OracleParameter("IN4", "STRING", "IN",P_EFF_DT);
					parameterList.add(param4);
					OracleParameter param5 = new OracleParameter("IN OUT5", "STRING", "IN OUT",P_EXHG_RATE);
					parameterList.add(param5);
					OracleParameter param6 = new OracleParameter("IN6", "STRING", "IN",P_WAR_ERR);
					parameterList.add(param6);

					OracleProcedureHandler procHandler = new OracleProcedureHandler();
					outputList = procHandler.execute(parameterList, connection,
							"P_GET_EXCHANGE_RATE_AI_IL");
					Iterator<OracleParameter> iterator = outputList.iterator();
					while (iterator.hasNext()) {
						OracleParameter oracleParameter = iterator.next();
						String value=oracleParameter.getValue();
