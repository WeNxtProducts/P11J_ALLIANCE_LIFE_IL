...
public class PKG_PILT003_APAC {

    /**
      *
      * @param P_POL_SYS_ID-IN
      * @param P_M_FC_NET_PREM-IN
      *
      * @return ArrayList of type Oracle Parameter
      * @throws Exception
      */
    public ArrayList<OracleParameter> L_CHECK_PYMT_DTLS(
                      Object P_POL_SYS_ID,  Object P_M_FC_NET_PREM) throws ProcedureException {
		 ...
		 try {
            ...
            OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.DOUBLE, OracleParameter.DIRECTION_TYPE.IN, P_M_FC_NET_PREM);
            parameterList.add(param2);

           OracleProcedureHandler procHandler = new OracleProcedureHandler();
            outputList = procHandler.executeProc(parameterList, connection,
                   "PKG_PILT003_APAC.L_CHECK_PYMT_DTLS");
         } catch(Exception e) {
    ...
    /**
      ...
      * @throws Exception
      */
    public ArrayList<OracleParameter> L_CHECK_SURR_MAT_VAL(
                      Object P_ERR_FLAG,
		 ...
		 try {
			...
			parameterList = new ArrayList<OracleParameter>();
			outputList = new ArrayList<OracleParameter>();
            OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.STRING, OracleParameter.DIRECTION_TYPE.IN, P_ERR_FLAG);
            parameterList.add(param1);
           ...
           OracleProcedureHandler procHandler = new OracleProcedureHandler();
            outputList = procHandler.executeProc(parameterList, connection,
                   "PKG_PILT003_APAC.L_CHECK_SURR_MAT_VAL");
         } catch(Exception e) {
         	ErrorHelpUtil.getErrorForProcedure(connection);
                throw new ProcedureException(e.getMessage());
         }
