...
/**
 * Servlet implementation class ApplicationExceptionHandler
 */
public class ApplicationExceptionHandler extends HttpServlet {
	...
	public void processError(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		
		new LoginService().invalidateSessionAction(request, getServletContext());
		response.sendRedirect(request.getContextPath()+"/jsf/error/systemerror.xhtml");
