...
<body>
<f:view locale="#{sessionScope['pageLocale']}" beforePhase="#{PILP026_COMPOSITE_ACTION.BP_ACTION_BEAN.onLoad}">
<f:loadBundle basename="messageProperties_PILP026" var="message"/>
<f:loadBundle basename="menu" var="menumessage"/>
<table cellpadding="0" cellspacing="0" width="100%" border="0"><tr><td colspan="3"><jsp:include page="../jsp/menu.jsp" /></td></tr><h:form id="BP" >
...
<h:commandLink
    action="#{PILP026_COMPOSITE_ACTION.BP_ACTION_BEAN.saveRecord}"
